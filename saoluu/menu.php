...
if (isset($databases['Name'])&&count($databases['Name'])>0)// Danh sách mysql dum p ra màn hình
{
...
if (isset($databases['Name'])&&count($databases['Name'])>0)// Xuất danh sách database ra màn hình
{
