<div id="menu">
<ul>
	<li id="m1" style="display: none" ><a href="main.php" target="MySQL_Dumper_content" onclick="setMenuActive('m1')">{L_HOME}</a></li>
	<li id="m2" style="display: none" class=""><a href="config_overview.php" target="MySQL_Dumper_content" onclick="setMenuActive('m2')">{L_CONFIG}</a></li>

	<!-- BEGIN MAINTENANCE -->
	<li id="m3" class="active" class=""><a href="filemanagement.php?action=dump"
	...
	<li style="display: none" id="m6" class=""><a	href="sql.php?db={DB_ACTUAL}&amp;dbid={DB_SELECTED_INDEX}"
		target="MySQL_Dumper_content" onclick="setMenuActive('m6')">{L_SQL_BROWSER}</a></li>
	<li style="display: none" id="m7" class=""><a href="log.php" target="MySQL_Dumper_content"
...
<fieldset id="dbSelect"><legend>{L_CHOOSE_DB}:</legend>
	<!-- BEGIN DB_LIST -->
		<select name="dbindex" DISABLED="DISABLED" style="width:180px;color:red;font-weight:bold;" onchange="this.form.submit()">
		<!-- BEGIN DB_ROW -->
