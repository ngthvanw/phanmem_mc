...
<a target="_blank" title="{L_VISIT_HOMEPAGE} {CONFIG_HOMEPAGE}"><img src="css/{CONFIG_THEME}/pics/h1_logo.gif" alt="MySQLDumper - Homepage"></a>
<div id="version">
	<a title="{L_HOME}" target="MySQL_Dumper_content" style="text-decoration: none">
