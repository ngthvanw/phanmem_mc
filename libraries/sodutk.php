            ...
            if ($data['cttheobophan'] == 1) {
                ...
                if ($data['matk'] == 2141) {
                    if($_SESSION['theothongtu']=="tt200"){
                        $sqltk = "SELECT 0 as soduno,(sum(nguyengia)-sum(giatriconlai)) as soduco FROM psts WHERE tanggiam=0 and giatriconlai>=0 and SUBSTRING(matk, 1, 3) ='211' group by SUBSTRING(matk, 1, 3) order by matk ";
                    }else{
                ...
                if ($data['matk'] == 2142) {
                    if($_SESSION['theothongtu']=="tt200"){
                        $sqltk = "SELECT 0 as soduno,(sum(nguyengia)-sum(giatriconlai)) as soduco FROM psts WHERE tanggiam=0 and giatriconlai>=0 and SUBSTRING(matk, 1, 3) ='212' group by SUBSTRING(matk, 1, 3) order by matk ";
                    }else{
                ...
                if ($data['matk'] == 2143) {
                    if($_SESSION['theothongtu']=="tt200"){
                        $sqltk = "SELECT 0 as soduno,(sum(nguyengia)-sum(giatriconlai)) as soduco FROM psts WHERE tanggiam=0 and giatriconlai>=0 and SUBSTRING(matk, 1, 3) ='213' group by SUBSTRING(matk, 1, 3) order by matk ";
                    }else{
