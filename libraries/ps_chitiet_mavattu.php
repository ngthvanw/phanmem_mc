...
class ps_chitiet_mavattu extends database
{
    ...
    {// Lấy danh sách vật tư nhập trong ps chi tiết
        ...
        while ($data = $this->fetch()) {
            ...
            $data['sldm'] = $datatonDM[$mact][$mavt]['soluong'];
    ...
    {// Lấy danh sách vật tư nhập trong ps chi tiết
        ...
        while ($data = $this->fetch()) {
            ...
            $data['STT'] = $i;
            $data['soluongton'] = $dataton[$mavt]['slton'];
            $data['gianhap'] = round($dataton[$mavt], 2);
    ...
    {// Lấy danh sách vật tư nhập trong ps chi tiết
        ...
        if($_SESSION['phuongphaptonkho']==2) {
            $sql = "SELECT chitiet_psvt.sott,chitiet_psvt.mavt,chitiet_psvt.tenvt,chitiet_psvt.dvt,(SELECT dongiabinhquan as dongia from tkthang where chitiet_psvt.mavt = tkthang.mavt AND sophieu_nxk='".$this->getSoPhieu()."' ) as donggianhap,chitiet_psvt.soluongnhap,chitiet_psvt.thuesuat,(SELECT thanhtienxuat from tkthang where chitiet_psvt.mavt = tkthang.mavt AND sophieu_nxk='".$this->getSoPhieu()."' ) as thanhtien,(SELECT thanhtienxuat from tkthang where chitiet_psvt.mavt = tkthang.mavt AND sophieu_nxk='".$this->getSoPhieu()."' ) as thanhtienchuack,chietkhau,(chitiet_psvt.thuesuat/100)*(SELECT thanhtienxuat from tkthang where chitiet_psvt.mavt = tkthang.mavt AND sophieu_nxk='".$this->getSoPhieu()."' ) as thue,chitiet_psvt.tienchietkhau,soluongnhap as slcu,soluongnhap as slcuton,donggianhap as dgcu,thuesuat as thuesuatcu,chietkhau as chietkhaucu,chitiet_psvt.sophieu,psvt.mapskt FROM chitiet_psvt inner join psvt on (chitiet_psvt.sophieu = psvt.sophieu) WHERE 0=0 and chitiet_psvt.sophieu in (" . $this->getSoPhieu() . ") order by chitiet_psvt.sott";
        }else{
            $sql = "SELECT chitiet_psvt.sott,chitiet_psvt.mavt,chitiet_psvt.tenvt,chitiet_psvt.dvt,(SELECT dongiabinhquan as dongia from tkthang where chitiet_psvt.mavt = tkthang.mavt AND month(psvt.ngayghiso)=tkthang.thang and tkthang.makho = psvt.kho ) as donggianhap,chitiet_psvt.soluongnhap,chitiet_psvt.thuesuat,chitiet_psvt.soluongnhap*(SELECT dongiabinhquan from tkthang where chitiet_psvt.mavt = tkthang.mavt AND month(psvt.ngayghiso)=tkthang.thang and tkthang.makho = psvt.kho ) as thanhtien,chitiet_psvt.soluongnhap*(SELECT dongia from tkthang where chitiet_psvt.mavt = tkthang.mavt AND month(psvt.ngayghiso)=tkthang.thang and tkthang.makho = psvt.kho ) as thanhtienchuack,chietkhau,(chitiet_psvt.thuesuat/100)*chitiet_psvt.soluongnhap*(SELECT dongia from tkthang where chitiet_psvt.mavt = tkthang.mavt AND month(psvt.ngayghiso)=tkthang.thang and tkthang.makho = psvt.kho ) as thue,chitiet_psvt.tienchietkhau,soluongnhap as slcu,soluongnhap as slcuton,donggianhap as dgcu,thuesuat as thuesuatcu,chietkhau as chietkhaucu,chitiet_psvt.sophieu,psvt.mapskt FROM chitiet_psvt inner join psvt on (chitiet_psvt.sophieu = psvt.sophieu) WHERE 0=0 and chitiet_psvt.sophieu in (" . $this->getSoPhieu() . ") order by chitiet_psvt.sott";
        }
        $this->query($sql);
        $i = 0;
        $dataton = $this->LoadDanhSachTKHT();
    ...
    function layChiTietPSVT_SX($parentid = 0)
    {
        $trees = array();
        $fill = $this->get_orderby();
        if ($fill != "")
            $sql_w = " and " . $this->get_orderby();
        $sql = "SELECT chitiet_psvt.*,mavt.tkdoanhthu as matk FROM chitiet_psvt inner JOIN mavt on(chitiet_psvt.mavt = mavt.mavt)  WHERE 0=0 $sql_w  order by mavt";
        $this->query($sql);
        $i = 0;
        while ($data = $this->fetch()) {
            $i++;
    ...
    function loadListMaVTXuatNotjon($thang,$makho,$mact)
    {// Lấy danh sách nhập vật tư trong tồn kho
        $trees = array();
        $fill = $this->get_orderby();
        if ($fill != "")
            $sql_w = " and " . $this->get_orderby();
        $sql = "SELECT 0 as sott,mavt.mavt,mavt.tenvt,mavt.dvt,mavt.giaban as donggianhap,sl as soluongnhap,rate as thuesuat,sl as thanhtienchuack,sl as thanhtien,dp as chietkhau,sl as thue,sl as tienchietkhau,sl as slcu,sl as dgcu,rate as thuesuatcu,dp as chietkhaucu,0 as phivc,0 as phibx,0 as tygiant,0 as nguyentent,0 as thanhtiennt,tmp_tkhientai.slton as soluongton FROM mavt LEFT JOIN tmp_tkhientai on (mavt.mavt = tmp_tkhientai.mavt) WHERE tmp_tkhientai.kho='$makho' ".str_replace("mavt", "mavt.mavt", $sql_w)." order by tenvt" . $this->getLimit();
        $this->query($sql);
        $i = 0;
        $datatonDM = $this->LoadDanSachDMNVLHienTai($mact);
        $datagiavon = $this->LoadDanhSachGiaVon($thang,$makho);
    ...
    {// Lấy danh sách nhập vật tư trong tồn kho khi nhấn INSERT
       ...
       $sql = "select * from (SELECT chitiet_psvt.sott,chitiet_psvt.mavt,chitiet_psvt.tenvt,chitiet_psvt.dvt,chitiet_psvt.donggianhap,chitiet_psvt.soluongnhap,chitiet_psvt.thuesuat,chitiet_psvt.thanhtien,thanhtienchuack,chietkhau,thue,tienchietkhau,chitiet_psvt.soluongnhap as slcu,chitiet_psvt.soluongnhap as slcuton,chitiet_psvt.donggianhap as dgcu,chitiet_psvt.thuesuat as thuesuatcu,chietkhau as chietkhaucu,dongiamt,thanhtienmt,thuenk,thuettdb,phivc,phibx,tygiant,nguyentent,thanhtiennt,tmp_tkhientai.slton as soluongton FROM chitiet_psvt LEFT JOIN tmp_tkhientai on (chitiet_psvt.mavt = tmp_tkhientai.mavt) WHERE tmp_tkhientai.kho='$makho' and sophieu= '" . $this->getSoPhieu() . "' " . str_replace("mavt", "chitiet_psvt.mavt", $sql_w) . "  
        ...
        while ($data = $this->fetch()) {
            ...
            $data['thang11'] = $datatonsp[$mavt]['thang11'];
            $data['thang12'] = $datatonsp[$mavt]['thang12'];
            $data['gianhap'] = round($dataton[$mavt], 3);
    ...
    function loadListMaVTXuatUnion($thang,$makho,$mact="")
    {// Lấy danh sách nhập vật tư trong tồn kho khi nhấn INSERT
        $trees = array();
        $fill = $this->get_orderby();
        if ($fill != "")
    ...
    {// Lấy danh sách nhập vật tư trong tồn kho khi nhấn INSERT
        ...
        UNION ALL 
		        SELECT '' as mact,0 as sott,mavt,tenvt,dvt,0 as dongia,0 as soluong,0 as slcu,0 as thanhtien,(select soluong from tmp_tknvlhienthai where tmp_tknvlhienthai.mavt = mavt.mavt and mact='" . $mact . "' )  as soluongton FROM mavt WHERE 0=0 $sql_w order by tenvt" . $this->getLimit();
        $this->query($sql);
        $i = 0;
        $dataton = $this->LoadDanhSachTKHT('0010');
        $datatonsp = $this->LoadDanhSachTKSPHT($mact);
        while ($data = $this->fetch()) {
            $mavt = $data['mavt'];
    ...
    function loadListDanhSachTKTheoThangChiTietCuoiKyTheoNhom($InSoAm, $loctheotk,$listKho,$loctheonhomhang)
    {// Xuất tòn kho cuối kỳ theo từng tháng
        $trees = array();
        $sqlwtk = "";
        if ($loctheotk != "ALL" && $loctheotk != "") {
            $sqlwtk = " and matk='{$loctheotk}' ";
        }
        $sqlwmanhom = "";
        if ($loctheonhomhang != "ALL" && $loctheonhomhang != "") {
            $sqlwmanhom = " and manhom='{$loctheonhomhang}' ";
        }

        $dem = 0;
        foreach ($listKho as $kKho => $itemKho) {
                $dem++;
                $fill = $this->get_orderby();
                if ($fill != "")
                    $sql_w = " and " . $this->get_orderby();
                if ($InSoAm == 1)
                   $sql = "select * from tkthang where thang=" . $this->getThang() . " and ROUND(soluongtonck,3)!=0 and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} order by tenvt";
                if ($InSoAm == 2)
                    $sql = "select * from tkthang where thang=" . $this->getThang() . "  and ROUND(soluongtonck,3) >0 and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} order by tenvt";
                if ($InSoAm == 3)
                    $sql = "select * from tkthang where thang=" . $this->getThang() . " and ROUND(soluongtonck,3) < 0 and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} order by tenvt";
                if ($InSoAm == 4)
                    $sql = "select * from tkthang where thang=" . $this->getThang() . " and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} order by tenvt ";

                $querytk = $this->re_query($sql);
                $i = 0;
                while ($data = $this->re_fetch($querytk)) {
                    $mavt = $data['mavt'];
                    $i++;
                    $data['STT'] = $i;
                    $data['sott'] = "";
                    ...
                    $data['tenkho'] = $itemKho['tenkho'];
                    $trees[$kKho][$data['manhom']][] = $data;
                }
        }
        return $trees;
    }
    ...
    function themTonKhoThangTuTK($thangtk, $listKho)
    { // Tính toàn kho tháng và ghi vào table tk_thang
        ...
        $i = 0;
        foreach ($listKho as $kKho => $itemKho) {
            $sql = "select mavt,tenvt,dvt,matk,mavt.manhom,rate as thuesuat,manhom.tennhom FROM mavt inner join manhom on (mavt.manhom=manhom.manhom) AND manhom.manhom!='1200' ";
            $query = $this->re_query($sql);

            $datanhap = $this->TinhPhatSinhNhap($this->getThangNamTK(), $this->getThangTonKho(), $kKho);
            $dataxuat = $this->TinhPhatSinhXuat($this->getThangNamTK(), $this->getThangTonKho(), $kKho);
            $dataton = $this->TinhPhatSinhTonDKTuTK($kKho);
            while ($data = $this->re_fetch($query)) {
               $mavt = $data['mavt'];
                ...
                $soluongtonck = round($soluongtondk + ($soluongnhap - $soluongxuat),3);
                ...
                if ($soluongtonck == 0) {
                    $thanhtiendulai = (round($thanhtientondk + $thanhtiennhap - $thanhtienxuat));
                    $thanhtientonck = 0;
                    $thanhtienxuat = $thanhtienxuat + $thanhtiendulai;
                } else {
                ...
                //$array_am = array();
                if ($soluongtonck < 0 && in_array($data['mavt'], $array_am) == false) {
                    $array_am[$data['mavt']] = $data['mavt'];
                    echo $thongbaoam = "Mã kho : {$kKho}" . " - " . $data['mavt'] . " - " . $data['tenvt'] . " - (" . number_format($soluongtonck,3) . " " . $data['dvt'] . ") \n ";
                }
                if ((round($thanhtienxuat)<0) && in_array($data['mavt'], $array_am) == false) {
                    $array_am[$data['mavt']] = $data['mavt'];
                    echo $thongbaoam = "Mã kho : {$kKho}" . " - " . $data['mavt'] . " - " . $data['tenvt'] . " - (" .number_format($thanhtienxuat,0) .  " VNĐ) \n ";
                }
                $data['tongtien'] = $trees[$data['matk']]['tongtien'] += $thanhtienxuat;

                $value .= "('" . $data['mavt'] . "','" .htmlentities($data['tenvt'],ENT_QUOTES) . "','" . $data['dvt'] . "','" . $soluongtondk . "','" . $dongiabinhquan . "','" . $thanhtientondk . "','" . $this->getThang() . "','" . $data['matk'] . "','" . $data['manhom'] . "','" . $data['thuesuat'] . "','" . $data['tennhom'] . "','" . $soluongnhap . "','" . $thanhtiennhap . "','" . $soluongxuat . "','" . $thanhtienxuat . "','" . $dongiabinhquan . "','" . $soluongtonck . "','" . $thanhtientonck . "','" . $giaban . "','{$kKho}'),";
                $trees[$data['matk']] = $data;
            }
        }
        $sql_ins = "insert into tkthang(mavt,tenvt,dvt,soluong,dongia,thanhtien,thang,matk,manhom,thuesuat,tennhom,soluongnhap,thanhtiennhap,soluongxuat,thanhtienxuat,dongiabinhquan,soluongtonck,thanhtientonck,giaban,makho) VALUE " . substr($value, 0, -1);
        $this->re_query($sql_ins);
        return $trees;
    }

    function themTonKhoThang($thangtk, $listKho)
    { // Tính toàn kho tháng và ghi vào table tk_thang
        $trees = array();
        $fill = $this->get_orderby();
        if ($fill != "")
        ...
        foreach ($listKho as $kKho => $itemKho) {
            ...
            $dataton = $this->TinhPhatSinhTonDKTuTKTHANGTRUOC($this->getThang(), $kKho);
            while ($data = $this->fetch()) {
                $mavt = $data['mavt'];
                $giaban = 0;
                if ($datanhap == 0) {
                ...
                if ($dataton == 0) {
                    ...
                    $thanhtientondk = 0;
                    $giabandk = 0;
					$dongiabinquanthangtruoc = $dataton[$mavt]['dongiabinhquan'];
                } else {
                    $soluongtondk = $dataton[$mavt]['soluong'];
                    $thanhtientondk = $dataton[$mavt]['thanhtien'];
                    $giabandk = $dataton[$mavt]['giaban'];
                ...
                $dongiabinhquan = round(($thanhtientondk + $thanhtiennhap) / ($soluongtondk + $soluongnhap), 3);
                if($soluongtonck<0){
                    $dongiabinhquan =$dongiabinquanthangtruoc;
                }
				if($soluongtonck==0 && $dongiabinhquan==0){
                    $dongiabinhquan =$dongiabinquanthangtruoc;
                }
                $thanhtienxuat = round($soluongxuat * $dongiabinhquan);// Giá vốn bán hàng
    ...
    function themTonKhoThang_LienHoan($listKho)
    { // Tính toàn kho tháng và ghi vào table tk_thang
        $value="";
        $trees = array();
        $fill = $this->get_orderby();
        ...
        foreach ($listKho as $kKho => $itemKho) {
            $sql = "select mavt,tenvt,dvt,matk,mavt.manhom,rate as thuesuat,manhom.tennhom FROM mavt inner join manhom on (mavt.manhom=manhom.manhom) AND manhom.manhom!='1200' ";
            $this->query($sql);
            $datatondk = $this->TinhPhatSinhTonDKTuTK($kKho);
            $datanhapxuat = $this->TinhPhatSinhNhapXuat(1, 12, $kKho);
            //debug($datanhapxuat);

            while ($data = $this->fetch()) {
                $mavt = $data['mavt'];
                $soluongton = $datatondk[$mavt]['soluong'];
                $thanhtienton = $datatondk[$mavt]['thanhtien'];
                $dongiavon = round($thanhtienton/$soluongton,3);

                $tongsoluongnhap = $datatondk[$mavt]['soluong'];
                $tongthanhtiennhap = $datatondk[$mavt]['thanhtien'];

                foreach ($datanhapxuat[$mavt] as $k=> $itemnhapxuat){
                    $soluongdk = $soluongton;
                    $thanhtiendk = $thanhtienton;
                    $dongiadk = $dongiavon;

                    $thang = date("m",strtotime($itemnhapxuat['ngayghiso']));

                    $tongsoluongnhap = number_format($tongsoluongnhap+$itemnhapxuat['soluongnhap'],4,".","");;
                    $tongthanhtiennhap = $tongthanhtiennhap+$itemnhapxuat['thanhtiennhap'];

                    $thanhtienxuat = round($dongiavon*$itemnhapxuat['soluongxuat']);


                    $soluongton =number_format(($soluongton+$itemnhapxuat['soluongnhap']-$itemnhapxuat['soluongxuat']),4,".","");;;
                    $thanhtienton = ($thanhtiendk+$itemnhapxuat['thanhtiennhap'])-$thanhtienxuat;
                    if($soluongton!=0){
                        $dongiavon = number_format(($thanhtienton/$soluongton),3,".","");
                    }
                    //echo $itemnhapxuat['mapskt']."-".$mavt."-".$soluongton."-".$thanhtienton."-".$dongiavon."<br/>";

                    $value .= "('" . $data['mavt'] . "','" . htmlentities($data['tenvt'],ENT_QUOTES) . "','" . $data['dvt'] . "','".$soluongdk."','".$dongiadk."','".$thanhtiendk."','" . $thang. "','" . $data['matk'] . "','" . $data['manhom'] . "','" . $data['thuesuat'] . "','" . $data['tennhom'] . "','" . $itemnhapxuat['soluongnhap'] . "','" . $itemnhapxuat['thanhtiennhap'] . "','" . $itemnhapxuat['soluongxuat'] . "','" . $thanhtienxuat . "','" . $dongiavon . "','" . $soluongton . "','" . $thanhtienton . "','" . $dongiavon . "','{$kKho}','" . $itemnhapxuat['ngayghiso'] . "','" . $itemnhapxuat['ngayhoadon'] . "','" . $itemnhapxuat['mapskt'] . "','" . $itemnhapxuat['sophieu'] . "'),";
                }

            }
        }
        $sql_ins = "insert into tkthang(mavt,tenvt,dvt,soluong,dongia,thanhtien,thang,matk,manhom,thuesuat,tennhom,soluongnhap,thanhtiennhap,soluongxuat,thanhtienxuat,dongiabinhquan,soluongtonck,thanhtientonck,giaban,makho,ngs,nhd,sottct,sophieu_nxk) VALUE " . substr($value, 0, -1);
        $this->re_query($sql_ins);
        return $trees;
    }
    ...
    {
        $sql = "INSERT INTO ct_nhapvattu_ct (mavt,soluong,dongia,thanhtien,sophieu,mact) VALUES ('" . $this->get_MaVT() . "', '" . $this->getSoLuongNhap() . "','" . $this->getDonGiaNhap() . "','" . $this->getThanhTien() . "','" . $this->getSoPhieu() . "','" . $this->getMaCT() . "');";
        $this->query($sql);
    }
    ...
    {
        //$sql = "UPDATE chitiet_psvt SET soluongnhap ='" . $this->getSoLuongNhap() . "',donggianhap ='" . $this->getDonGiaNhap() . "',thuesuat ='" . $this->getThueSuat() . "',thanhtien='" . $this->getThanhTien() . "',thanhtienchuack='" . $this->getThanhTienChuaCK() . "',thue ='" . $this->getThue() . "',chietkhau ='" . $this->getChietKhau() . "',tienchietkhau ='" . $this->getTienChietKhau() . "',tenkd='" . $this->get_TenKD() . "',dongiamt='" . $this->getDonGiaMT() . "',thanhtienmt='" . $this->getThanhTienMT() . "' WHERE sott='" . $this->get_SoTT() . "' and sophieu='" . $this->getSoPhieu() . "' and mavt='" . $this->get_MaVT() . "';";
        $sql = "UPDATE ct_nhapvattu_ct SET mavt = '" . $this->get_MaVT() . "',soluong ='" . $this->getSoLuongNhap() . "',dongia ='" . $this->getDonGiaNhap() . "',thanhtien='" . $this->getThanhTien() . "',mact='".$this->getMaCT()."' WHERE sott='" . $this->get_SoTT() . "'";
        $this->query($sql);
    }
    ...
    function TinhSLNhap($makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "select sum(soluongnhap) as soluong,AVG(donggianhap) as dongia,chitiet_psvt.mavt from psvt INNER join chitiet_psvt on (psvt.sophieu=chitiet_psvt.sophieu) where loaiphieu=1 and psvt.kho='{$makho}' group by chitiet_psvt.mavt";// Nhập hàng trông tháng
        $query = $this->re_query($sql);
    ...
    function TinhSLXuat($makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "select sum(soluongnhap) as soluong,chitiet_psvt.mavt from psvt INNER join chitiet_psvt on (psvt.sophieu=chitiet_psvt.sophieu) where loaiphieu in ('2','3') and psvt.kho='{$makho}' group by chitiet_psvt.mavt";// Nhập hàng trông tháng
        $query = $this->re_query($sql);
        if ($this->re_num_rows($query) == 0) {
            return 0;
        } else {
    ...
    function TinhPhatSinhNhap($TuNgay, $DenNgay, $makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "select sum(soluongnhap) as soluong,(SUM(thanhtien)+SUM(cpmuahang)) as thanhtien,chitiet_psvt.mavt from psvt INNER join chitiet_psvt on (psvt.sophieu=chitiet_psvt.sophieu) where loaiphieu=1 and ngayghiso<='" . $DenNgay . "' and ngayghiso>='" . $TuNgay . "' and psvt.kho = '{$makho}' group by chitiet_psvt.mavt";// Nhập hàng trông tháng
        $query = $this->re_query($sql);
        //if($this->num_rows() == 0){
        //return 0;
        //}else{
    ...
    function TinhPhatSinhNhapXuat($TuNgay, $DenNgay, $makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT * FROM (select '' as sophieu,'".$_SESSION['kyketoan_tungay']."' as ngayghiso,'".$_SESSION['kyketoan_tungay']."' as ngayhoadon,'' as mapskt,0 as soluongnhap,0 as thanhtiennhap,0 as soluongxuat,0 as thanhtienxuat,mavt,0 as loaiphieu from tk where makho = '{$makho}'
                union all
                select psvt.sophieu,ngayghiso,ngayhoadon,psvt.mapskt,soluongnhap as soluongnhap,(thanhtien+cpmuahang) as thanhtiennhap,0 as soluongxuat,0 as thanhtienxuat,chitiet_psvt.mavt,loaiphieu from psvt INNER join chitiet_psvt on (psvt.sophieu=chitiet_psvt.sophieu) where psvt.loaiphieu=1 and month(ngayghiso)<=" . $DenNgay . " and month(ngayghiso)>=" . $TuNgay . " and psvt.kho = '{$makho}'
                union all
                select psvt.sophieu,ngayghiso,ngayhoadon,psvt.mapskt,0 as soluongnhap,0 as thanhtiennhap,soluongnhap as soluongxuat,thanhtien as thanhtienxuat,chitiet_psvt.mavt,loaiphieu from psvt INNER join chitiet_psvt on (psvt.sophieu=chitiet_psvt.sophieu) where psvt.loaiphieu in ('2','3') and month(ngayghiso)<=" . $DenNgay . " and month(ngayghiso)>=" . $TuNgay . " and psvt.kho = '{$makho}') AS f order by UNIX_TIMESTAMP(ngayghiso) ASC ,loaiphieu ASC
    ...
    function TinhPhatSinhXuat($TuNgay, $DenNgay, $makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "select sum(soluongnhap) as soluong,SUM(thanhtien) as thanhtien,chitiet_psvt.mavt from psvt INNER join chitiet_psvt on (psvt.sophieu=chitiet_psvt.sophieu) where loaiphieu in ('2','3') and ngayghiso<='" . $DenNgay . "' and ngayghiso>='" . $TuNgay . "' and psvt.kho = '{$makho}' group by chitiet_psvt.mavt";// Nhập hàng trông tháng
        $query = $this->re_query($sql);
        ///if($this->num_rows() == 0){
        // return 0;
        //}else{
    ...
    function TinhPhatSinhTonDKTuTK($makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT mavt,slck as soluong,dgxvnd as thanhtien,gtvnck as dongia FROM tk where makho = '{$makho}'";// Nhập hàng trông tháng
        $query = $this->re_query($sql);
        //if($this->num_rows() == 0){
        //return 0;
        // }else{
    ...
    function TinhPhatSinhTonDKTuTKTHANGTRUOC($thang, $makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT mavt,soluongtonck as soluong,thanhtientonck as thanhtien,giaban,dongia as dongiabinhquan FROM tkthang where thang=" . ($thang - 1) . " and makho = '{$makho}'";// Tồn đầu kỳ
        $query = $this->re_query($sql);
        //if($this->num_rows() == 0){
        //return 0;
        //}else{
    ...
    function LoadDanhSachTKHT($makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT mavt,slton FROM tmp_tkhientai where kho='{$makho}'";// Tồn đầu kỳ
        $query = $this->re_query($sql);
    ...
    function LoadDanhSachGiaVon($thang,$makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT mavt,dongiabinhquan as giavon FROM tkthang where thang='{$thang}' and makho='{$makho}'";// Tồn đầu kỳ
        $query = $this->re_query($sql);
    ...
    function LoadDanhSachTKSPHT($mact)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT mavt,thang1,thang2,thang3,thang4,thang5,thang6,thang7,thang8,thang9,thang10,thang11,thang12 FROM tmp_tksphienthai where masp='".$mact."'";// Tồn đầu kỳ
        $query = $this->re_query($sql);
    ...
    function LoadDanSachDMNVLHienTai($mact)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT mavt,sum(soluong) as soluong,mact FROM tmp_tknvlhienthai where mact='{$mact}' group by mact,mavt";// Tồn đầu kỳ
        $query = $this->re_query($sql);
    ...
    function laydanhsachphieunhapkhosanxuat()
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT t1.*,month(t2.ngayghiso) as thang,t3.matk,t2.kho as khohang,t2.mand FROM chitiet_psvt t1 inner join psvt t2 on (t1.sophieu=t2.sophieu) INNER join mavt t3 on(t1.mavt=t3.mavt) where t2.loaiphieu=3";// Tồn đầu kỳ
        $query = $this->re_query($sql);
        while ($data = $this->re_fetch($query)) {
    ...
    function laydanhsachphieuxuatkho_lienhoan()
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT mapskt,sophieu,ngayghiso,MONTH(ngayghiso) as thang,kho,loaiphieu FROM psvt where loaiphieu in ('2','3')";// Tồn đầu kỳ
        $query = $this->re_query($sql);
        while ($data = $this->re_fetch($query)) {
            $row[] = $data;
        }
    ...
    function gettonggiavonxuatkho_lienhoan()
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT sum(thanhtienxuat) as thanhtien,sophieu_nxk,makho,matk FROM tkthang where soluongxuat!=0  group by  sophieu_nxk,matk";// Tồn đầu kỳ
        $query = $this->re_query($sql);
        while ($data = $this->re_fetch($query)) {
            $row[$data['sophieu_nxk']][] = $data;
        }
        return $row;
    ...
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT t2.mapskt,t1.mavt,t1.sophieu,t1.soluongnhap,month(t2.ngayghiso) as thang,t2.ngayghiso,t3.matk,((SELECT dongia from tkthang WHERE thang = month(t2.ngayghiso) and mavt = t1.mavt )*t1.soluongnhap) as thanhtien,t2.kho as khohang FROM chitiet_psvt t1 inner join psvt t2 on (t1.sophieu=t2.sophieu) INNER join mavt t3 on(t1.mavt=t3.mavt) where t2.loaiphieu='2' AND t3.manhom!='1200'";// Tồn đầu kỳ
        $query = $this->re_query($sql);
        while ($data = $this->re_fetch($query)) {
    ...
    function getdongiamavttonkho($mavt, $thang, $makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT dongiabinhquan as dongia from tkthang where mavt='" . $mavt . "' and thang='" . $thang . "' and makho='{$makho}'";// Tồn đầu kỳ
        $query = $this->re_query($sql);
    ...
    function ThemSLTKMaVTHT($listKho)
    {// Lấy danh sách nhập vật tư trong tồn kho
        ...
        if ($fill != "")
            $sql_w = " and " . $this->get_orderby();
        $sql_emp = "delete from tmp_tkhientai";
        $this->re_query($sql_emp);
        $this->re_query("ALTER TABLE tmp_tkhientai AUTO_INCREMENT=1;");
        foreach ($listKho as $kKho => $itemKho) {
            $sql = "SELECT mavt FROM mavt WHERE 0=0 $sql_w  " . $this->getLimit();
            $this->query($sql);

            $datanhap = $this->TinhSLNhap($kKho);
            $dataxuat = $this->TinhSLXuat($kKho);
            $dataton = $this->TinhPhatSinhTonDKTuTK($kKho);
            while ($data = $this->fetch()) {
                $mavt = $data['mavt'];
                if ($datanhap == 0) {
                ...
                $value .= "('" . $data['mavt'] . "','" . $tonconlai . "','" . round($giavon, 2) . "','{$kKho}'),";
                $trees[] = $data;
            }
        }
        $sql_ins = "insert into tmp_tkhientai(mavt,slton,giavon,kho) VALUE " . substr($value, 0, -1);
        $this->re_query($sql_ins);
        return $trees;
    }

    function ThemSLTKMaVTHT_KhiNhapMaVT($listKho)
    {// Lấy danh sách nhập vật tư trong tồn kho
        ...
        //$this->re_query("ALTER TABLE tmp_tkhientai AUTO_INCREMENT=1;");
        foreach ($listKho as $kKho => $itemKho) {
            $sql = "SELECT mavt FROM mavt WHERE 0=0 and mavt NOT in (SELECT mavt from tmp_tkhientai WHERE kho='{$kKho}') " . $this->getLimit();
            $this->query($sql);
            $datanhap = $this->TinhSLNhap($kKho);
            $dataxuat = $this->TinhSLXuat($kKho);
            $dataton = $this->TinhPhatSinhTonDKTuTK($kKho);
    ...
    function loadListDanhSachTKTheoThangChiTietCuoiKyTheoNhom_CongDon($InSoAm, $tuthang, $denthang, $loctheotk, $listKho,$loctheonhomhang)
    {// Xuất tòn kho cuối kỳ theo từng tháng
        $trees = array();
        ...
        foreach ($listKho as $kKho => $itemKho) {
            $datadauky = $this->TinhTonDKTuTK_CongDon($tuthang, $denthang,$kKho);
            $dataphatsinh = $this->TinhPhatSinh_CongDong($tuthang, $denthang,$kKho);
            ...
            if ($fill != "")
                $sql_w = " and " . $this->get_orderby();
            if ($InSoAm == 1)
                $sql = "select * from tkthang where thang=" . $this->getThang() . " and ROUND(soluongtonck,1)!=0 and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} order by tenvt";
            if ($InSoAm == 2)
                $sql = "select * from tkthang where thang=" . $this->getThang() . " and ROUND(soluongtonck,1) >0 and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} order by tenvt";
            if ($InSoAm == 3)
                $sql = "select * from tkthang where thang=" . $this->getThang() . " and ROUND(soluongtonck,1) and makho='".$kKho."' < 0 {$sqlwtk} {$sqlwmanhom} order by tenvt";
            if ($InSoAm == 4)
                $sql = "select * from tkthang where thang=" . $this->getThang() . " and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} order by tenvt ";
            $this->query($sql);
            $i = 0;
    ...
    function loadListDanhSachTKTheoThangChiTietCuoiKyTheoNhom_CongDon_LienHoa($InSoAm, $tuthang, $denthang, $loctheotk, $listKho,$loctheonhomhang)
    {// Xuất tòn kho cuối kỳ theo từng tháng
        $trees = array();
        ...
        foreach ($listKho as $kKho => $itemKho) {
            ...
            if ($fill != "")
                $sql_w = " and " . $this->get_orderby();
            if ($InSoAm == 1)
                //echo $sql = "select * from tkthang where thang=" . $denthang . " and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} order by sott";
                $sql = "select sott, mavt, tenvt, matk, dvt, soluong, dongia, thanhtien, soluongnhap, thanhtiennhap, soluongxuat, thanhtienxuat, thanhtientonck, dongiabinhquan, soluongtonck, thuesuat, makho, tenkho, quycach, manhom, tennhom, thang, giaban, sophieu_nxk, ngs, nhd, sottct from tkthang where thang=" . $denthang . " {$sqlwtk} {$sqlwmanhom} and makho='".$kKho."'
                    UNION ALL
                    select sott, mavt, tenvt, matk, dvt, soluongtonck as soluong, dongia,thanhtientonck as thanhtien, 0 AS soluongnhap, 0 AS thanhtiennhap, 0 AS soluongxuat, 0 AS thanhtienxuat,thanhtientonck, dongiabinhquan, soluongtonck, thuesuat, makho, tenkho, quycach, manhom, tennhom, thang, giaban, sophieu_nxk, ngs, nhd, '' as sottct from tkthang a where thang<" . $denthang . " {$sqlwtk} {$sqlwmanhom} and makho='".$kKho."' AND sott in(select max(sott) from tkthang where thang<" . $denthang . " GROUP BY mavt ) GROUP by mavt order by sott";
            if ($InSoAm == 2)
                //$sql = "select * from tkthang where thang=" . $denthang . " and ROUND(soluongtonck,3) >0 and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} order by sott";
                $sql = "select sott, mavt, tenvt, matk, dvt, soluong, dongia, thanhtien, soluongnhap, thanhtiennhap, soluongxuat, thanhtienxuat, thanhtientonck, dongiabinhquan, soluongtonck, thuesuat, makho, tenkho, quycach, manhom, tennhom, thang, giaban, sophieu_nxk, ngs, nhd, sottct from tkthang where thang=" . $denthang . " and ROUND(soluongtonck,3) >0 {$sqlwtk} {$sqlwmanhom} and makho='".$kKho."'
                    UNION ALL
                    select sott, mavt, tenvt, matk, dvt, soluongtonck as soluong, dongia,thanhtientonck as thanhtien, 0 AS soluongnhap, 0 AS thanhtiennhap, 0 AS soluongxuat, 0 AS thanhtienxuat, thanhtientonck, dongiabinhquan, soluongtonck, thuesuat, makho, tenkho, quycach, manhom, tennhom, thang, giaban, sophieu_nxk, ngs, nhd, '' as sottct from tkthang a where thang<" . $denthang . " {$sqlwtk} {$sqlwmanhom} and makho='".$kKho."' AND sott in(select max(sott) from tkthang where thang<" . $denthang . " GROUP BY mavt ) GROUP by mavt order by sott";
            ...
            if ($InSoAm == 4)
                //$sql = "select * from tkthang where thang=" . $denthang . " and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} order by sott ";
                $sql = "select sott, mavt, tenvt, matk, dvt, soluong, dongia, thanhtien, soluongnhap, thanhtiennhap, soluongxuat, thanhtienxuat, thanhtientonck, dongiabinhquan, soluongtonck, thuesuat, makho, tenkho, quycach, manhom, tennhom, thang, giaban, sophieu_nxk, ngs, nhd, sottct from tkthang where thang=" . $denthang . " {$sqlwtk} {$sqlwmanhom} and makho='".$kKho."'
                    UNION ALL
                    select sott, mavt, tenvt, matk, dvt, soluongtonck as soluong, dongia,thanhtientonck as thanhtien, 0 AS soluongnhap, 0 AS thanhtiennhap, 0 AS soluongxuat, 0 AS thanhtienxuat, thanhtientonck, dongiabinhquan, soluongtonck, thuesuat, makho, tenkho, quycach, manhom, tennhom, thang, giaban, sophieu_nxk, ngs, nhd, '' as sottct from tkthang a where thang<" . $denthang . " {$sqlwtk} {$sqlwmanhom} and makho='".$kKho."' AND sott in(select max(sott) from tkthang where thang<" . $denthang . " GROUP BY mavt ) GROUP by mavt order by sott";
            $this->query($sql);
    ...
    function loadListDanhSachTKTheoThangChiTietCuoiKyTheoNhom_CongDon_LienHoa_TongHop($InSoAm, $tuthang, $denthang, $loctheotk, $listKho,$loctheonhomhang)
    {// Xuất tòn kho cuối kỳ theo từng tháng
        $trees = array();
        ...
        foreach ($listKho as $kKho => $itemKho) {
            $datadauky = $this->TinhTonDKTuTK_CongDon_LienHoan($tuthang, $denthang,$kKho);
            //$dataphatsinh = $this->TinhPhatSinh_CongDong($tuthang, $denthang,$kKho);
            ...
            if ($fill != "")
                $sql_w = " and " . $this->get_orderby();
            if ($InSoAm == 1)
                $sql = "select mavt,tenvt,dvt,manhom,sum(soluongnhap) as soluongnhap,sum(thanhtiennhap) as thanhtiennhap,sum(soluongxuat) as soluongxuat,sum(thanhtienxuat) as thanhtienxuat from tkthang where thang>=" . $tuthang . " and thang<=" . $denthang . " and ROUND(soluongtonck,1)!=0 and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} group by mavt order by tenvt";
            if ($InSoAm == 2)
                $sql = "select mavt,tenvt,dvt,manhom,sum(soluongnhap) as soluongnhap,sum(thanhtiennhap) as thanhtiennhap,sum(soluongxuat) as soluongxuat,sum(thanhtienxuat) as thanhtienxuat from tkthang where thang>=" . $tuthang . " and thang<=" . $denthang . " and ROUND(soluongtonck,1) >0 and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} group by mavt order by tenvt";
            if ($InSoAm == 3)
                $sql = "select mavt,tenvt,dvt,manhom,sum(soluongnhap) as soluongnhap,sum(thanhtiennhap) as thanhtiennhap,sum(soluongxuat) as soluongxuat,sum(thanhtienxuat) as thanhtienxuat from tkthang where thang>=" . $tuthang . " and thang<=" . $denthang . " and ROUND(soluongtonck,1) and makho='".$kKho."' < 0 {$sqlwtk} {$sqlwmanhom} group by mavt order by tenvt";
            if ($InSoAm == 4)
                $sql = "select mavt,tenvt,dvt,manhom,sum(soluongnhap) as soluongnhap,sum(thanhtiennhap) as thanhtiennhap,sum(soluongxuat) as soluongxuat,sum(thanhtienxuat) as thanhtienxuat from tkthang where thang>=" . $tuthang . " and thang<=" . $denthang . " and makho='".$kKho."' {$sqlwtk} {$sqlwmanhom} group by mavt order by tenvt ";
            $this->query($sql);
            $i = 0;
            while ($data = $this->fetch()) {
                $mavt = $data['mavt'];
                ...
                $data['soluongtonck'] = $datadauky[$mavt]['soluong']+$data['soluongnhap']-$data['soluongxuat'];
                $data['thanhtientonck'] = $datadauky[$mavt]['thanhtien']+$data['thanhtiennhap']-$data['thanhtienxuat'];
                if($data['soluongtonck']==0 ||$data['thanhtientonck']==0 ){
                    $data['soluongtonck'] =0;
                    $data['thanhtientonck'] =0;
                }
                $data['dongiabinhquan'] = $data['dongiabinhquan'];
    ...
    function loadListDanhSachTKTheoThangChiTietCuoiKyTheoNhom_LienHoa($InSoAm, $tuthang, $denthang, $loctheotk, $listKho,$loctheonhomhang)
    {// Xuất tòn kho cuối kỳ theo từng tháng
        $trees = array();
    ...
    function TinhTonDKTuTK_CongDon($tungay, $denngay,$makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        if ($tungay == 1) {
            $sql = "SELECT mavt,slck as soluong,dgxvnd as thanhtien,gtvnck as dongia FROM tk WHERE makho='{$makho}'";// Nhập hàng trông tháng
        } else {
            $sql = "SELECT mavt,soluongtonck as soluong,thanhtientonck as thanhtien,dongiabinhquan as dongia,makho FROM tkthang where thang='" . ($tungay - 1) . "' and makho='{$makho}'";// Nhập hàng trông tháng
        }
        $query = $this->re_query($sql);
        while ($data = $this->re_fetch($query)) {
            $row[$data['mavt']] = $data;
    ...
    function TinhTonDKTuTK_CongDon_LienHoan($tungay, $denngay,$makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        if ($tungay == 1) {
            $sql = "SELECT mavt,slck as soluong,dgxvnd as thanhtien,gtvnck as dongia FROM tk WHERE makho='{$makho}'";// Nhập hàng trông tháng
        } else {
            $sql = "SELECT mavt,soluongtonck as soluong,thanhtientonck as thanhtien,dongiabinhquan as dongia,makho,max(sott) FROM tkthang where thang<" . ($tungay) . " and makho='{$makho}' group by mavt";// Nhập hàng trông tháng
        }
        $query = $this->re_query($sql);
        while ($data = $this->re_fetch($query)) {
            $row[$data['mavt']] = $data;
    ...
    function TinhPhatSinh_CongDong($tungay, $denngay,$makho)
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT mavt,sum(soluongnhap) as soluongnhap,sum(thanhtiennhap) as thanhtiennhap,sum(soluongxuat) as soluongxuat,sum(thanhtienxuat) as thanhtienxuat FROM tkthang where  thang>='" . ($tungay) . "' and thang<='" . $denngay . "' and makho='{$makho}' group by mavt";// Nhập hàng trông tháng
        $query = $this->re_query($sql);
        while ($data = $this->re_fetch($query)) {
            $row[$data['mavt']] = $data;
        }
    ...
    public function sumthangtienpsgiavon($thang)// Lấy tổng giá vốn đã kết chuyển từ phiếu xuất kho và phiếu xuất kho sản xuất
    {
        $sql_w = $this->get_orderby();
        $sql = "select sum(tongtiengiavon) as tongtiengiavon,matk from (select sum(gtvnd1) as tongtiengiavon,tkno1 as matk from chitiet_pskt where MONTH(ngayhoadon) ='{$thang}' and loaiphieu='65' GROUP BY tkno1 
                UNION ALL 
                select sum(sotien) as tongtiengiavon,dinhkhoan_psvt.tkco as matk from psvt INNER JOIN dinhkhoan_psvt on (psvt.sophieu = dinhkhoan_psvt.sophieu) WHERE month(ngayghiso)='{$thang}' and loaiphieu='3' GROUP BY dinhkhoan_psvt.tkco) t GROUP BY matk";
        $this->query($sql);
        while ($data = $this->fetch()) {
            $row[$data['matk']] = $data;
        }
    ...
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT t1.sophieu,t3.matk,t1.mavt,t1.soluongnhap,t1.sott FROM chitiet_psvt t1 inner join psvt t2 on (t1.sophieu=t2.sophieu) INNER join mavt t3 on(t1.mavt=t3.mavt) INNER JOIN masp t4 on (t1.mavt = t4.masp) where t2.loaiphieu=1 and t4.loaisp='SP'";// Tồn đầu kỳ
        $query = $this->re_query($sql);
        while ($data = $this->re_fetch($query)) {
            $row[$data['sophieu']][] = $data;
        }
    ...
    function laydanhsachphieunhapkhosanxuat_tu_denngay($TuNgay,$DenNgay)//// Lấy thông tin nhập kho để sản xuất-------------
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT t1.sophieu,t3.matk,t1.mavt,t1.soluongnhap,t1.sott FROM chitiet_psvt t1 inner join psvt t2 on (t1.sophieu=t2.sophieu) INNER join mavt t3 on(t1.mavt=t3.mavt) INNER JOIN masp t4 on (t1.mavt = t4.masp) where t2.ngayghiso >='".$TuNgay."' and t2.ngayghiso <='".$DenNgay."' and  t2.loaiphieu=1 and t4.loaisp='SP'";// Tồn đầu kỳ
        $query = $this->re_query($sql);
        while ($data = $this->re_fetch($query)) {
            $row[$data['sophieu']][] = $data;
        }
    ...
    function laydanhsachphieunhapkhosanxuathd_($TuNgay,$DenNgay)//// Lấy thông tin nhập kho để sản xuất-------------
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT t1.sophieu,t3.matk,t1.mavt,t1.soluongnhap,t1.sott,t2.loaisp,t2.makho masp FROM chitiet_psvt t1 inner join psvt t2 on (t1.sophieu=t2.sophieu) INNER join mavt t3 on(t1.mavt=t3.mavt) where t2.ngayghiso >='".$TuNgay."' and t2.ngayghiso <='".$DenNgay."' and t2.loaiphieu=1 and t2.loaisp='HD'";// Tồn đầu kỳ
        $query = $this->re_query($sql);
        while ($data = $this->re_fetch($query)) {
            $row[$data['sophieu']][] = $data;
        }
    ...
    {// Tính phát sinh nhập trong khoản thời gian nhất định
        $sql = "SELECT masp,sum(thanhtien) as dongia FROM `banggiathanhtieuchuan` group by masp";// Tồn đầu kỳ
        $query = $this->re_query($sql);
        while ($data = $this->re_fetch($query)) {
