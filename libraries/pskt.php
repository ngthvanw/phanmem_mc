...
class pskt extends database
{
    ...
    {// Kiểm tra xem phiếu nhập kho có tòn tại chưa
        $sql = "select chitiet_pskt.sct,pskt.mapskt,ngayghiso,pskt.loaiphieu from pskt inner join chitiet_pskt on (pskt.sophieu = chitiet_pskt.sophieu) where pskt.loaiphieu%2=0 and CAST(chitiet_pskt.sct AS SIGNED) ='" . $this->getSCT() . "' and pskt.sophieu!='" . $this->getSoPhieu() . "' and pskt.makh='" . $this->getMaKH() . "'
                union all
    ...
    {// Kiểm tra xem phiếu nhập kho có tòn tại chưa
        $sql = "select chitiet_pskt.sct,pskt.mapskt,ngayghiso,pskt.loaiphieu from pskt inner join chitiet_pskt on (pskt.sophieu = chitiet_pskt.sophieu) where pskt.loaiphieu%2=1 and CAST(chitiet_pskt.sct AS SIGNED) ='" . $this->getSCT() . "' and pskt.sophieu!='" . $this->getSoPhieu() . "' and chitiet_pskt.seri='" . $this->getSeri() . "'
        union all
