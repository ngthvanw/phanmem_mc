    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_baocaothue + "laythongtininphieukekhaithue_dautu.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                loadiFrame('modules/baocaothue/inphieu_tokhai_thuegtgt_theopp_dautu.php?<?php echo $query; ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $('.dialog_main_print').load("form/print_bangke_thuegtgt_dautu.php?<?php echo $query; ?>");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="TỜ KHAI THUẾ GTGT DÀNH CHO DỰ ÁN ĐẦU TƯ"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
