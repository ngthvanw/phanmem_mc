...
<div id="dialog-tangtaisan" title="THIẾT LẬP TÀI SẢN CỐ ĐỊNH (F8: XOÁ PHIẾU)">
            ...
            <table class="table-dialog" style="vertical-align: middle;width: 100%" border="0">
                <tr>
                    ...
                    <td width="27%"><span style="padding: 2px">
                      <input type="hidden" name="ngayghiso" value="<?php echo $_SESSION['NienDo']."/01/01"; ?>" style="width:97%" id="ngayghiso"
                               required="require"
                 ...
                 <td width="17%" style="padding: 2px"><label for="name13"> Tham chiếu :</label></td>
                   ...
                   <td width="17%" style="padding: 2px"><label for="name13"> Ngày :</label></td>
                    <td width="27%"><span style="padding: 2px">
                      <input type="date" name="ngay" value="<?php echo $_SESSION['NienDo']."/01/01"; ?>" style="width:97%" id="ngay"
                               required="require"
                               placeholder="Ngày ghi sổ" class="text ui-widget-content ui-corner-all"/>
                    </span></td>
          ...
          <table width="100%" border="0">
               ...
               <tr>
                  ...
                  <td colspan="5"><input name="mataisan" type="text"
                               class="text ui-widget-content ui-corner-all" disabled="disabled" id="mataisan" style="width: 20%" value=""/>
...
///-------------------Kết thúc--------------------------------
       function layngayghiso($loaiphieu){
        ...
        $(btnstt).click(function (event) {// Gọi table khách hàng để chọn
            $('.dialog_main_ds_nhapkho').load("form/frm_ds_tanggiam_taisan.php?idstyle=Form-chinh&idinput=STT&idfocus=STT&loaiphieu=0");
        });
