                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                window.open($dir_module_baocaothue+"xuatexcelbangke_kiemtra_nganhang.php");
                            }else{
                                loadiFrame('tcpdf/baocao/inbangke_kiemtra_thanhtoan_quanganhang.php?sole=<?php echo $sole ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
                            window.open("tcpdf/baocao/inbangke_kiemtra_thanhtoan_quanganhang.php?sole=<?php echo $sole ?>","bankemuavao","menubar=0,resizable=1");
                        }
                    }
                }
            });
