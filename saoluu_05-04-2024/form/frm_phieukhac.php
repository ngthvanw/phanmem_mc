            ...
            if (valid) {
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if ($LoaiPhieu == 4 && (tkno1.val().trim().substring(0,3) == "211" || tkno2.val().trim().substring(0,3) == "211" || (tkno1.val().trim().substring(0,3) == "242") || (tkno1.val().trim().substring(0,3) == "241") || tkno1.val().trim() == "1562")) {
