        ...
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
                <tr>
                    ...
                    <td width="70%"><select name="MaKhachHang" style="width:100%;height:25px;" id="MaKhachHang">
                        </select></td>
                </tr>
            </table>
        </fieldset>
                    ...
                    buttons: {
                        "OK": {
                            keys: ['Y'], action: function () {
                                $('.dialog_main_thongbao').load("form/frm_insolieu_tonghopno_khachhang.php?tungay=" + $tungay + "&denngay=" + $denngay + "&mataikhoan=" + $mataikhoan + "&loaitien=" + $loaitien + "&theothongtu=" + $theothongtu + "&kieuin=" + $kieuin + "&makhachhang=" + $makhachhang + "&nhomkhachhang=" + $nhomkhachhang + "&xemtonghop=" + $xemtonghop);
                            }
                        }
                    }
                });
