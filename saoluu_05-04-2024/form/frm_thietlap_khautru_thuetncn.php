            ...
            change: function (evt, ui) {// Khi dữ liệu thay đổi                
                ...
                var rowList = ui.rowList,
                    ...
                    var obj = rowList[0],
                        ...
                        type = obj.type,
                        rowData = obj.rowData;
                var column = $("#grid_editing_bangcandoi_ketoan").pqGrid( "getData", { dataIndx: ['sotien', 'machitieu','sott','kytinhthue','loaitokhai'] } );
					...
					if (type == 'update') {
                        ...
                        if (valid) {
                            if (rowData[recIndx] == null) {
                                ...
                                url = $dir_module_baocaothue+"edit_sotien_tokhai_khautru_thuetncn.php";
                            }
                            else {
...
colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                    ...
                    { title: "STT", dataType: "string",editable: false, dataIndx: "maso", width: 80,sortable: false,align: "center"},

                     { title: "Chỉ tiêu", width: 450,editable: false, dataType: "string", dataIndx: "chitieu",sortable: false,
                        validations: [
                    ...
                    { title: "Mã Chỉ tiêu cha",editable: false, width: 80, dataType: "string", align: "center", dataIndx: "machitieucha",sortable: false
                    },
                    { title: "Đơn vị tính",editable: false, dataType: "string",align: "center", dataIndx: "donvitinh", width: 80,sortable: false},
                    { title: "Số người/Số tiền", width: 200, dataType: "integer", dataIndx: "sotien",align:"right",
                        render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                            return $.number(ui.rowData.sotien,0,".",",");
                        }
                    },
                     { title: "Kỳ tính thuế",editable: false, dataType: "string",align: "center", dataIndx: "kytinhthue", width: 80,sortable: false},
                     { title: "Loại tờ khai",editable: false, dataType: "string",align: "center", dataIndx: "loaitokhai", width: 80,sortable: false,hidden:true},
            ],//-----------------------------------------Kết thúc các cột---------------------------------------
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                postData: {loaitokhai:"<?php echo $LoaiToKhai; ?>",thangtinhthue:"<?php echo $ThangTinhThue; ?>",namtinhthue:"<?php echo $NamTinhThue; ?>"},
                url: $dir_module_baocaothue+"list_tokhai_khautru_thuetncn.php",//-- Load danh sách lên lưới
...
<div id="dialog-thietlap_tokhai_phuluckqkd" title="<?php if($LoaiToKhai=='TNDN') echo 'THIẾT LẬP TỜ KHAI KHẤU TRỪ THUẾ TNCN'; else echo 'THIẾT LẬP TỜ KHAI KHẤU TRỪ THUẾ TNCN';?>"><!-- dialog -->
