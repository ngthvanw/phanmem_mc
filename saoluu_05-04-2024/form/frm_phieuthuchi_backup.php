                                                    ...
                                                    ?>
                                                        <select id="hoadondientu" style="width: 100%;height:20px;">
                                                            ...
                                                            if($_SESSION['chukysodaky']=='1'){
                                                                ...
                                                                <option value="2">3.Hoá đơn điều chỉnh</option>
                                                                <option value="3">4.Hoá đơn thay thế</option>
                                                                <option value="4">5.Huỷ xoá đơn</option>
                                                            ...
                                                            <?php }else{
                                                                ...
                                                                <option value="2">2.Hoá đơn điều chỉnh</option>
                                                                <option value="3">3.Hoá đơn thay thế</option>
                                                                <option value="4">4.Huỷ xoá đơn</option>
                                                                <option value="8">5.Lập hóa đơn nháp</option>
...
// Khai báo các btntkco trên form
        ...
        function giam30theonghidinh(){
            ...
            $DenNgayGiamThue_20 = new Date("2022/12/31");
...

            {
                ...
                if('<?php echo $_SESSION['nhacungcaphddt']; ?>'=='viettel') {////// HOÁ ĐƠN ĐIỆN TỬ CỦA VIETTEL
                            ...
                            if ($hoadondientu == '1' || $hoadondientu == '8') {// Lập hoá đơn gốc
                                var $data = {
                                    "generalInvoiceInfo": {
                                        ...
                                        "templateCode": $("#mauso").val(),
                                        "invoiceSeries": $("#kyhieu").val().trim().toUpperCase(),
                                        "invoiceIssuedDate": $NgayLapHoaDon.getTime(),
                                        "currencyCode": "VND",
                                        "adjustmentType": "1",
                                        "paymentStatus": true,
                                        "paymentType": "TM/CK",
                    ...
                    if ("<?php echo $_SESSION['thietlaphddt'] ?>" == "1") {
                        if (valid && $LoaiPhieu == 1 && ($LoaiCT == '1' || $LoaiCT == '2') && $hoadondientu != 0 && $hoadondientu != 9 && $loaitokhai == '1' && "<?php echo $_SESSION['txt_hddt_tendangnhap'] ?>" != "" && "<?php echo $_SESSION['txt_hddt_matkhau'] ?>" != "" && "<?php echo $_SESSION['txt_hddt_duongdan'] ?>" != "") {// Nếu là phiếu chi và loại chứng từ là thuế GTGT thì thực hiện lập hoá đơn điện tử
                            ...
                            var $NgayLapHoaDon = $NgayHoaDon[1] + "/" + $NgayHoaDon[2] + "/" + $NgayHoaDon[0];
                            ...
                            if ($hoadondientu == '1' || $hoadondientu == '8') {// Lập hoá đơn gốc
                                var $data = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"+
                                            ...
                                            "      <ACpass><?php echo $_SESSION['txt_PartnerToken']; ?></ACpass>"+
                                            "      <xmlInvData><![CDATA[<Invoices>" +
                                                                            "<Inv>" +
                                                                                ...
                                                                                "<Invoice>" +
                                                                                    ...
                                                                                    "<AmountInWords>Năm mươi nghìn đồng</AmountInWords>" +
                ...
                if (valid) {
                    $.ajax({
                        ...
                        success: function (result) {
                            if ($LoaiPhieu%2==0 && (tkno1.val().trim() == "2111" || tkno1.val().trim() == "2112" || tkno1.val().trim() == "2113" || tkno2.val().trim() == "2111" || tkno2.val().trim() == "2112" || tkno2.val().trim() == "2113" || (tkno1.val().trim().substring(0,3) == "242") || (tkno1.val().trim().substring(0,3) == "241") || tkno1.val().trim() == "1562")) {
                                if ((tkno1.val().trim() == "2111" || tkno1.val().trim() == "2112" || tkno1.val().trim() == "2113" || tkno2.val().trim() == "2111" || tkno2.val().trim() == "2112" || tkno2.val().trim() == "2113")) {
                                    ...
                                    if (window.confirm("Số liệu phát sinh này liên quan đến xây dựng cơ bản dở dang . \n Muốn hiển thị cửa sổ nhập xây dựng cơ bản dở dang ?")) {
                                        xoadialog_phieuthuchi();
                                        $('.dialog_main_tangtaisan').load('form/frm_tang_xdcoban_dodang.php?sottphieukhac=' + sophieu.val().trim() + '&form=frm_phieuthuchi&nguyengia=' + sotien1.val().trim() + '&tk=' + tkno1.val().trim() + '&ngayghiso=' + ngayghiso.val().trim());
