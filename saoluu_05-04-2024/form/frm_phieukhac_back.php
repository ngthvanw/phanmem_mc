        ...
        <fieldset style="background-color: #afd9ee">
            <table class="table-dialog" style="vertical-align: middle;width: 780PX" border="0">
                <tr>
                    ...
                    <td width="309"><span style="padding: 2px">
                      <input type="text" name="tkco" value="" id="tkco" list="listmataikhoan" required="required"
                             style="width: 15%"
                      ...
                      <input name="tentkco" type="text" disabled="disabled" required="required"
                             ...
                             placeholder="Tài khoản" style="width: 82%" value=""/>
                    </span></td>
            ...
            <table border="0" class="table-dialog" style="vertical-align: middle;width: 780PX">
                <tr>
                    ...
                    <td width="70px">
                        <input type="text" name="STT" id="STT" value="" style="width:80px"
            ...
            <table class="table-dialog" style="vertical-align: middle;width: 780PX" border="0">
                ...
                <tr>
                    ...
                    <td colspan="3" style="padding: 2px">
                        <input name="tencanhan" type="text" required list="listtencanhan"
                               ...
                               style="width: 100%"/>
                        <datalist id="listtencanhan"></datalist>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="220" style="padding: 2px" valign="top">
                        <table width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td><input style="text-transform: uppercase" type="text" name="kyhieu"
                                           onkeyup="return KhuDauTiengViet(this.value,'#kyhieu')" value=""
                        ...
                        <table width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td colspan="2" id="users-contain"><input type="hidden" class="button" name="btnbophan"
                                    ...
                                    <datalist id="listmacongtrinh"></datalist>
                                ...
                                <td colspan="3">
                                    <table width="100%" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align="right"><b style="font-size: 12px;">HĐĐT:&nbsp;</b>
                                            </td>
                                            <td align="right" width="21%">
                                                ...
                                                <input type="hidden" id="txt_chuky">
                                            </td>
                                            <td width="4%">&nbsp;</td>
                                            <td width="21%"><b style="font-size: 11px;background-color: orange;"
                                                               id="TXTLoaiHoaDonDienTu">Chưa lập HĐĐT</b></td>
                                        </tr>
                                        <tr id="trvanbanthoathuan">
                                            <td width="4%">&nbsp;</td>
                                            <td colspan="2"><b style="font-size: 12px;">Văn bản thoả thuận:</b></td>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <select style="width:100%;" id="loaihanghoadichvu">
                                                    <option value="1">1. Hàng hóa dịch vụ dùng riêng cho SXKD chịu thuế
                                                        GTGT và sử dụng cho các hoạt động cung cấp hàng hóa, dịch vụ
                                                        không kê khai, nộp thuế GTGT đủ điều kiện khấu trừ thuế
                                                    </option>
                                                    <option value="2">2. Hàng hóa, dịch vụ không đủ điều kiện khấu trừ
                                                    </option>
                                                    <option value="3">3. Hàng hóa, dịch vụ dùng chung cho SXKD chịu thuế
...
<script>
    ...
    $(function () {
        /////////////////////////////////////////////////////// Danh sách Autocomplex
        {
            ...
            var $listtencanhan = "";// Danh sách khách hàng
            ...
            $.ajax({// Load danh sách mã khách hàng
                ...
                success: function (response) {
                    ...
                    for (var i = 0; i < $array.length; i++) {
                        ...
                        $listtencanhan += '<option value="' + $array[i].tenkh + '">' + $array[i].masothue + '-' + bodauTiengViet($array[i].tenkh) + '</option>';
                    }
                }
            });
            ...
            $("#listtencanhan").html($listtencanhan);
...
/// bắt dầu mã bộ phận
            ...
            $("#listmacongtrinh").html($listmabophan);
            ////// kết thúc mã bộ phận
...
///-------------------------Di chuyễn các phần tử bằng enter----------------
        ...
        function LapHoaDonDienTu($LoaiHoaDon, $data) {
            $chukyso = $("#txt_chuky").val().trim();
            $ketqua = "";
            $res = {
                "errorCode": "INVOICE_ISSUED_DATE_INVALID",
                "description": "Không kết nối được tới máy chủ !"
            }
            if(($LoaiHoaDon==1 || $LoaiHoaDon==2 || $LoaiHoaDon==3) && "<?php echo $_SESSION['txt_seritoken'] ?>"!="" && $chukyso==""){
                $.ajax({// Load danh sách mã khách hàng
                    url: "taohoadondientu_usb.php",
                    async: false,
        ...
        function checkSoTTTrung($LoaiPhieu) {// Check key khi nhấn submit
            ...
            if ($sottpsct != "") {
                $.ajax({
                    url: $dir_module_ps_kt + "kiemtrasott.php",
                    data: {
                        loaiphieu: $LoaiPhieu,
                        sophieu: $sophieu,
                        sottpsct: $sottpsct
...
// Khai báo các btntkco trên form
        ...
        function goitablemakhachhang2($vale) {
            if ($vale == "") {// nếu tk nợ trống thì bật tra bảng
                ...
                if ($data != null) { // Nếu tk có tòn tại trong hệ thống tài khoản thì lấy giá trị và gán vào textbox
                    ...
                    $('.dialog_main_makh').load("form/frm_dm_makh_form_select.php?idstyle=Form-chinh&idinput=makhachhang2***tenkhachhang2***diachi2***masothue2&idfocus=btnbophan&ma=" + $("#makhachhang2").val());
                }
            }
        }
        ...
        $(btnthem).click(function (event) {// Gọi table khách hàng để chọn
            ...
            $tkco = tkco.val().trim();
            $tktkno1 = tkno1.val().trim();
            $tktkno2 = tkno2.val().trim();
            $makhachhang = $("#makhachhang").val().trim();
            $makhachhang3 = $("#makhachhang3").val().trim();
            $loitk = true;
            if (($tkco.substring(0, 3) == 111 || $tkco.substring(0, 3) == 112) && $makhachhang == $makhachhang3) {
                alert("Không thể sử dụng tài khoản " + $tkco + " trong phiếu định khoản .");
                tkco.focus();
                return false;
            }
            if (($tktkno1.substring(0, 3) == 111 || $tktkno1.substring(0, 3) == 112) && $makhachhang == $makhachhang3) {
                alert("Không thể sử dụng tài khoản " + $tktkno1 + " trong phiếu định khoản .");
                tkno1.focus();
                return false;
            }
            if (($tktkno2.substring(0, 3) == 111 || $tktkno2.substring(0, 3) == 112) && $makhachhang == $makhachhang3) {
                alert("Không thể sử dụng tài khoản " + $tktkno2 + " trong phiếu định khoản .");
                tkno2.focus();
                return false;
            }
            ...
            var Reg_MauSo = new RegExp("^[A-Z]{0,4}[-]{0,1}[0-9]{1,10}$");
            valid = valid && checkRegexp(STT, Reg_MauSo, " Số phiếu không đúng định dạng. Ví dụ: PC-00001.");
            ...
            if (($tkco == $tktkno1 && $tkco != "" && $tktkno1 != "") || ($tkco == $tktkno2 && $tkco != "" && $tktkno2 != "")) {
                $thongbao = "";
            ...
            if (($LoaiPhieu % 2) == 0 && $("#chonloaisp").val() == 0 && ($tkco == 621 || $tkco == 622 || $tkco == 623 || $tkco == 627 || $tktkno1 == 621 || $tktkno1 == 622 || $tktkno1 == 623 || $tktkno1 == 627 || $tktkno2 == 621 || $tktkno2 == 622 || $tktkno2 == 623 || $tktkno2 == 627)) {
            ...
            $loaihoadondientu = 0;
            if (valid && $LoaiPhieu == 3 && $LoaiCT == '1' && $hoadondientu != 0 && $loaitokhai == '1' && "<?php echo $_SESSION['thietlaphddt'] ?>" == "1" && "<?php echo $_SESSION['txt_hddt_tendangnhap'] ?>" != "" && "<?php echo $_SESSION['txt_hddt_matkhau'] ?>" != "" && "<?php echo $_SESSION['txt_hddt_duongdan'] ?>" != "") {// Nếu là phiếu chi và loại chứng từ là thuế GTGT thì thực hiện lập hoá đơn điện tử
               ...
               // $("#masothue2").val("");
                ...
                if ($checkphieuthuchi == 0) {
                            ...
                            buttons: {
                                "ĐỒNG Ý": {
                                    keys: ['Y'], action: function () {
                                        ...
                                        $.ajax({// Tạo số phiếu
                                            url: $dir_module_ps_kt + "taosophieu.php",
                                            data: {loaiphieu: $LoaiPhieu, mapskt: ($STT)},
                                            async: false,
                                            success: function (response) {
                    ...
                    try {
                        ...
                        $lacanhan = $data.lacanhan;
                        if ($lacanhan == 1) {
                            $("#latencanhan").attr("checked", true);
                            $("#tencanhan").attr("disabled", false);
                        } else {
                            $("#latencanhan").attr("checked", false);
                        }
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if ($loaitokhai == 0) {
                var result = confirm("CẢNH BÁO \n\n Bạn đang chọn tờ khai bổ sung ! Bạn có muốn tiếp tục nhập ?");
                if (result == false) {
                    $("#sohoadon").focus();
                    return false;
                }
            ...
            if ("<?php echo $_SESSION['thietlaphddt'] ?>" == "1") {
                if (valid && $LoaiPhieu == 3 && $LoaiCT == '1' && $hoadondientu != 0 && $hoadondientu != 9 && $loaitokhai == '1' && "<?php echo $_SESSION['thietlaphddt'] ?>" == "1" && "<?php echo $_SESSION['txt_hddt_tendangnhap'] ?>" != "" && "<?php echo $_SESSION['txt_hddt_matkhau'] ?>" != "" && "<?php echo $_SESSION['txt_hddt_duongdan'] ?>" != "") {// Nếu là phiếu chi và loại chứng từ là thuế GTGT thì thực hiện lập hoá đơn điện tử
                    $res = {
                        "errorCode": "INVOICE_ISSUED_DATE_INVALID",
                        "description": "Không kết nối được tới máy chủ !"
                    }
            ...
            if (valid) {
                $.ajax({
                    ...
                    data: { // Danh sách các thuộc tính sẽ gửi đi
                        ...
                        loaihanghoadichvu: $("#loaihanghoadichvu").val(),
                        tencanhan:$tencanhan,
                        latencanhan:$latencanhan
                    },
                    success: function (result) {
                        if ($LoaiPhieu == 4 && (tkno1.val().trim() == "2111" || tkno1.val().trim() == "2112" || tkno1.val().trim() == "2113" || tkno2.val().trim() == "2111" || tkno2.val().trim() == "2112" || tkno2.val().trim() == "2113" || tkno1.val().trim().substring(0, 3) == "242" || tkno1.val().trim() == "1562")) {
                            if ((tkno1.val().trim() == "2111" || tkno1.val().trim() == "2112" || tkno1.val().trim() == "2113" || tkno2.val().trim() == "2111" || tkno2.val().trim() == "2112" || tkno2.val().trim() == "2113")) {
                                if (window.confirm("Số liệu phát sinh này liên quan đến tài sản cố định . \n Muốn hiển thị cửa sổ nhập tài sản ?")) {
                                    ...
                                    if ($('.dialog_main_thongbao').html() == "") {
                                        $('.dialog_main_thongbao').load('form/frm_thongbao_phieukhac.php?loaiphieu=' + $LoaiPhieu + '&ngayhd=' + ngayhoadon.val().trim() + '&sophieu=' + sophieu.val().trim() + '&mapskt=' + STT.val().trim() + '&invoiceNo=' + $kyhieu + '' + $("#sohoadon").val() + '&mabimat=' + $("#MaBiMatHoaDon").val() + '&mauso=' + $mauso);
                                    }
                                }
                            } else if ((tkno1.val().trim().substring(0, 3) == "242")) {
                                ...
                                if (window.confirm("Số liệu phát sinh này liên quan đến chi phí mua hàng . \n Muốn hiển thị cửa sổ chi tiết từng mặt hàng ?")) {
                                    ...
                                    if ($('.dialog_main_thongbao').html() == "") { // copy
                                        $('.dialog_main_thongbao').load('form/frm_thongbao_thuchi.php?loaiphieu=' + $LoaiPhieu + '&ngayhd=' + ngayhoadon.val().trim() + '&sophieu=' + sophieu.val().trim() + '&mapskt=' + STT.val().trim() + '&invoiceNo=' + $kyhieu + '' + $("#sohoadon").val() + '&mabimat=' + $("#MaBiMatHoaDon").val() + '&mauso=' + $mauso);
                                    }
                                }
                            } else {
                                if ($('.dialog_main_thongbao').html() == "") {
                            ...
                            if ($('.dialog_main_thongbao').html() == "") {
                                $('.dialog_main_thongbao').load('form/frm_thongbao_phieukhac.php?loaiphieu=' + $LoaiPhieu + '&ngayhd=' + ngayhoadon.val().trim() + '&sophieu=' + sophieu.val().trim() + '&mapskt=' + STT.val().trim() + '&invoiceNo=' + $kyhieu + '' + $("#sohoadon").val() + '&mabimat=' + $("#MaBiMatHoaDon").val() + '&mauso=' + $("#mauso").val());
                            }
                        }
                    }
                });
...
<script language="javascript" type="text/javascript">
    $(document).ready(function(){
        ...
        var idSignMessage; //Use whens igning invoice
        var idCertString;
        var idSerial;
        var idSignValue;
        var idSignHashValue;
        ...
        signXml = function () {
            socket.getCert(preSignFile, errorFunction);
            return false;
        };
        receiveFunc = function (evt) {// Hàm receiveFunc
            var signValue = JSON.parse(evt.data);
            if (signValue.messageCode !== "" && signValue.messageCode !== null) {//Nếu có lỗi thì ở dây
                alert(signValue.messageCode);
                console.log("Message code: " + signValue.messageCode);
                var idMessage = idSignMessage;
                var textMessage = "Có lỗi xảy ra";
                var messageType = "error";
                var message = handleSigningErrorCode(signValue.messageCode);// Lấy thông báo lỗi từ hàm handleSigningErrorCode
                if (message !== null && message.textMessage !== "" && message.messageType !== "") {
                    textMessage = message.textMessage;
                    messageType = message.messageType;
                }

                setMessagePrimeFToView(idMessage, textMessage, messageType);// Hiện thông báo lỗi ra màn hình
                stopLoading();

            } else if (signValue.certRaw !== "" && signValue.certRaw !== null) {// Không có lỗi xẫy ra
            } else {
                var idMessage = idSignMessage;
                var textMessage = "File chứng thư số được chọn rỗng";
                var messageType = "error";
        ...
        errorFunction = function (event) {
            ...
            if (event.code === 1000) {
                ...
                textMessage = "Hết phiên kí hóa đơn";
                ...
                textMessage = "Không thể kết nối đến USB-TOKEN. Yêu cầu cắm USB-TOKEN hoặc cài đặt phần mềm ký số của Viettel";
        ...
        function handleSigningErrorCode(errorCode) {
            try {
                ...
                if (errorCode === "SESSION_TIME_OUT") {
                    message.textMessage = "Hết phiên kí hóa đơn";
                    message.messageType = "error";
                } else if (errorCode === "IS_SIGNING") {
                    message.textMessage = "Ứng dụng kí số đang bận";
                    message.messageType = "error";
                } else if (errorCode === "FORCE_CLOSE") {
                    message.textMessage = "Tiến trình kí số bị đóng";
                    message.messageType = "info";
                } else if (errorCode === "DEFAULT_CERT_NOT_IN_USB_TOKEN") {
                    message.textMessage = "Không tìm thấy chứng thư số mặc định trong USB-TOKEN";
                    message.messageType = "error";
                } else if (errorCode === "NO_INTERNET_CONNECTION_TO_VALIDATE_DEFAUT_CERT") {
                    message.textMessage = "Không kết nối được với server xác thực chứng thư số mặc định";
                    message.messageType = "error";
                } else if (errorCode === "NO_INTERNET_CONNECTION") {
                    message.textMessage = "Không kết nối được với server xác thực chứng thư số";
                    message.messageType = "error";
                } else if (errorCode === "DEFAULT_CERT_HAVE_ERROR") {
                    message.textMessage = "Có lỗi xảy ra khi kí bằng chứng thư số mặc đinh";
                    message.messageType = "error";
                } else if (errorCode === "INVALID_DEFAULT_CERT") {
                    message.textMessage = "Chứng thư số mặc định không hợp lệ";
                    message.messageType = "error";
                } else if (errorCode === "NO_CERT_IN_USB") {
                    message.textMessage = "Không tìm thấy chứng thư số trong USB-TOKEN";
                    message.messageType = "error";
                } else if (errorCode === "NO_INTERNET_CONNECTION_SETUP_TABLE") {
                    message.textMessage = "Không kết nối được với server xác thực chứng thư số";
                    message.messageType = "error";
                } else if (errorCode === "VALUE_EMPTY") {
                    message.textMessage = "Không lấy được hóa đơn để thực hiện kí";
                    message.messageType = "error";
                } else if (errorCode === "EMPTY_INVOICE") {
                    message.textMessage = "Tồn tại hóa đơn rỗng";
                    message.messageType = "error";
                } else if (errorCode === "NO_INTERNET_CONNECTION_TO_VALIDATE_CERT_TO_SIGN") {
                    message.textMessage = "Không kết nối được với server xác thực chứng thư số";
                    message.messageType = "error";
                } else if (errorCode === "HAVE_ERROR_WHEN_SIGING") {
                    message.textMessage = "Có lỗi xảy ra khi kí số";
                    message.messageType = "error";
                } else if (errorCode === "INVALID_CERT") {
                    message.textMessage = "Chứng thư số được chọn không hợp lệ";
                    message.messageType = "error";
                } else if (errorCode === "NO_USB_TOKEN_TO_SIGN") {
                    message.textMessage = "Không tìm thấy USB-TOKEN";
                    message.messageType = "error";
                } else if (errorCode === "MORE_THAN_ONE_USB_TOKEN_TO_SIGN") {
                    message.textMessage = "Chỉ sử dụng một USB-TOKEN";
                    message.messageType = "error";
                } else if (errorCode === "USB-UNPLUG") {
                    message.textMessage = "Không kết nối được với USB-TOKEN";
                    message.messageType = "error";
                } else if (errorCode === "HAVE_ERROR") {
                    message.textMessage = "Có lỗi xảy ra";
                    message.messageType = "error";
                }
        ...
        // THực hiện ký số trên USB
        preSignFile = function () {
            $hashString = $("#hashString").val().trim();
            console.log($hashString);
            socket.dataSign = $hashString;
            socket.serialCert = "<?php echo $_SESSION['txt_seritoken'] ?>";
        ...
        receiveSignFileFunc = function (evt) {
            ...
            if (signValue.messageCode !== "" && signValue.messageCode !== null) {
                ...
                console.log("Sign value: " + signValue.signValue);
                $("#txt_chuky").val(signValue.signValue);
            } else {
                clearSocket();
                stopLoading();
        ...
        var idMessageUploadSignature; //Use when upload cert when register signature
        var idUploadCertString; //Use when upload cert when register signature

        uploadCertificate = function () {
            startLoading();
            socket.uploadCert(receiveUploadFileFunc, errorUploadCertFunction);
            return false;
        };
        receiveUploadFileFunc = function (evt) {
            var signValue = JSON.parse(evt.data);
            if (signValue.messageCode !== "" && signValue.messageCode !== null) {
                var idMessage = idMessageUploadSignature;
                var textMessage = "Có lỗi xảy ra";
                var messageType = "error";
                var message = handleUploadCertificateErrorCode(signValue.messageCode);
                if (message !== null && message.textMessage !== "" && message.messageType !== "") {
                    textMessage = message.textMessage;
                    messageType = message.messageType;
                }
                ...
                $(idUploadCertString).val(signValue.certRaw);
                createCert();
            } else {
                socket.messageCode = 'EMPTY_UPLOADED_CERT';
                socket.finish();
                var idMessage = idMessageUploadSignature;
                var textMessage = "File chứng thư số được tải lên rỗng";
                var messageType = "error";
                setMessagePrimeFToView(idMessage, textMessage, messageType);
                $(idUploadCertString).val("");
                stopLoading();
            }
        };
        finishUploadProcess = function (messageCode) {
            socket.messageCode = messageCode;
            socket.finish();
        };
        function handleUploadCertificateErrorCode(errorCode) {
            try {
                var message = {
                    textMessage: "",
                    messageType: ""
                ...
                if (errorCode === "SESSION_TIME_OUT") {
                    message.textMessage = "Hết phiên tải lên chứng thư số từ USB-TOKEN";
                    message.messageType = "error";
                } else if (errorCode === "IS_SIGNING") {
                    message.textMessage = "Ứng dụng kí số đang bận";
                    message.messageType = "error";
                } else if (errorCode === "FORCE_CLOSE") {
                    message.textMessage = "Tiến trình tải lên chứng thư số từ USB-TOKEN bị đóng";
                    message.messageType = "info";
                } else if (errorCode === "DEFAULT_CERT_NOT_IN_USB_TOKEN") {
                    message.textMessage = "Không tìm thấy chứng thư số mặc định trong USB-TOKEN";
                    message.messageType = "error";
                    ...
                    message.textMessage = "Có lỗi xảy ra trong quá trình tải lên chứng thư số mặc đinh";
                    message.messageType = "error";
                } else if (errorCode === "INVALID_DEFAULT_CERT") {
                    message.textMessage = "Chứng thư số mặc định không hợp lệ";
                    message.messageType = "error";
        ...
        errorUploadCertFunction = function (event) {
            var idMessage = idMessageUploadSignature;
            var textMessage = "Có lỗi xảy ra";
            var messageType = "error";
            if (event.code === 1000) {
