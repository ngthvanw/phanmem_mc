    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                loadiFrame('modules/baocaothue/inphieu_tokhai_thuegtgt_theopp_khautru_pptt.php?<?php echo $query; ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $('.dialog_main_print').load("form/print_bangke_thuegtgt_khautru_pptt.php?<?php echo $query; ?>");
        });
