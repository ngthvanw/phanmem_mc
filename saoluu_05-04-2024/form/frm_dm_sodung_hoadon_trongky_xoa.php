			 ...
			 if (event.keyCode == Keys.F4) {
              ...
              if (event.keyCode == Keys.F7) { // copy
                  if (rowSelect != false){
                      ...
                      //--------------------------------------------Thay đổi khi copy---------------------------------
                       var _dataRow = {loaiphieu: rowData.loaiphieu, soquyen:rowData.soquyen, kyhieu: rowData.kyhieu, tuso: rowData.tuso, denso: rowData.denso, soluong: rowData.soluong, mauso: rowData.mauso,quy:rowData.quy,loaiphieu: "XOA"};
        ...
        //--------------------------------Khai báo lưới---------------------------------------.
 		var obj = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {title: "Sử dụng", width: 150, dataType: "string", align: "right", dataIndx: "sudung",hidden: false,
                },
                {title: "Xóa", width: 150, dataType: "string", align: "right", dataIndx: "denso",hidden: false,
                },
                {title: "Mất", width: 150, dataType: "string", align: "right", dataIndx: "tuso"
                },
                {title: "Hủy", width: 150, dataType: "string", align: "right", dataIndx: "huy"
                },
                {title: "Số lương", width: 80, dataType: "string", align: "center",editable:false, hidden: true,
                    render: function (ui) {
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_sudu_hoadon_select + "list_sodu_hoadon_trongky_xoa.php",//-- Load danh sách lên lưới
...
<div id="dialog-sodu_hoadon"
     title="SỐ HÓA ĐƠN MẤT,XÓA,HỦY (F4: Thêm mới , F7: Sao chép , F8: Xóa ,ESC : THOÁT - Dùng (,) hoặc (;) để xóa nhiều số,(-) nhập từ số - đến số)"><!-- dialog -->
