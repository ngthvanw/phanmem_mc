    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_danhmuccptratruoc + "laythongtinpbchiphimuahang.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                loadiFrame('TCPDF/baocao/inbang_bangphanbo_cpmuahang.php?denthang=<?php echo $denthang; ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
			...
			window.open("TCPDF/baocao/inbang_bangphanbo_cpmuahang.php?denthang=<?php echo $denthang; ?>","bangchiphitratruoc","menubar=0,resizable=1");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BẢNG PHÂN BỐ CHI PHÍ MUA HÀNG"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
