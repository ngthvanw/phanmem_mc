        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                content: function(){
                    var self = this;
                    return $.ajax({
                        url: $dir_module_dmsanpham + "laythongtingiathanhtieuchuan.php",
                        dataType: 'json',
                        method: 'get',
                        data: {
                            ...
                            xemtonghopmasp:"<?php echo $xemtonghopmasp ?>",
                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                window.open($dir_module_dmsanpham+"xuatexceltkchitiet.php");
                            }else{
            ...
            $.confirm({
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
                            if(<?php echo $congdontheosocai ?>=="0"){
                                window.open("tcpdf/baocao/inbangke_sochitiet_giathanh_tieuchuan.php?congdontheosocai=<?php echo $congdontheosocai ?>","insocai","menubar=0,resizable=0");
                            }else{
                                window.open("tcpdf/baocao/inbangke_sochitiet_giathanh_tieuchuan.php?congdontheosocai=<?php echo $congdontheosocai ?>","insocai","menubar=0,resizable=0");
                            }
                        }
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="PHIẾU TÍNH GIÁ THÀNH TIÊU CHUẨN"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
