...
<div id="dialog-bangke_thue_gtgt" title="Tờ khai thuế GTGT dành cho dự án đầu tư">
    ...
    <form method="post" id="Form-chinh" enctype="multipart/form-data">
        ...
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td width="180px">Thuế GTGT kỳ trước</td>
        ...
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
                <tr>
                    <td colspan="3"><span style="color:#600">Thuế GTGT đầu vào của dự án đầu tư chưa được hoàn bàn giao cho doanh nghiệp mới thành lập trong kỳ  </span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3"><span style="color:#600">Thuế GTGT đầu vào của hàng hoá nhập khẩu thuộc loại trong nước chưa sản xuất được để tạo tài sản cố định
đã đề nghị hoàn  </span>
                    </td>
                </tr>
                <tr>
                    <td width="50" style="padding-top:3px;"></td>
    ...
    $(function () {
        ...
        $("#capnhatsolieu").click(function () {
            ...
            $.confirm({
                ...
                content: function () {
                    var self = this;
                    return $.ajax({
                        url: $dir_module_baocaothue + "capnhattanggiamkytruoc_dautu.php?thangtinhthue=" + $thangtinhthue + "&loaitokhai=" + $loaitokhai+"&namtinhthue="+$namtinhthue,
                        async: false,
                        success: function (response) {
                            if (response != 0) {
        ...
        $("#loaitokhai").change(function () {
            ...
            if ($loaitokhai == 1) {
                $datakt = "";
                $.ajax({// Thêm dữ liệu vào tokhaithue
                    url: $dir_module_baocaothue + "laythonggtgtkytruoc_dautu.php?thangtinhthue=" + $thangtinhthue + "&loaitokhai=1&namtinhthue="+$namtinhthue,
                    async: false,
                    success: function (response) {
                        if (response != 0) {
                ...
                $data = "";
                $.ajax({// Thêm dữ liệu vào tokhaithue
                    url: $dir_module_baocaothue + "laythongtininphieukekhaithue_json_dautu.php?thangtinhthue=" + $thangtinhthue + "&loaitokhai=" + $loaitokhai+"&namtinhthue="+$namtinhthue,
                    async: false,
                    success: function (response) {
                        if (response != 0) {
                            try {
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                    ...
                    if ($thangtinhthue != "V") {
                        ...
                        if ($dulieutontai == true) {
                            if ($dulieukhoa && $loaitokhai == 1) {
                                ...
                                $('.dialog_main_thongbao').load("form/frm_insolieu_bangke_thuegtgt_khautru_pptt.php?thangtinhthue=" + $thangtinhthue + "&loaitokhai=" + $loaitokhai+"&namtinhthue="+$namtinhthue);
                ...
                if ($thangtinhthue != "V") {
                    $dulieutontai = false; // Dữ liệu chưa tồn tại
                    $.ajax({// Chuyển tồn kho cho năm mới
                        url: $dir_module_baocaothue + "kiemtracotontaidulieukhaithue_dautu.php",
                        data: {thangtinhthue: $thangtinhthue, loaitokhai: $loaitokhai,namtinhthue:$namtinhthue},
                        async: false,
                        success: function (response) {
                            if (response == 1) {
                    ...
                    $dulieukhoa = 0;
                    $.ajax({// Chuyển tồn kho cho năm mới
                        url: $dir_module_baocaothue + "kiemtrakhaithuebikhoa_dautu.php",
                        data: {thangtinhthue: $thangtinhthue, loaitokhai: $loaitokhai,namtinhthue:$namtinhthue},
                        async: false,
                        success: function (response) {
                            if (response == 1) {
                    ...
                    if ($dulieutontai == true) {
                        if ($dulieukhoa && $loaitokhai == 1) {
                            alert("CHÚ Ý.\n\nTỜ KHAI THUẾ CHÍNH THỨC NÀY ĐÃ ĐƯỢC DUYỆT. BẠN KHÔNG THỂ THAY ĐỔI TỜ KHAI NÀY.\n\nNHẤN [OK] ĐỂ XEM TỜ KHAI!");
                            $('.dialog_main_thongbao').load("form/frm_insolieu_bangke_thuegtgt_dautu.php?thangtinhthue=" + $thangtinhthue + "&loaitokhai=" + $loaitokhai+"&namtinhthue="+$namtinhthue);
                            ...
                            if (retVal == true) {
                                $.confirm({
                                    ...
                                    content: function () {
                                        var self = this;
                                        return $.ajax({
                                            url: $dir_module_baocaothue + "themtokhaithue_dautu.php?thuedenghihoan=" + $thuedenghihoan + "&doanhsogtgtkhautru=" + $doanhsogtgtkhautru + "&thuegtgtkhautru=" + $thuegtgtkhautru + "&doanhsogtgtdaura=" + $doanhsogtgtdaura + "&thuegtgtdaura=" + $thuegtgtdaura + "&thuegtgtngoaitinh=" + $thuegtgtngoaitinh + "&thuegtgtmuavaoduandautu=" + $thuegtgtmuavaoduandautu + "&thangtinhthue=" + $thangtinhthue + "&thuegtgtkytruoc=" + $thuegtgtkytruoc + "&loaitokhai=" + $loaitokhai + "&khautruhangthang=" + $khautruhangthang + "&thuegtgtduockhautrukynay=" + $thuegtgtduockhautrukynay + "&lydotanggiam=" + $lydotanggiam + "&chitietdaura=" + $chitietdaura+ "&thuegtgttanggiam=" + $thuegtgttanggiam+"&namtinhthue="+$namtinhthue,
                                            async: false,
                                            success: function (result) {
                                                if (result.trim() == 1) {
                                                    alert("CẢNH BÁO! \n\nTỔNG DOANH THU BÁN RA TRÊN TỜ KHAI KHÔNG KHỚP VỚI DOANH THU BÁN HÀNG VÀ CUNG CẤP DỊCH VỤ TRÊN SỔ CHI TIẾT.");
                        ...
                        $.confirm({
                            ...
                            content: function () {
                                var self = this;
                                return $.ajax({
                                    url: $dir_module_baocaothue + "themtokhaithue_dautu.php?thuedenghihoan=" + $thuedenghihoan + "&doanhsogtgtkhautru=" + $doanhsogtgtkhautru + "&doanhsogtgtdaura=" + $doanhsogtgtdaura + "&thuegtgtdaura=" + $thuegtgtdaura + "&thuegtgtngoaitinh=" + $thuegtgtngoaitinh + "&thuegtgtmuavaoduandautu=" + $thuegtgtmuavaoduandautu + "&thangtinhthue=" + $thangtinhthue + "&thuegtgtkytruoc=" + $thuegtgtkytruoc + "&loaitokhai=" + $loaitokhai + "&lydotanggiam=" + $lydotanggiam + "&chitietdaura=" + $chitietdaura+ "&thuegtgttanggiam=" + $thuegtgttanggiam+"&namtinhthue="+$namtinhthue,
                                    async: false,
                                    success: function (result) {
                                    }
                                });
