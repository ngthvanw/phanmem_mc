    ...
    $(function () {
        ...
        var obj = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Khấu hao", minWidth: 100, dataType: "integer", align: "center", dataIndx: "khauhao",
                ...
                },
                {
                    ...
                    editable: false,
                    validations: [
                        {type: 'minLen', value: 4, msg: "Mã tài sản phải có  4 đến 14 ký tự  !"},
                        {type: 'maxLen', value: 14, msg: "Mã tài sản phải có 4 đến 14 ký tự !"},
                        {
                            type: function (ui) {
                                isEdit = isEditCell();
                                if (isEdit) {
                ...
                },
                {
                    ...
                    editor: {type: "select",options: function (ui) {
                            ...
                            $.ajax({// Load danh sách mã khách hàng
                                ...
                                async: false,
                                data:{ma:'154,156,411,421,611,621,622,623,627,631,632,635,641,642,811'},
                                success: function (response) {
                ...
                {
                    title: "CP được trừ", minWidth: 100, dataType: "string", dataIndx: "cpkhongduoctru", editable: true,
                    render: function (ui) {
                        var value = ui.rowData.cpkhongduoctru;
                        if (value == 0) {
                            return "CHI PHÍ ĐƯỢC TRỪ";
                        } else if (value == 1) {
                            return "CHI PHÍ KHÔNG ĐƯỢC TRỪ";
                        }
                    },
                    editor: {type: "select",options: function (ui) {
                            //remote validation
                            var parsedJson = [ {"0":"CHI PHÍ ĐƯỢC TRỪ"},{"1":"CHI PHÍ KHÔNG ĐƯỢC TRỪ"} ];
                            return parsedJson;
                        }},
                },
