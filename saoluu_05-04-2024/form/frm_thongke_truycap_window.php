...
<script>
    ...
    $(function () {
        ...
        var obj = {
            ...
            toolbar: {
                items: [
                    { type: 'button', icon: ' ui-icon-contact', label: 'THÔNG KÊ DUYỆT HỒ SƠ', listeners: [
                        { "click": function (evt, ui) {
                            //window.href="frm_thongke_truycap_window.php";
                            window.location="frm_thongke_xuyetduyet_window.php";
                        }
                        }
                    ]
                    },
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Ngày nhập", minWidth: 150, dataType: "integer", align: "center", dataIndx: "ngaynhap",editable:false,
                    filter: { type: 'date', condition: "begin", listeners: ['keyup'] },

                },
                {
                    title: "Giờ nhập", minWidth: 100, dataType: "integer", align: "center", dataIndx: "gionhap",editable:false,
                ...
                },
				{
                    ...
                    editable: false,
					render:function( ui ){
						$val = ui.rowData.slchungtu;
						$masothue = ui.rowData.tendatabase;
						$nguoinhap = ui.rowData.tendangnhap;
						$tencongty = ui.rowData.tencongty;
						$ngaynhap = ui.rowData.ngaynhap;
						return "<a style='color:blue;' href='frm_thongke_ctchungtu_window.php?masothue="+$masothue+"&tendangnhap="+$nguoinhap+"&tencongty="+$tencongty+"&ngaynhap="+$ngaynhap+"'>"+$val+"</a>"
					}
                }
            ],//-----------------------------------------Kết thúc các cột--------------------------------------
            ...
            dataModel: {
                ...
                url: $dir_module_user + "list.php",//-- Load danh sách lên lưới
