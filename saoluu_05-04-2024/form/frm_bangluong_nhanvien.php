        ...
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
             <tr>
                ...
                <tr>
                    <td><input name="khongtaobuttoan" type="checkbox" id="khongtaobuttoan" ></td>
                    <td>&nbsp;Không tạo bút toán phát sinh&nbsp;</td>
                    <td>
                    </td>
                </tr>
                <tr style="display: none">
                    <td><input name="hachtoanbaohientheotyle" type="checkbox" id="hachtoanbaohientheotyle" ></td>
                    <td>Hạch toán bảo hiểm theo tỷ lệ&nbsp;</td>
                    <td>
                    </td>
                </tr>
                <tr>
                    <td><input name="rd_tinhluong" value="nam" type="checkbox" id="rd_tinhluongtheonam" ></td>
                    <td>&nbsp; Tổng hợp cả năm&nbsp;</td>
                    <td>
                    </td>
                </tr>
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
			...
			$khongtaobuttoan = $('input[name=khongtaobuttoan]:checked').val();
			$txttinhluongtheo = 1;
			if($tinhluongtheo=="thang"){
				$txttinhluongtheo = $("#txttinhluongtheothang").val();
			}

            $tinhluongtheo = $("#rd_tinhluongtheonam").prop( "checked");
            $khongtaobuttoan = $("#khongtaobuttoan").prop( "checked");
            $hachtoanbaohientheotyle = $("#hachtoanbaohientheotyle").prop( "checked");
			...
			if($tinhluongtheo==false) {
                if ($bangluongtontai) {
                    ...
                    if (res) {
                        res1 = confirm(" Bạn có chắc muốn tạo bảng lương tháng " + $txttinhluongtheo + " không ?");
                        if (res1) {
                            valid = true;
                        } else {
                            valid = false;
                            $('.dialog_main_thongbao').load("form/frm_insolieu_bangluong_nhanvien.php?tinhluongtheo=" + $tinhluongtheo + "&txttinhluongtheo=" + $txttinhluongtheo+ "&hachtoanbaohientheotyle=" + $hachtoanbaohientheotyle);
                        }
                    } else {
                        valid = false;
                        $('.dialog_main_thongbao').load("form/frm_insolieu_bangluong_nhanvien.php?tinhluongtheo=" + $tinhluongtheo + "&txttinhluongtheo=" + $txttinhluongtheo+ "&hachtoanbaohientheotyle=" + $hachtoanbaohientheotyle);
                    ...
                    res1 = confirm(" Bạn có muốn tạo bảng lương tháng " + $txttinhluongtheo + " không ?");
                    if (res1) {
                        valid = true;
                    } else {
                        valid = false;
                ...
                res1 = confirm(" Bạn có muốn xem bảng lương tổng hợp năm <?php echo $_SESSION['NienDo']; ?> không ?");
                if (res1) {
                    valid = true;
                } else {
                    valid = false;
                        ...
                        content: function () {
                            ...
                            return $.ajax({
                               url: $dir_module_manv + "thembangluong_nhanvien.php",
								data: {tinhluongtheo: $tinhluongtheo,txttinhluongtheo:$txttinhluongtheo,khongtaobuttoan:$khongtaobuttoan,hachtoanbaohientheotyle:$hachtoanbaohientheotyle},
                            });
                        },
                        buttons: {
                            "OK": {
