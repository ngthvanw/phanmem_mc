...
<head>
    <meta charset="utf-8"/>
    <title>Chọn mã khách hàng</title>
        ...
        $("#dialog-makhachhang").keydown(function (event) {//--------------Các phím tắt
            ...
            if ($('div').hasClass('jconfirm') == false) {
                ...
                if (event.keyCode == Keys.INSERT) {
                    ...
                    //window.opener.document.getElementsByClassName("<?php echo $class; ?>").value=$ma;
                    window.opener.document.getElementById("<?php echo $class; ?>").value=$ma;
                    window.close();
                }
...
<div id="dialog-makhachhang" title="Thông tin khách hàng (ENTER : Sửa,Lưu ,F4: Thêm mới  , F7: Sao chép , F8: Xóa )"><!-- dialog -->
