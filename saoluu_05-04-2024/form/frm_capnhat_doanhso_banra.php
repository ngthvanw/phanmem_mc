    ...
    <form method="post" id="Form-CapNhap_MatKhau" enctype="multipart/form-data">
        <fieldset>
            <table class="table-dialog">
                ...
                <tr>
                    <td colspan="2">
                        <label for="name" style="font-weight: bold;">Không thuế</label><input type="text" onkeyup="format_munber(this.value,'#KhongChiuThue')" name="KhongChiuThue" id="KhongChiuThue" required=""  value="" class="text ui-widget-content ui-corner-all" autocomplete="off" style="width:35%;text-align: right;" />
...
function xoadialog(){
 ...
 var dialog, form,
    ...
    function tinhtongdoanhso() {
        ...
        $tongcong = parseInt($KhongChiuThue)+parseInt($KhongPhanTram)+parseInt($NamPhanTram)+parseInt($MuoiPhanTram);
    ...
    function tinhtongthuedoanhso() {
        ...
        $tongcong = parseInt($ThueKhongChiuThue)+parseInt($ThueKhongPhanTram)+parseInt($ThueNamPhanTram)+parseInt($ThueMuoiPhanTram);
        ///console.log($tongcong);
        return $tongcong;
    }
 ...
 function ChucNang_CapNhat_MatKhau(){
     var chitietds_json = '{"tongtien":0,"tongthue":0,"tongtienbr":0,"tongthuebr":0,"chitienbr":{"0":{"tongtien":0,"tongthue":0},"5":{"tongtien":0,"tongthue":0},"10":{"tongtien":0,"tongthue":0},"0":{"tongtien":0,"tongthue":0},"k":{"tongtien":0,"tongthue":0}}}';
