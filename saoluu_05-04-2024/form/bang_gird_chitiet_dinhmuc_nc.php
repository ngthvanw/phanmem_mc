...
<script>
    ...
    var objnc = {
            ...
            title: "Danh sách nhân công (INSERT: Lấy danh sách , ENTER: Sửa và Lưu)",
            change: function (evt, ui) {// Khi dữ liệu thay đổi
                ...
                rowData.dinhmuckecakhauhao = parseInt($dinhmuckecakhauhao);
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Mã nhân công", dataType: "string", dataIndx: "mavt", width: 80, sortable: true, editable: false,
                    filter: {
                        type: 'textbox',
                        condition: 'begin',
                        listeners: ['keyup']
                ...
                {
                    title: "Tên nhân công", width: 200, dataType: "string", dataIndx: "tenvt", editable: false,
                    validations: [
                ...
                {
                    title: "Đơn giá", width: 70, dataType: "float", align: "right", dataIndx: "tylehaohoc",
                    render: function (ui) {
                        var val = ui.rowData.tylehaohoc;
                        return $.number(val,2,".",",");
                    }
                },
                {
