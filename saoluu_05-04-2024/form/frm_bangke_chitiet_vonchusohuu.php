...
<div id="dialog-bangkekhauhao_taisan" title="BẢNG KÊ CHI TIẾT VỐN CHỦ SỞ HỮU...">
    ...
    <form method="post" id="Form-chinh" enctype="multipart/form-data">
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
                <tr>
                    ...
                    <td>Tháng</td>
                    <td>
                        <select disabled="disabled" name="tuthang" style="height:20px;width:100px;" id="tuthang">
                            <?php
                            for ($i = 1; $i <= 12; $i++) {
                                $select = "";
                                if ($i == $cur_thang)
                    ...
                    <td>
                        <select name="denthang" disabled="disabled" style="height:20px;width:100px;" id="denthang">
                            <?php
                            for ($i = 1; $i <= 12; $i++) {
                                $select = "";
                                if ($i == $cur_thang)
        ...
        <fieldset style="background-color: #afd9ee">
            ...
            <table>
                <tr>
                    <td><input name="tonghopcanam" disabled="disabled" type="checkbox" id="tonghopcanam" checked="checked"></td>
...
<script>
    ...
    $(function () {
		...
		$("#btntaisankhongkhauhao").click(function(e) {
            $('.dialog_main_mataisan').load('form/frm_danhsach_mataisan_khongkhauhao.php');
        });
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if ($tonghopcanam == false) {
                for ($i = $tuthang; $i <= $denthang; $i++) {
                    $.ajax({
                        url: $dir_module_vonchusohuu + "themkhauhaotaisan.php",
                        dataType: 'json',
                        data: {tuthang: $i, denthang: $i, tonghopcanam: $tonghopcanam},
                        method: 'get',
                        async: false,
                ...
                $('.dialog_main_thongbao').load("form/frm_insolieu_bangke_chitiet_vonchusohu.php?tuthang=" + $tuthang + "&denthang=" + $denthang + "&tonghopcanam=" + $tonghopcanam);
            }else{
                for ($i = 1; $i <= 1; $i++) {
                    $.ajax({
                        url: $dir_module_vonchusohuu + "themkhauhaotaisan.php",
