    ...
    $(function () {
        ...
        var objmabpnv = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Mã bộ phận", dataType: "string", dataIndx: "mabp", width: 100, sortable: true,
                    validations: [
                ...
                {
                    title: "Tên bộ phận", width: 300, dataType: "string", dataIndx: "tenbp",
                    validations: [
                ...
                {title: "Địa chỉ", width: 300, dataType: "string", align: "left", dataIndx: "diachi"},
                {
                    title: "Chú thích", width: 350, dataType: "string", align: "right", dataIndx: "ghichu",
        ...
        var $grid = $("#grid_editing_mabct_form_select").pqGrid(objmabpnv);
...
<div id="dialog-mabophan_form_select"
     title="THÔNG TIN BỘ PHẬN NHÂN VIÊN (INSERT: Để chọn mã ,F4: Thêm  , F7: Sao chép , F8: Xóa)"><!-- dialog -->
