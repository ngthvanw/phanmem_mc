...
<script>
    ...
    $width = getWidth()-50;
    $(function() {
        $dir_module = "modules/mabp/";//--------------------------------------------Thay đổi khi copy
        function xoadialog_mabophan() { // ----------------------đóng form
            reset_dialog(".dialog-mabophan");
            reset_dialog(".dialog_main_mabophan");
        }
        $("#dialog-mabophan").dialog({ // ------------------Gọi dialog
            resizable: false,
            height: $height,
            width: $width,
            modal: true
     ...
     $("#dialog-mabophan").keydown(function(event) {//--------------Các phím tắt
        var $grid_pb = $("#grid_editing_mabophan").closest('.pq-grid');//---- Lưới----------------
        ...
        var rowEditting = $( "#grid_editing_mabophan" ).pqGrid( "getRowsByClass", { cls : 'pq-row-edit' } );//---Lấy đối tượng đang sửa
          if ( $('div').hasClass('jconfirm')==false) {
             ...
             if (event.keyCode == Keys.F7) { // copy
                if (rowSelect != false){
                   ...
                   //--------------------------------------------Thay đổi khi copy---------------------------------
                   var _dataRow = {mabp :rowData.mabp,tenbp :rowData.tenbp,shtk :rowData.shtk,diachi :rowData.diachi,ghichu :rowData.ghichu};
             ...
             build: function($trigger, e) {
                 return {
                     callback: function(key, options) {
                         var $grid_pb = $("#grid_editing_mabophan").closest('.pq-grid');
     ...
     function change_data_quit_mabophan() { // Cảnh báo thoát khi thay đổi dữ liệu////////////////////////////////////////////////////
        var $grid_pb = $("#grid_editing_mabophan").closest('.pq-grid');//---- Lưới----------------
    ...
    //----------------------------------------------------Bắt đầu lưới-----------------------------------------
        ...
        var obj = {                        
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                    ...
                    { title: "Mã bộ phận", dataType: "integer", dataIndx: "mabp", width: 80,sortable: true,
                        validations: [
                    ...
                    { title: "Sửa|Xóa", editable: false, minWidth: 40, sortable: false, render: function (ui) {
        ...
        var $grid = $("#grid_editing_mabophan").pqGrid(obj);
        ...
        function getRowSelect() { // --------------------Lấy dữ liệu theo dòng trên gird----------------------                 
             var arr = $("#grid_editing_mabophan").pqGrid("selection", {
                 type: 'cell',
                 method: 'getSelection'
...
<div id="dialog-mabophan" title="Thông tin bộ phận (F2: Sửa , F7: Sao chép , F8: Xóa , F9: Lưu , END : Hủy dòng đang sửa)"><!-- dialog -->
  <div id="grid_editing_mabophan" style="margin:5px auto;border: 0px !important;"></div>
</div>