        ...
        var obj = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                },
                {
                    ...
                    filter: { type: 'date', condition: "contain", listeners: ['keyup'] }
                },
                {
                    title: "Đến ngày",
                    minWidth: 150,
                ...
                },
                {
                    ...
                    validations: [
                        {type: 'minLen', value: 1, msg: "Danh sách công ty không được trống !"},
                    ],
                ...
                {
                    title: "Ghi chú", minWidth: 300, dataType: "string", align: "left", dataIndx: "ghichu",editable: function (ui) {
                    var rowData = ui.rowData;
                    try {
                        var $trangthai = rowData.trangthai;
                    }catch (e){
