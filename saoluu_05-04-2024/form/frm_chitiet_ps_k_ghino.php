...
<script>
    ...
    $(function () {
        ...
        function xoadialog_chitiet_ps_kt_phieuthu() { // ----------------------đóng form
            ...
            $("#grid_editing_ps_k_ghino :button").first().focus();
        }
                        ...
                        buttons: {
                            ...
                            "Hủy bỏ": {
                                keys: ['N'], action: function () {
                                    $( "#grid_editing_ps_k_ghino" ).pqGrid( "refreshDataAndView" );
        ...
        var obj = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                /*{
                 ...
                 var parsedJson = "";
                 $.ajax({
                 url: $dir_module_chitiet_ps_kt_phieuthu + "cb_loaiphieu.php",
                 data: {},
                 async: false,
                 success: function (response) {
                 ...
                 var $TenLoai = "";
                 $.ajax({
                 url: $dir_module_chitiet_ps_kt_phieuthu + "ten_loaiphieu.php",
                 data: {ma: $maloaict},
                 async: false,
                 success: function (response) {
                 $TenLoai = response;
                 ...
                 var $Ten = "";
                 $.ajax({
                 url: $dir_module_chitiet_ps_kt_phieuthu + "gettenkh.php",
                 data: {makh: $makh},
                 async: false,
                 success: function (response) {
                ...
                {
                    title: "TK có", minWidth: 150, dataType: "string", align: "left", dataIndx: "tkco_mand",
                    editor: {
                        type: laytkno,
                    },
                    validations: [
                ...
                },
                {
                    ...
                    validations: [
                        { type: 'minLen', value: 1, msg: "Mã nội dung 2 không được trống !" },
                        { type: function (ui) {
                            var value = ui.value,
                                _found = false,sott = ui.rowData.sott;
                            //remote validation
                ...
                {
                    title: "TK có 2", minWidth: 150, dataType: "string", align: "left", dataIndx: "tkco_mand2",
                    editor: {
                        type: laytkno2,
                    },
                    validations: [
...
<div id="dialog-chitiet_ps_kt_phieuthu"
     title="Chi tiết Phát sinh Phiếu ghi nợ ... (F2: Sửa , F7: Sao chép , F8: Xóa , F9: Lưu , END : Hủy dòng đang sửa)">
    <!-- dialog -->
