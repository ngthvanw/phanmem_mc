...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                {// nếu không check vào chuyển tồn kho
                                                        ...
                                                        buttons: {
                                                            "OK": {
                                                                keys: ['Y'], action: function () {
                                                                    $('.dialog_main_thongtin_nhapxuatkho').load("form/frm_insolieu_tkthang_theonhom.php?thangtk=" + $tinhlaituthang + "&sole=" + $sole + "&congdontuthang=" + $congdontuthang + "&congdondenthang=" + $congdondenthang + "&congdon=" + $congdon + "&Inxoasoam=" + $Inxoasoam+ "&loctheotk=" + $LocTheoTK);
                                                                }
                                                            }
                                                        }
                                                    });
                                                ...
                                                if($res){
                                                    $.confirm({
                                                        ...
                                                        buttons: {
                                                            "OK": {
                                                                keys: ['Y'], action: function () {
                                                                    $('.dialog_main_thongtin_nhapxuatkho').load("form/frm_insolieu_tkchitietthang_theonhom.php?thangtk=" + $tinhlaituthang + "&sole=" + $sole + "&congdontuthang=" + $congdontuthang + "&congdondenthang=" + $congdondenthang + "&congdon=" + $congdon + "&Inxoasoam=" + $Inxoasoam+ "&loctheotk=" + $LocTheoTK);
                                                                }
                                                            }
                                                        }
                                                    });
