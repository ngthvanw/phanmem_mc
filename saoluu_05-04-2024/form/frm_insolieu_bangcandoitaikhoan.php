                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                window.open($dir_module_ketoantonghop+"xuatexceltkchitiet.php?xemchitiet=<?php echo $xemchitiet ?>");
                            }else{
                                loadiFrame('tcpdf/baocao/inbang_candoi_taikhoan.php?sole=<?php echo $sole ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
                            window.open("tcpdf/baocao/inbang_candoi_taikhoan.php?xemchitiet=<?php echo $xemchitiet ?>","mywindow","menubar=0,resizable=0");
                        }
                    }
                }
            });
                    ...
                    <table width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="NgayHoaDon_InPhieu_ThuChi" style="width:100%"
                                       id="NgayHoaDon_InPhieu_ThuChi" value="<?php echo 'Năm: '.$_SESSION['NienDo'];  ?>"/></td>
                        </tr>
                        <tr>
                            <td>Ngày Lập</td>
