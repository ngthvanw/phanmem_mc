...
<div style="width: 500px;;" id="dialog_insolieu_nhapxuat" title="In số liệu ">
    <iframe id="fred" style="border:1px solid #666CCC" title="" src="modules/baocaothue/inphieu_tokhai_thuegtgt_theopp_khautru_pptt.php?<?php echo $query; ?>&nhomnganh=<?php echo substr($ppkhautru, 4, 1) ?>"
        ...
        dialog = $("#dialog_insolieu_nhapxuat").dialog({
            ...
            buttons: {
                ...
                "Phiếu kiểm tra": function () {
					if("<?php echo $loaitokhai ?>"==1){
						window.open('form/frm_phieukiemtra_tokhai_thuegtgt_window.php?loaiphieu=9&tuphieu=<?php echo $thang."-".$namtinhthue;; ?>&denphieu=<?php echo $DenPhieu; ?>&gt1=<?php echo $tongthue; ?>&gt2=<?php echo 0; ?>&machinhanh=<?php echo $machinhanh; ?>','kiemtraphieuthu<?php echo $LoaiPhieu; ?>','height='+(getHeight()-80)+',width='+getWidth());
						
					}else{
						window.open('form/frm_phieukiemtra_tokhai_thuegtgt_window.php?loaiphieu=11&tuphieu=<?php echo $thang."-".$namtinhthue;; ?>&denphieu=<?php echo $DenPhieu; ?>&gt1=<?php echo $tongthue; ?>&gt2=<?php echo 0; ?>&machinhanh=<?php echo $machinhanh; ?>','kiemtraphieuthu<?php echo $LoaiPhieu; ?>','height='+(getHeight()-80)+',width='+getWidth());
