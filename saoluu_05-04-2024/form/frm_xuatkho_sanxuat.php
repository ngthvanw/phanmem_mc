                ...
                <tr>
                    ...
                    <td width="90px">
                        <input type="text" name="mauso" id="mauso" style="width: 96%" list="masohoadon" autocomplete="off"
                               placeholder="Mẫu số" value="" class="text ui-widget-content ui-corner-all"/>
                ...
                <tr>
                    ...
                    <td colspan="6" style="padding: 2px">
                        ...
                        <input type="text" onkeyup="return KhuDauTiengViet(this.value,'#manoidung')" name="manoidung"
                               value="_XKHSX" id="manoidung" list="listmanoidung" required
                               style="width: 22%"
						...
						if ((tkno1.val().trim().substring(0,3) == "242") || (tkno2.val().trim().substring(0,3) == "242")) {
                                if (window.confirm("Số liệu phát sinh này liên quan đến công cụ dụng cụ . \n Muốn hiển thị cửa sổ nhập công cụ dụng cụ ?")) {
                                    ...
                                    if ($('.dialog_main_thongbao').html() == "") { // copy
                                        $('.dialog_main_thongbao').load('form/frm_thongbao_xuatkho_sanxuat.php?loaiphieu=' + $LoaiPhieu + '&ngayhd=' + ngayhoadon.val().trim() + '&sophieu=' + STT.val().trim() + '&tenkho=' + encodeURI(tenkho.val().trim()));
                                    }
                                }
                               ...
                               if (window.confirm("Số liệu phát sinh này liên quan đến xây dựng cơ bản dở dang . \n Muốn hiển thị cửa sổ nhập xây dựng cơ bản dở dang ?")) {
                                   ...
                                   if ($('.dialog_main_thongbao').html() == "") { // copy
                                        $('.dialog_main_thongbao').load('form/frm_thongbao_xuatkho_sanxuat.php?loaiphieu=' + $LoaiPhieu + '&ngayhd=' + ngayhoadon.val().trim() + '&sophieu=' + STT.val().trim() + '&maphieu=' + sophieu.val().trim() + '&tenkho=' + encodeURI(tenkho.val().trim())+'&invoiceNo='+$kyhieu + '' + $("#sohoadon").val().trim()+ '&mabimat=' + $("#MaBiMatHoaDon").val()+ '&mauso=' + $mauso);
                                   }
                               }
        ...
        dialog = $("#dialog-xuatkho").dialog({
            ...
            buttons: {
                ...
                "Kết thúc": function () {
                    ...
                    $('.dialog_main_thongbao').load('form/frm_thongbao_xuatkho_sx_thoat.php');
                }
            }
        });
        dialog.dialog("open");
