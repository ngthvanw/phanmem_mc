...
<head>
    <meta charset="utf-8"/>
    <title>DUYỆT BẢNG TỒN KHO - <?php echo $mst . " - " . $tencongty; ?></title>
    ...
    $(function () {
        ...
        var obj = {
            ...
            change: function (evt, ui) {// Khi dữ liệu thay đổi
                ...
                if (type == 'update') {
                    ...
                    if (valid) {
                        if (rowData[recIndx] == null) {
                            url = $dir_module_user + "edit_tonkho.php";
                        }
                        else {
                            url = $dir_module_user + "edit_tonkho.php";
                        }
                ...
                if (valid) {
                    rowData._soluongtonckduyet = rowData.soluongtonck;
                    rowData._thanhtientonckduyet = rowData.thanhtientonck;
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Mã VT ", minWidth: 100, dataType: "string", align: "left", dataIndx: "mavt", editable: false,
                ...
                {
                    title: "ĐVT", minWidth: 80, dataType: "string", dataIndx: "dvt", editable: false,align: "center",
                    filter: {type: 'textbox', condition: 'contain', listeners: ['keyup']}
                },
                {
                    title: "Mã TK", minWidth: 80, dataType: "string", dataIndx: "matk", editable: false,align: "center",
                    filter: {type: 'textbox', condition: 'contain', listeners: ['keyup']}
                },
                {
                    title: "SL Tồn",
                    ...
                    dataType: "string",
                    align: "right",
                    dataIndx: "soluongtonck",
                    editable: false,
                    render: function (ui) {
                        var val = ui.rowData.soluongtonck;
                        return $.number(val,3,",",".");
                    }
                ...
                },
                {
                    ...
                    dataType: "string",
                    align: "right",
                    dataIndx: "dongiabinhquan",
                    editable: false,
                    render: function (ui) {
                        var val = ui.rowData.dongiabinhquan;
                        return $.number(val,3,",",".");
                    }
                ...
                },
                {
                    ...
                    dataType: "string",
                    align: "right",
                    dataIndx: "thanhtientonck",
                    editable: false,
                    render: function (ui) {
                        var val = ui.rowData.thanhtientonck;
                        return $.number(val);
                    }
                ...
                },
                {
                    ...
                    editor: {
                        type: "select", options: function (ui) {
                            //remote validation
                            var parsedJson = [{0: "CHỜ DUYỆT"},{2: "THẤP"},{1: "TRUNG BÌNH"},{3: "CAO"}];
                            return parsedJson;
                        }
                    },
                    render: function (ui) {
                        var rowData = ui.rowData,
                            dataIndx = ui.dataIndx;
                        $CanhBao = rowData.canhbao;

                        rowData.pq_cellcls = rowData.pq_cellcls || {};
                        if ($CanhBao == 3) {//if change is negative.
                            rowData.pq_cellcls[dataIndx] = 'maudo';
                            return "CAO";
                        }else if ($CanhBao == 1) {//if change is negative.
                            rowData.pq_cellcls[dataIndx] = 'mauvang';
                            return "T.BÌNH";
                        }else if ($CanhBao == 2) {//if change is negative.
                            rowData.pq_cellcls[dataIndx] = 'mauxanh';
                            return "THẤP";
                ...
                },
                {
                    ...
                    dataType: "string",
                    align: "right",
                    dataIndx: "_soluongtonckduyet",
                    editable: false,
                    render: function (ui) {
                        var val = ui.rowData._soluongtonckduyet;
                        return $.number(val);
                    }
                ...
                },
                {
                    ...
                    dataType: "string",
                    align: "right",
                    dataIndx: "_thanhtientonckduyet",
                    editable: false,
                    render: function (ui) {
                        var val = ui.rowData._thanhtientonckduyet;
                        return $.number(val);
                    }
            ...
            dataModel: {
                ...
                url: $dir_module_user + "list_dsduyet_tonkho.php",//-- Load danh sách lên lưới
...
<div id="dialog-makhachhang"
     title="DUYỆT BẢNG TỒN KHO CUỐI KỲ - <?php echo $mst . " - " . $tencongty; ?>"><!-- dialog -->
