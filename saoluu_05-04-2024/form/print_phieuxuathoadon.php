...
<div style="width: 500px;;" id="dialog_insolieu_nhapxuat" title="In số liệu">
    <iframe id="fred" style="border:1px solid #666CCC" title="" src="modules/psmavattu/inphieuxuathoadonbanhang.php"
        ...
        dialog = $("#dialog_insolieu_nhapxuat").dialog({
            ...
            buttons: {
                "Sổ nhật ký kiểm phiếu": function () {
                    window.open('form/frm_phieukiemtra_nhatky_window.php?loaiphieu=2','kiemtraphieuthu<?php echo $LoaiPhieu; ?>','height='+(getHeight()-80)+',width='+getWidth());
                },
                "Phiếu kiểm tra": function () {
                    window.open('form/frm_phieukiemtra_chungtu_window.php?loaiphieu=2&tuphieu=<?php echo $TuPhieu; ?>&denphieu=<?php echo $DenPhieu; ?>','kiemtraphieuthu<?php echo $LoaiPhieu; ?>','height='+(getHeight()-80)+',width='+getWidth());
                },
                "Kết thúc": function () {
                    xoadialog_print_insolieu_thuchi();
                }
