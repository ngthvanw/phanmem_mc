...
$ppkhautru = load_khoadulieuchidoc($driver."/datafile/".$_SESSION['MST']."/".$_SESSION['NienDo']);
?>
<style>
    #Form-chinh label {
        margin-top: 3px;
...
<div id="dialog-hinhthuc_khaibaothue" title="KHOÁ TOÀN BỘ DỮ LIỆU...">
        ...
        <fieldset style="background-color: #afd9ee;display:none">
            ...
            <table border="0" style="width: 100%;">
                ...
                <tr >
                    ...
                    <td>Từ ngày</td>
                    <td align="right"><input type="date" name="congdontuthang" style="width:130px;" id="congdontuthang" class="text ui-widget-content ui-corner-all" value="<?php if($_SESSION['TuNgay']!=""){ echo $_SESSION['TuNgay'];}else{echo $_SESSION['NienDo'] . "-" . date("m-d");} ?>" /></td>
                    <td>Đến ngày</td>
                    <td align="right">
                    <input type="date" name="congdondenthang" id="congdondenthang" style="width:130px;" class="text ui-widget-content ui-corner-all" value="<?php if($_SESSION['DenNgay']!=""){ echo $_SESSION['DenNgay'];}else{echo $_SESSION['NienDo'] . "-" . date("m-d");} ?>" /></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
            </table>
        ...
        <fieldset style="background-color: #afd9ee" >
            <table border="0" style="width: 100%;">
                <tr>
                    ...
                    <td style="color: red;">Khi khoá dữ liệu , tât cả dữ liệu chỉ có quyền xem không có quyền thay dổi dữ liệu trong năm <?php $_SESSION['NienDo']; ?></td>
                </tr>
                <tr>
                    <td width="6" style="padding-top:3px;"></td>
                    <td><label for="PhuongPhapTinhThue"></label>
                      <select name="PhuongPhapTinhThue" id="PhuongPhapTinhThue" style="width:100%;height:25px;">
                        <option value="0" <?php if($ppkhautru==0 || $ppkhautru=="") echo "selected"; ?>>KHÔNG KHOÁ DỮ LIỆU</option>
                        <option value="1" <?php if($ppkhautru==1) echo "selected"; ?>>KHOÁ DỮ LIỆU TOÀN BỘ NHÂN VIÊN</option>
                        <option value="2" <?php if($ppkhautru==2) echo "selected"; ?>>KHOÁ DỮ LIỆU KHÁCH HÀNG</option>
                    </select></td>
                </tr>
            </table>
        </fieldset>
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                $.ajax({
                    url: $dir_module_tuychon+"editkhoachidoc.php", // Thay dổi file
