    ...
    $(function () {
        ...
        function change_data_quit_makh() { // Cảnh báo thoát khi thay đổi dữ liệu////////////////////////////////////////////////////{
            if(<?php echo $_SESSION['Level']; ?>==3)
            {
                ...
                $.confirm({
                    title: 'CHÚ Ý',
                    content: 'Hệ thống sẽ tự tạo nhật ký kiểm tra kỳ khai thuế (Quý/Tháng) <?php echo $TuPhieu; ?> . Bạn có muốn tạo không ? .<br/>Nhấn phím <strong style="color:blue;">[Y]</strong> để lưu và thoát phím <strong style="color:red;">[N]</strong> để hủy bỏ và thoát ',
                    icon: 'fa fa-warning',
                    type: 'red',
                    buttons: {
                        "GHI NHẬT KÝ": {
