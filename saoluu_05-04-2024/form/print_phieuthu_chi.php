...
<div style="width: 500px;;" id="dialog_insolieu_thuchi" title="In số liệu">
    <iframe id="fred" style="border:1px solid #666CCC" title="PDF in an i-Frame" src="modules/pskt/inphieuthu_chi.php"
        ...
        dialog = $("#dialog_insolieu_thuchi").dialog({
            ...
            buttons: {
                "Sổ nhật ký kiểm phiếu": function () {
                    window.open('form/frm_phieukiemtra_nhatky_thuchi_window.php?loaiphieu=<?php echo $LoaiPhieu; ?>','kiemtraphieuthu<?php echo $LoaiPhieu; ?>','height='+(getHeight()-80)+',width='+getWidth());
                },
                "Phiếu kiểm tra": function () {
                    window.open('form/frm_phieukiemtra_chungtu_window.php?loaiphieu=<?php echo $LoaiPhieu; ?>&tuphieu=<?php echo $TuPhieu; ?>&denphieu=<?php echo $DenPhieu; ?>&ngaycuoi=<?php echo $ngaycuoi; ?>&matk=<?php echo $matk; ?>','kiemtraphieuthu<?php echo $LoaiPhieu; ?>','height='+(getHeight()-80)+',width='+getWidth());
                },
                "Kết thúc": function () {
                    xoadialog_print_insolieu_thuchi();
                }
