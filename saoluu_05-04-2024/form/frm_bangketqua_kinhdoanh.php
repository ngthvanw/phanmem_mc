...
<div id="dialog-bangcandoiketoan" title="Bảng cân đối kế toán...">
        ...
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
                <tr>
                  ...
                  <button type="button" style="width:100%;border:1px solid #990" class="ui-button ui-corner-all ui-widget">Thiết lập số dư tài khoản...</button>
                  </td>
                </tr>
                <tr style="display:none">
                    <td><b>Chứng từ :
