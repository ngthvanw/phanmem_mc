...
<script>
    ...
    $(function () {
        ...
        $("#dialog-ds_nhapkho").keydown(function (event) {//--------------Các phím tắt
            var $grid_pb = $("#grid_editing_nhapkho").closest('.pq-grid');//---- Lưới----------------
            ...
            var rowEditting = $("#grid_editing_nhapkho").pqGrid("getRowsByClass", {cls: 'pq-row-edit'});//---Lấy đối tượng đang sửa
       ...
       /* $.contextMenu('destroy');
        $.contextMenu({// Menu chuột phải
            selector: '#grid_editing_nhapkho',
            build: function ($trigger, e) {
                return {
                    callback: function (key, options) {
                        var $grid_pb = $("#grid_editing_nhapkho").closest('.pq-grid');
        ...
        var manoidung_select = function (ui) {
            ...
            var $inp = $("<input type='text'  name='" + dataIndx + "' class='" + cls + " pq-cell-editor pg-cel-define' readonly />")
                .appendTo($cell)
                .val(dc).keypress(function (e) {
                    $('.dialog_main_manoidung').load("form/frm_dm_manoidung_select.php?idstyle=grid_editing_nhapkho");
                });
        }
        ...
        var makh_select = function (ui) {
            ...
            var $inp = $("<input type='text'  name='" + dataIndx + "' class='" + cls + " pq-cell-editor pg-cel-define' readonly />")
                ...
                .val(dc).keypress(function () {
                    $('.dialog_main_makh').load("form/frm_dm_makh_select.php?idstyle=grid_editing_nhapkho");
                });
        }
        ...
        var $grid = $("#grid_editing_nhapkho").pqGrid(obj);
        ...
        function getRowSelect() { // --------------------Lấy dữ liệu theo dòng trên gird----------------------
            var arr = $("#grid_editing_nhapkho").pqGrid("selection", {
                type: 'cell',
                method: 'getSelection'
...
<div id="dialog-ds_nhapkho"
    ...
    <!-- dialog -->
    <div id="grid_editing_nhapkho" style="margin:5px auto;border: 0px !important;"></div>
</div>