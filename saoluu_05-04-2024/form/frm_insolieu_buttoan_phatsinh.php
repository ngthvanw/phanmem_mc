        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                content: function(){
                    var self = this;
                    return $.ajax({
                        url: $dir_module_baocaothue + "inbangke_bang_buttoan_phatsinh.php",
                        dataType: 'json',
                        method: 'get',
                        data: {
                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                window.open($dir_module_baocaothue+"xuatexcelbangkebanra.php");
                            }else{
                                loadiFrame('tcpdf/baocao/inbangke_bang_buttoan_phatsinh.php');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                content: function(){
                    var self = this;
                    return $.ajax({
                        url: $dir_module_baocaothue + "laythongtininphieu_buttoan_phatsinh.php",
                        dataType: 'json',
                        method: 'get',
                        data: {
                            tenphieu:$("#TenPhieu_ThuChi").val(),
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
                            window.open("tcpdf/baocao/inbangke_bang_buttoan_phatsinh.php","buttoan_phatsinh","menubar=0,resizable=1");
                        }
                    }
                }
            });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BÚT TOÁN PHÁT SINH"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
                            <td><input type="date" name="NgayHoaDon_InPhieu_ThuChi" style="width:100%"
                                       id="NgayHoaDon_InPhieu_ThuChi" value="<?php echo date("Y-m-d"); ?>"/></td>
                        </tr>
                        <tr>
                            <td>Ngày Lập</td>
