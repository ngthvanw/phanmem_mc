...
?>
  ...
  .ui-menu{
    ...
    <div style="width: 500px;;" id="dialog-print_bangluong" title="In phiếu định khoản">
            <iframe id="fred" style="border:1px solid #666CCC" title="PDF in an i-Frame" src="TCPDF/baocao/inphieu_hachtoan.php" frameborder="1" scrolling="auto" height="100%" width="100%" ></iframe>
</div>
  <script>
...
$(function() {
        ...
        dialog = $("#dialog-print_bangluong").dialog({
                ...
                modal: true,
                buttons: {
                    "Sổ nhật ký kiểm phiếu": function () {
                        window.open('form/frm_phieukiemtra_nhatky_window.php?loaiphieu=<?php echo $LoaiPhieu; ?>','kiemtraphieuthu<?php echo $LoaiPhieu; ?>','height='+(getHeight()-80)+',width='+getWidth());
                    },
                    "Phiếu kiểm tra": function () {
                        window.open('form/frm_phieukiemtra_chungtu_window.php?loaiphieu=<?php echo $LoaiPhieu; ?>&tuphieu=<?php echo $TuPhieu; ?>&denphieu=<?php echo $DenPhieu; ?>','kiemtraphieuthu<?php echo $LoaiPhieu; ?>','height='+(getHeight()-80)+',width='+getWidth());
                    },
                        "Kết thúc": function() {
        ...
        dialog.dialog("open");
    $("#dialog-print_bangluon").keydown(function (event) {//--------------Các phím tắt
