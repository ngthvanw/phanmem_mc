...
$soducuoingay = 0;
if(substr($matk,0,4)=='1121') {
    $str_w = "";
    $str_w2 = "";

    $str_w = " and ngayghiso >='" . $_SESSION['kyketoan_tungay'] . "' and ngayghiso<= '" . $ngaycuoi . "'  " . $sql_mabp;
    $OBJKTTH->setStrOderby($str_w);
    $str_w2 = " and ngayghiso >='" . $_SESSION['kyketoan_tungay'] . "' and ngayghiso<='" . $ngaycuoi . "'  " . $sql_mabp1;
    $OBJKTTH->setStrOderby2($str_w2);

    $dauky = $OBJKTTH->load_danhsach_socai_dk_theotk($matk, "ALL", 'sott');

    $soducuoingay = $dauky[$matk]['tienno'] - $dauky[$matk]['tienco'];
}
?>
<!DOCTYPE HTML>
<html lang="vi">
    ...
    $(function () {
        ...
        function change_data_quit_makh() { // Cảnh báo thoát khi thay đổi dữ liệu////////////////////////////////////////////////////{
            if(<?php echo $_SESSION['Level']; ?>==3)
            {
                ...
                $.confirm({
                    title: 'CHÚ Ý',
                    content: 'Hệ thống sẽ tự tạo nhật ký kiểm tra từ phiếu số <?php echo $TuPhieu; ?> đến số <?php echo $DenPhieu; ?> -  Số dư tài khoản <b><?php echo $matk; ?></b> đến ngày <b><?php echo date("d-m-Y",strtotime($ngaycuoi)); ?></b> là <b><?php echo number_format($soducuoingay,0) ?> VNĐ</b>. Bạn có muốn tạo không ?<br/>Nhấn phím <strong style="color:blue;">[Y]</strong> để lưu và thoát phím <strong style="color:red;">[N]</strong> để hủy bỏ và thoát ',
                    icon: 'fa fa-warning',
                    type: 'red',
                    buttons: {
                        "GHI NHẬT KÝ": {
                            keys: ['Y'], action: function () {
                                $.ajax({// Lấy thông tin phiếu và lưu vào session
                                    ...
                                    data: {
                                        ...
                                        matk: '<?php echo $matk; ?>',
                                        ngaycuoi: '<?php echo $ngaycuoi; ?>',
                                        gt1:'<?php echo $soducuoingay; ?>',
                                    },
                                    async: false,
