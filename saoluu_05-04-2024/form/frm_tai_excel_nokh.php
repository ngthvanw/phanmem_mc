...
<head>
    <meta charset="utf-8"/>
    <title>NHẬP NỢ KHÁCH HÀNG ĐẦU KỲ EXCEL</title>
                        ...
                        "Đồng ý": {
                            keys: ['Y'], action: function () {
                                ...
                                $.ajax({// Lấy nội dung của file cần phục hồi
                                    url: $dir_module_chitiet_vattu + "ajaxupload_nokh.php",
                                    type: "POST",
                                    data: form_data,
                                    async: false,
                                ...
                                $.confirm({
                                    ...
                                    content: 'url:' + $dir_module_chitiet_vattu + 'uploadphuchoi_nokh.php',
    ...
    <fieldset
        ...
        <table border="0" style="width: 100%;margin-bottom: 1px;">
            <tr>
                ...
                <td><a href="../tmp/maubangke_nokh.xlsx"><b>Mẫu bảng kê</b></a></td>
            </tr>
