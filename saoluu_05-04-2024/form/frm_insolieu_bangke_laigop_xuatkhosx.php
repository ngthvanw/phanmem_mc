                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                ...
                                loadiFrame('tcpdf/baocao/inbangke_chitiet_hanghoa_laigop_chitiet_xuatkhosx.php');
                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if("<?php echo $congdonhanghoa; ?>"=="1")
                                window.open("tcpdf/baocao/inbangke_chitiet_hanghoa_laigop_chitiet_xuatkhosx.php?sole=<?php echo $sole ?>","bankelaigop","menubar=0,resizable=1");
                            else
                                window.open("tcpdf/baocao/inbangke_chitiet_hanghoa_laigop_chitiet_xuatkhosx.php?sole=<?php echo $sole ?>","bankelaigop_chitiet","menubar=0,resizable=1");
                        }
                    }
                }
            });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="<?php if($nhapxuatkho==3) echo 'BẢNG KÊ HÀNG HÓA XUẤT KHO SẢN XUẤT'; else{ echo 'BẢNG KÊ HÀNG HÓA NHẬP KHO';} ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
