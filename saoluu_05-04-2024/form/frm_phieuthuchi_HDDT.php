            ...
            <table class="table-dialog" style="vertical-align: middle;width: 780PX" border="0">
                <tr>
                    ...
                    <td colspan="3" style="padding: 2px"><input type="hidden" class="button" name="btnmakh" id="btnmakh"
                                                                value="..."/>
                        <input type="text" name="makhachhang" value="" id="makhachhang" list="listmakhachhang" required
                               style="width: 20%"
                    ...
                    <td width="220" style="padding: 2px">
                        <table width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td><input style="text-transform: uppercase" type="text" name="mauso" value=""
                        ...
                        <table width="100%" border="0">
                            <tr>
                                ...
                                <td colspan="2"><input type="hidden" class="button" name="btnmakh2" id="btnmakh2"
                                                       value="..."/>
                                    <input type="text" name="makhachhang2" list="listmakhachhang2" id="makhachhang2"
...

            {
                ...
                if (valid) {
                    $.ajax({
                        ...
                        success: function (result) {
                            if (($LoaiPhieu % 2) == 0 && (tkno1.val().trim() == "2111" || tkno1.val().trim() == "2112" || tkno1.val().trim() == "2113" || tkno2.val().trim() == "2111" || tkno2.val().trim() == "2112" || tkno2.val().trim() == "2113" || tkno1.val().trim() == "242" )) {
