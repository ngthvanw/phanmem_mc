...
<div id="dialog-bangcandoiketoan" title="Bảng cân đối tài khoản...">
    ...
    <form method="post" id="Form-chinh" enctype="multipart/form-data">
        ...
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
                <tr>
                    <td colspan="2"><select name="loctheocap" style="width:100%;height:25px;" id="loctheocap">
                      <option value="1">Tài khoản cấp 1</option>
                      <option  value="2">Tài khoản cấp 2</option>
                      <option selected="selected" value="3">Tài khoản cấp 3</option>
                  </select></td>
                </tr>
                <tr>
                    <td colspan="2">
                       <label><input type="checkbox" name="thucthicongno" id="thucthicongno" style="margin-top: 1px;">&nbsp;Thực thi kèm theo bảng tổng hợp công nợ khách hàng</label>
                    </td>
                </tr>
                <tr style="display:none">
                    <td><b>Sắp xếp : </b></td>
                ...
                <tr  style="display:block;">
                    <td colspan="2">
                        <table style="width: 100%">
                            <tr>
                                <td style="display: none;"><input name="xemchitiet" type="checkbox" id="xemchitiet"
                                           checked="checked"></td>
                                <td><b style="color: red;">&nbsp;&nbsp;Phải thực thi công nợ trước bảng cân đối tài khoản</b></td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
        ...
        <fieldset style="background-color: #afd9ee;display:none">
            ...
            <table>
                <tr>
                    <td><input type="checkbox" style="display: none;" name="KhoaSoVaChuyenTonKho" id="KhoaSoVaChuyenTonKho"></td>
                    <td><b style="color: red;">Phải thực thi bảng công nợ trước khi chạy bảng cân đối</b></td>
                </tr>
            </table>
        </fieldset>
    </form>
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            $kieuin = $("#kieuin").val();
            valid = valid && checkNull(congdontuthang, " Từ ngày  ");
            valid = valid && checkNull(congdondenthang, " Đến ngày  ");
            if($("#thucthicongno").prop("checked") == true){
                $.confirm({
                    title: 'Thực thi công nợ tổng hợp thành công',
                    type: 'green',
                    autoClose: 'OK|1000',
                    content: function () {
                        var self = this;
            ...
            if (valid) {
                $('.dialog_main_thongbao').load("form/frm_insolieu_bangcandoitaikhoan.php?tungay=" + $tungay + "&denngay=" + $denngay + "&intheothuesuat=" + $loctheocap + "&intheochungtu=" + $Intheochungtu+ "&sapxeptheohoadon=" + $sapxeptheohoadon+ "&theothongtu=" + $theothongtu+ "&kieuin=" + $kieuin+ "&xemchitiet=" + $xemchitiet);
            }
