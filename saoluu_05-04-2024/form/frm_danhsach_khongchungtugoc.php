    ...
    $(function () {
        ...
        var obj = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                    ...
                    render: function (ui) {
                        ...
                        if($nhapxuat==2){
                            if($loaiphieu==1){
                                ...
                                return "PHIẾU GHI CÓ";
                            }else if($loaiphieu>=5 && $loaiphieu%2!=0 ){
                                return "PHIẾU THU NH";
                            }else if($loaiphieu>=5 && $loaiphieu%2==0 ){
                                return "PHIẾU CHI NH";
                            }
                ...
                {
                    title: "Trạng thái", minWidth: 100, dataType: "integer", align: "center", dataIndx: "chungtugoc",
                    filter: { type: "select",
                        condition: 'equal',
                        prepend: { '': '----Tất cả----' },
                        options: function (ui) {
                            var parsedJson = [ { 0:"KHÔNG CHỨNG TỪ GỐC"}, {1: "CÓ CHỨNG TỪ GỐC"}] ;
                            return parsedJson;
                        },
                        listeners: ['change']
                    },
                    render: function (ui) {
                        var value = ui.rowData.chungtugoc;
                        if (value == "1") {
                ...
                {
                    title: "Ngày cập nhật", minWidth: 150, dataType: "string", align: "center", dataIndx: "capnhat_chungtugoc",
                }
            ],//-----------------------------------------Kết thúc các cột---------------------------------------
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_dsnhapkho + "list_khongchungtugoc.php",//-- Load danh sách lên lưới
...
<div id="dialog-ds_hoadon_khongchungtu"
     title="DANH SÁCH HÓA ĐƠN KHÔNG CÓ CHỨNG TỪ GỐC... (ESC: Thoát)">
    <!-- dialog -->
