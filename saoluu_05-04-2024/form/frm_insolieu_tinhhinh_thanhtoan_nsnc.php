        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                content: function(){
                    var self = this;
                    return $.ajax({
                        url: $dir_module_ketoantonghop + "laythong_tinhhinh_thanhtoan_ngansach.php",
                        dataType: 'json',
                        method: 'get',
                        data: {
                        ...
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                ...
                                if(<?php echo $congdontheosocai ?>=="0"){
                                    loadiFrame('tcpdf/baocao/inbangke_tinhhinh_thanhtoan_ngansach.php?congdontheosocai=<?php echo $congdontheosocai ?>');
                                }else{
                                    loadiFrame('tcpdf/baocao/inbangke_tinhhinh_thanhtoan_ngansach.php?congdontheosocai=<?php echo $congdontheosocai ?>');
                                }
            ...
            $.confirm({
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
                            if(<?php echo $congdontheosocai ?>=="0"){
                                window.open("tcpdf/baocao/inbangke_tinhhinh_thanhtoan_ngansach.php?congdontheosocai_nopnsnn=<?php echo $congdontheosocai ?>","thanhtoanngansach","menubar=0,resizable=0");
                            }else{
                                window.open("tcpdf/baocao/inbangke_tinhhinh_thanhtoan_ngansach.php?congdontheosocai_nopnsnn=<?php echo $congdontheosocai ?>","thanhtoanngansach","menubar=0,resizable=0");
                            }
                        }
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BẢNG TỔNG HỢP THANH TOÁN THUẾ VÀ CÁC KHOẢN PHẢI NỘP NGÂN SÁCH NHÀ NƯỚC NĂM <?php echo $_SESSION['NienDo']; ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
