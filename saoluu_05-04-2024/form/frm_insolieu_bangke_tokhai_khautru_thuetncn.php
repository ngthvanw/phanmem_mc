...
$quy = LayQuy($thangtinhthue,$_SESSION['NienDo']);
    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_baocaothue + "laythongtininphieukekhai_khautru_tncn.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                loadiFrame('modules/baocaothue/inphieu_tokhai_khautru_thuetncn.php?<?php echo $query; ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $('.dialog_main_print').load("form/print_bangke_tokhai_khautru_thuetncn.php?<?php echo $query; ?>");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="TỜ KHAI KHẤU TRỪ THUẾ THU NHẬP CÁ NHÂN"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
