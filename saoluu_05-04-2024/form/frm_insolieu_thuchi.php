...
<script>
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
			...
			var $loaiphieu = <?php echo $LoaipPhieu ?>;
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_ps_kt + "laythongtininphieuthuchi.php",
                data: {
                    sophieu: $sophieu,
					 tuphieu: $TuPhieu,
                    denphieu: $DenPhieu,
            ...
            loadiFrame('modules/pskt/inphieuthu_chi.php');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            // window.open($dir_module_manv_chamcong+'exportexcel.php?json='+encode64(parsedJson)+"&mactnhom="+(stringmact_nhom)+"&tuan="+encode64($tuan));
            $('.dialog_main_print').load("form/print_phieuthu_chi.php?loaiphieu=<?php echo $LoaipPhieu; ?>&tuphieu="+$TuPhieu+"&denphieu="+$DenPhieu);
        });
