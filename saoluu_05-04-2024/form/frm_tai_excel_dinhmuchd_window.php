...
<head>
    <meta charset="utf-8"/>
        <title>NHẬP ĐỊNH MỨC HỢP ĐỒNG</title>
                        ...
                        "Đồng ý": {
                            keys: ['Y'], action: function () {
                                ...
                                $.ajax({// Lấy nội dung của file cần phục hồi
                                    url: $dir_module_chitiet_vattu + "ajaxupload_dinhmuc_hd.php",
                                    type: "POST",
                                    data: form_data,
                                    async: false,
                                ...
                                $.confirm({
                                    ...
                                    content: 'url:' + $dir_module_chitiet_vattu + 'uploadphuchoi_dinhmuc_hd.php?nhacungcap='+$NhaCungCap,
        ...
        <tr>
            <td width="150px;" >
                <select style="width: 98%" id="NhaCungCap">
                    <option value=<?php echo $masp ?>>---EXCEL</option>
                </select></td>
            <td colspan="2" width="300px;"><input type="file" id="filedulieu" accept=".xls,.xlsx,.xml"></td>
            <td><a href="../tmp/maudinhmuc_hd.xlsx"><b>Mẫu bảng kê</b></a></td>
        </tr>
        <tr>
            <td width="150px;"></td>
            <td width="150px;"></td>
