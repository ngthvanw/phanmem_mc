...
<div id="dialog-bangcandoiketoan" title="BẢNG ĐIỀU TRA XÂY DỰNG CÔNG TRÌNH...">
    ...
    <form method="post" id="Form-chinh" enctype="multipart/form-data">
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
                <tr>
                    <td width="3%"><input name="rd_thangtonkho" type="radio" id="rd_thangtonkho" checked="checked"></td>
                    <td width="8%">&nbsp;Quý</td>
                    <td width="40%">
                        <select style="width:100%;height:20px;" name="quydieutra" id="quydieutra">
                ...
                <tr style="display:none;">
                 ...
                 <tr>
                  <td colspan="7"><br/>                  
                  <button id="nhapbangdieutra" type="button" style="width:100%;border:1px solid #990" class="ui-button ui-corner-all ui-widget">NHẬP BẢNG ĐIỀU TRA XÂY DỰNG</button>
                  </td>
                </tr>
...
///-------------------Kết thúc--------------------------------
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
                            $('.dialog_main_thongbao').load("form/frm_insolieu_bangphanbo_chiphi_congtrinh.php?tungay=" + $tungay + "&denngay=" + $denngay);
                        }
                    }
                }
            });
		...
		$("#nhapbangdieutra").click(function(){
			$quy = $("#quydieutra").val();
			$('.dialog_main_dinhmuc_sanpham').load('form/frm_dm_bangdieutra_xaydung_congtrinh.php?quy='+$quy);
		});
