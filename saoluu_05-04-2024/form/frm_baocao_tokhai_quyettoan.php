...
<div id="dialog-thietminh_baocao_taichinh" title="TỜ KHAI QUYẾT TOÁN THUẾ TNCN...">
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                $tontai = true;
                if ($tontai) {
                    var result = confirm("Đã tồn tại tờ khai quyết toán thuế TNCN ! Bạn có muốn ghi đè ?");
                    if (result) {
                        $.confirm({
                            title: 'Thành công',
                            type: 'green',
                            ...
                            content: function(){
                                var self = this;
                                return $.ajax({
                                    url: $dir_module_dmsanpham + "laythongtintokhaithue_tndn.php",
                                    dataType: 'json',
                                    method: 'get',
                                    data: {
                                        tungay:$tungay,
                            ...
                            buttons: {
                                "OK": {
                                    keys: ['Y'], action: function () {
                                        $('.dialog_main_thongbao').load("form/frm_insolieu_tokhai_quyettoanthue_tncn.php?tungay="+$tungay+"&denngay="+$denngay);
                                    }
                                }
                            }
                        });
