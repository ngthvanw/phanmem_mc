...
<div id="dialog-thietminh_baocao_taichinh" title="KẾT XUẤT BÁO CÁO TÀI CHÍNH...">
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                $tontai = true;
                if ($tontai) {
                    var result = confirm("Đã tồn tại bảng báo cáo tài chính ! Bạn có muốn ghi đè ?");
                    if (result) {
                        $.confirm({
                            title: 'Thành công',
                            type: 'green',
                            ...
                            content: function(){
                                var self = this;
                                return $.ajax({
                                    url: $dir_module_ketoantonghop + "laythongtin_bangbaocao_taichinh.php",
                                    dataType: 'json',
                                    method: 'get',
                                    data: {
                                        tungay:$tungay,
                            ...
                            buttons: {
                                "OK": {
                                    keys: ['Y'], action: function () {
                                        $('.dialog_main_thongbao').load("form/frm_insolieu_ketxuat_baocao_taichinh.php?tungay="+$tungay+"&denngay="+$denngay);
                                    }
                                }
                            }
                        });
