...
<script>
    ...
    $(function () {
        ...
        $("#dialog-ps_kt").keydown(function (event) {//--------------Các phím tắt
            var $grid_pb = $("#grid_editing_ps_kt").closest('.pq-grid');//---- Lưới----------------
            ...
            var rowEditting = $("#grid_editing_ps_kt").pqGrid("getRowsByClass", {cls: 'pq-row-edit'});//---Lấy đối tượng đang sửa
       ...
       /* $.contextMenu('destroy');
        $.contextMenu({// Menu chuột phải
            selector: '#grid_editing_ps_kt',
            build: function ($trigger, e) {
                return {
                    callback: function (key, options) {
                        var $grid_pb = $("#grid_editing_ps_kt").closest('.pq-grid');
        ...
        var manoidung_select = function (ui) {
            ...
            var $inp = $("<input type='text'  name='" + dataIndx + "' class='" + cls + " pq-cell-editor pg-cel-define' readonly />")
                .appendTo($cell)
                .val(dc).keypress(function (e) {
                    $('.dialog_main_manoidung').load("form/frm_dm_manoidung_select.php?idstyle=grid_editing_ps_kt");
                });
        }
        ...
        function update(rowIndx, $grid) {
            ...
            if (isDirty) {
                ...
                if (rowData[recIndx] == null) {
                    //url to add records.
                    url = $dir_module_ps_kt + "add.php";
                }
                else {
                    //url to  update records.
                    url = $dir_module_ps_kt + "edit.php";
                }
                var sott = "";
                $.ajax($.extend({}, ajaxObj, {
                    context: $grid,
        ...
        var makh_select = function (ui) {
            ...
            var $inp = $("<input type='text'  name='" + dataIndx + "' class='" + cls + " pq-cell-editor pg-cel-define' readonly />")
                ...
                .val(dc).keypress(function () {
                    $('.dialog_main_makh').load("form/frm_dm_makh_select.php?idstyle=grid_editing_ps_kt");
                });
        }
        ...
        var obj = {
                ...
                },
                {
                    ...
                    filter: {
                        ...
                        options: function (ui) {
                            ...
                            var parsedJson = "";
                            $.ajax({
                                url: $dir_module_ps_kt + "cb_loaiphieu.php",
                                data: {},
                                async: false,
                                success: function (response) {
                    ...
                    render: function (ui) {
                        ...
                        var $TenLoai = "";
                        $.ajax({
                            url: $dir_module_ps_kt + "ten_loaiphieu.php",
                            data: {ma: $maloaict},
                            async: false,
                            success: function (response) {
                                $TenLoai = response;
                        ...
                        {type: 'minLen', value: 1, msg: "Tài khoản nợ không được trống !"},
                        {
                            type: function (ui) {
                                ...
                                if (_found) {
                                    ...
                                    $('.dialog_main_httk').load("form/frm_dm_httk_select.php?idstyle=grid_editing_ps_kt");
                                    return false;
                                }
                            }
                        }
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_ps_kt + "list.php",//-- Load danh sách lên lưới
        ...
        var $grid = $("#grid_editing_ps_kt").pqGrid(obj);
        ...
        function getRowSelect() { // --------------------Lấy dữ liệu theo dòng trên gird----------------------
            var arr = $("#grid_editing_ps_kt").pqGrid("selection", {
                type: 'cell',
                method: 'getSelection'
...
<div id="dialog-ps_kt"
     title="Phát sinh phiếu chi... (F2: Sửa , F7: Sao chép , F8: Xóa , F9: Lưu , END : Hủy dòng đang sửa, INSERT: Thêm chi tiết phiếu chi  )">
    <!-- dialog -->
    <div id="grid_editing_ps_kt" style="margin:5px auto;border: 0px !important;"></div>
</div>