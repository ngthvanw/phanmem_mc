            ...
            if ($('div').hasClass('jconfirm') == false) {
                ...
                if ((event.keyCode == Keys.ESCAPE) && $('div').hasClass('jconfirm') == false && rowEditting.length < 1) {
                   ...
                   // if($tkco==""){
                    ...
                    $tongtiennt = Math.round($TongTTNT);
...
//change edit button to update button and delete to cancel.
        ...
        var objxuatkho = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {title: "Mã VT", dataType: "string", dataIndx: "mavt", width: 100, sortable: true,
				...
				{
                    title: "Giá vốn", width: 85, dataType: "string", align: "right", dataIndx: "gianhap",editable: false,
