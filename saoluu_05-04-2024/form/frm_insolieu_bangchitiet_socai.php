                        ...
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                ...
                                if("<?php echo $congdontheosocai ?>"=="0"){
                                    loadiFrame('tcpdf/baocao/inbangke_sochitiet_socai.php?congdontheosocai=<?php echo $congdontheosocai ?>');
                                }else{
                                    loadiFrame('tcpdf/baocao/inbangke_sochitiet_socai_congdon.php?congdontheosocai=<?php echo $congdontheosocai ?>');
                                }
            ...
            $.confirm({
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
                            if("<?php echo $congdontheosocai ?>"=="0"){
                                window.open("tcpdf/baocao/inbangke_sochitiet_socai.php?congdontheosocai=<?php echo $congdontheosocai ?>","insocai","menubar=0,resizable=0");
                            }else{
                                window.open("tcpdf/baocao/inbangke_sochitiet_socai_congdon.php?congdontheosocai=<?php echo $congdontheosocai ?>","insocai","menubar=0,resizable=0");
                            }
                        }
                    }
                }
                    ...
                    <table width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td><input type="date" name="NgayLap_InPhieuThuChi" style="width:100%"
                                       value="<?php echo ($_SESSION['NienDo'] == date('Y')) ? date('Y-m-d') : $_SESSION['NienDo'].'-12-31'; ?>" id="NgayLap_InPhieuThuChi"/></td>
                        </tr>
                        <tr>
