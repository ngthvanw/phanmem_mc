...
function ThanhTien($SoLuong, $DonGia,$TienChietKhau,$ThanhTienNhap) {
        ...
        var objxuatctct = {
            ...
            change: function (evt, ui) {// Khi dữ liệu thay đổi
                ...
                $soluong = parseFloat(rowData.soluong.toString().toString().split(",").join(""));// Lấy số lượng nhập vào

                $dongia = parseFloat(rowData.dongia.toString().toString().split(",").join(""));// Lấy đơn giá nhập vào
                ...
                $dongiatinh = Math.round(($thanhtien/$soluong),2);
                rowData.dongia = $dongiatinh.toString();

                //var str = rowData.dongia; // Lấy đơn giá nhập
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                },
                {
                    ...
                    render: function (ui) {
                        return $.number(ui.rowData.soluong,2,".",",");
                    }
                },
                {
                    ...
                    render: function (ui) {
                        ...
                        return $.number(ui.rowData.dongia,2,".",",");
                    }
                },
                {
                    title: "Thành tiền",
