    ...
    $(function () {
        ...
        var obj = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Phân bổ", minWidth: 100, dataType: "integer", align: "center", dataIndx: "khauhao",hidden:false,
                ...
                },
                {
                    ...
                    editable: false,
                    validations: [
                        {type: 'minLen', value: 4, msg: "Mã phải có  4 đến 14 ký tự  !"},
                        {type: 'maxLen', value: 14, msg: "Mã phải có 4 đến 14 ký tự !"},
                ...
                {
                    title: "Tên CP", minWidth: 200, dataType: "string", dataIndx: "tents", editable: true,
                    validations: [
                ...
                },
                {
                    ...
                    render: function (ui) {{
                        var parsedJson = [ { "id":"1531","name":"Công cụ dụng cụ"}, {"id":"1535","name":"Chi phí trả trước"}] ;
			...
			dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_danhmuccptratruoc + "listallmats.php",//-- Load danh sách lên lưới
...
<div id="dialog-dm_cptratruoc" title="DANH SÁCH DANH MỤC CHI PHÍ TRẢ TRƯỚC... (ENTER: Sửa và Lưu, F4: Thêm, F7: Sao chép ,F8 : Xóa , ESC : Thoát )"><!-- dialog -->
