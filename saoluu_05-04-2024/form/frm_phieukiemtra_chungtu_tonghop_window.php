            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                },
                {
                    ...
                    filter: {
                        ...
                        prepend: { '': '--TẤT CẢ--' },
                        condition: 'equal',
                        options: [ {"1":"NHẬP KHO"}, {"2":"XUẤT KHO"}, {"3":"PHIẾU THU"},{"4":"PHIẾU CHI"},{"5":"PHIẾU GHI CÓ"},{"6":"PHIẾU GHI NO"} ],
                        listeners: ['change']
                    },
                    editor: {type: "select",options: function (ui) {
                        //remote validation
                        var parsedJson = [ {"":"CHỌN LOẠI PHIẾU"},{"1":"NHẬP KHO"}, {"2":"XUẤT KHO"}, {"3":"PHIẾU THU"},{"4":"PHIẾU CHI"},{"5":"PHIẾU GHI CÓ"},{"6":"PHIẾU GHI NO"} ];
                        return parsedJson;
                    }
                    },
                },
...
<div id="dialog-makhachhang"
     title="THỐNG KÊ PHIẾU KIỂM TRA CHỨNG TỪ KẾ TOÁN (ENTER : Sửa,Lưu ,F4: Thêm mới  , F7: Sao chép , F8: Xóa )"><!-- dialog -->
