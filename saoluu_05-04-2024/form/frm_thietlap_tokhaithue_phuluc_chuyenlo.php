    ...
    $(function () {
        ...
        var objtokhaiphuluc = {
            ...
            change: function (evt, ui) {// Khi dữ liệu thay đổi                
                ...
                var url = "";
                if (type == 'update') {
                    $solophatsinh = rowData.solophatsinh;
                    $sochuyenkytruoc = rowData.sochuyenkytruoc;
                    $sochuyentrongky = rowData.sochuyentrongky;
                    $soloconduocchuyen = $solophatsinh-$sochuyenkytruoc-$sochuyentrongky;
                    rowData.sochuyenkysau = $soloconduocchuyen;
                    var valid = grid.isValid({rowData: rowData, allowInvalid: true}).valid;
                    if (valid) {
                        if (rowData[recIndx] == null) {
                            //url = $dir_module_baocaothue+"add_tokhai_thuetndn.php";
                            url = $dir_module_baocaothue + "edit_sotien_tokhai_plchuyenlo.php";
                        }
                        else {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Số lỗ phát sinh", width: 100, dataType: "integer", dataIndx: "solophatsinh", align: "right",
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.solophatsinh, 0, ".", ",");
                    }
                },
                {
                    title: "Số lỗ đã chuyển trong các kỳ tính thuế trước", width: 100, dataType: "integer", dataIndx: "sochuyenkytruoc", align: "right",
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.sochuyenkytruoc, 0, ".", ",");
                    }
                },
                {
                    title: "Số lỗ đã chuyển trong các kỳ tính thuế này", width: 100, dataType: "integer", dataIndx: "sochuyentrongky", align: "right",
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.sochuyentrongky, 0, ".", ",");
                    }
                },
                {
                    title: "Số lỗ còn được chuyển sang các kỳ tính thuế sau", width: 100, dataType: "integer", dataIndx: "sochuyenkysau", align: "right",editable: false,
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.sochuyenkysau, 0, ".", ",");
                    }
                },
                {
                    title: "Ghi chú",
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_baocaothue + "list_tokhai_thuetndn_plchuyenlo.php",//-- Load danh sách lên lưới
...
<div id="dialog-thietlap_tokhai_phuluckqkd" title="THIẾT LẬP PHỤ LỤC CHUYỂN LỖ TỪ HOẠT ĐỘNG SXKD"><!-- dialog -->
