        ...
        $("#dialog-makhachhang").keydown(function (event) {//--------------Các phím tắt
            ...
            if (event.keyCode == Keys.F7) { // copy
                if (rowSelect != false) {
                    ...
                    var _dataRow = {
                        namhd: rowData.namhd,
                        ngaybd: rowData.ngaybd,
                        ngaykt: rowData.ngaykt,
                        giadichvu: rowData.giadichvu,
                    };
                    addRow(rowIndx + 1, 'masothue', $grid_pb, _dataRow);
                }
            }
        ...
        function deleteRow(rowData, $grid) {
            ...
            if ($('div').hasClass('jconfirm') == false) {
                $.confirm({
                    ...
                    content: "Bạn có muốn xóa dữ liệu này không ?" + '<br/>Nhấn phím <strong style="color:blue;">[Y]</strong> để đồng ý phím <strong style="color:red;">[N]</strong> để hủy bỏ ',
                    buttons: {
                        "Đồng ý": {
                            keys: ['Y'], action: function () {
                                ...
                                $.ajax($.extend({}, ajaxObj, {
                                    context: $grid,
                                    url: $dir_module_banggiaonhan + "del_quanly_hopdong_daily.php",
                                    data: {id: sott},
        ...
        var obj = {
                ...
                if (type == 'update') {
                    ...
                    if (valid) {
                        if (rowData[recIndx] == null){
                            url = $dir_module_banggiaonhan + "add_quanly_hopdong_daily.php";
                        }
                        else {
                            url = $dir_module_banggiaonhan + "edit_quanly_hopdong_daily.php";
                        }
                    }
                }
                if (valid) {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                },
                {
                    ...
                    dataIndx: "namhd",
                    validations: [
                        {type: 'minLen', value: 1, msg: "Dữ liệu không được trống !"}
                    ],
                ...
                },
                {
                    ...
                    render:function( ui ){
                        var $yyyy_mm_dd = ui.rowData.ngaybd;
                ...
                },
                {
                    ...
                    render:function( ui ){
                        var $yyyy_mm_dd = ui.rowData.ngaykt;
                        return Format_dd_mm_yyyy($yyyy_mm_dd);
                    },
                    validations: [
                        {type: 'minLen', value: 1, msg: "Dữ liệu không được trống !"}
                ...
                },
                {
                    ...
                    render:function( ui ){
                        var values = ui.rowData.giadichvu;
                ...
                },
                {
                    ...
                    editable: false,
                    render:function( ui ){
                        var values = ui.rowData.teptin;
                        return "<a target='_blank' href='"+values+"'>Xem</a>";
                    },
                },
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_banggiaonhan + "list_qualy_hopdong_daily.php",//-- Load danh sách lên lưới
...
<div id="dialog-makhachhang"
     title="DANH SÁCH HỢP ĐỒNG ĐẠI LÝ THUẾ (F4: THÊM MỚI, F7: SAO CHÉP, F8: XOÁ)"><!-- dialog -->
