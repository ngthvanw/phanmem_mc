                    ...
                    <td width="70%">
                        <table style="width: 100%" border="0">
                            ...
                            <tr>
                                ...
                                <td> <input style="margin-top: 5px;" type="checkbox" name="Intheothuesuat[]" value="kk">&nbsp;Không kê khai</td>
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                $('.dialog_main_thongbao').load("form/frm_insolieu_bangke_muavao.php?tungay=" + $tungay + "&denngay=" + $denngay + "&intheothuesuat=" + $Intheothuesuat + "&intheochungtu=" + $Intheochungtu+ "&sapxeptheohoadon=" + $sapxeptheohoadon+ "&theothongtu=" + $theothongtu+ "&kieuin=" + $kieuin+"&loaibangke="+$loaibangke+"&loaithue="+$loaithue+"&chinhanh="+$chinhanh);
            }
