    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_dmsanpham + "laythongtinbangtietkiem_langphi_vlct.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                loadiFrame('tcpdf/baocao/inbang_tietkiem_langphi_vlct.php');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            window.open("tcpdf/baocao/inbang_tietkiem_langphi_vlct.php","inbang_tietkiem_langphi_vlct","menubar=0,resizable=1");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BẢNG TỔNG HỢP MỨC TIẾT KIỆM/LÃNG PHÍ VL CÔNG TRÌNH"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
                            <td><input type="text" name="NgayHoaDon_InPhieu_ThuChi" style="width:100%"
                                       id="NgayHoaDon_InPhieu_ThuChi" value="Từ ngày <?php echo date("d-m-Y",strtotime($tungay)); ?> đến ngày <?php echo date("d-m-Y",strtotime($denngay)); ?>"/></td>
                        </tr>
                        <tr>
                            <td>Ngày Lập</td>
