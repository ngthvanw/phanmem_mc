    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_psvattu_ketoantonghop + "laythongtininphieu_bangchitiet_nokhachhang.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                if('<?php echo $loaingoaite; ?>'=='VND'){
                loadiFrame('tcpdf/baocao/inbang_chitiet_nokhachhang.php');
                }else{
                    loadiFrame('tcpdf/baocao/inbang_chitiet_nokhachhang_nt.php');
                }
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            if('<?php echo $loaingoaite; ?>'=='VND'){
                window.open("tcpdf/baocao/inbang_chitiet_nokhachhang.php","chitietnokhachhang","menubar=0,resizable=0");
            }else{
                window.open("tcpdf/baocao/inbang_chitiet_nokhachhang_nt.php","chitietnokhachhangnt","menubar=0,resizable=0");
            }
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="SỔ CHI TIẾT THANH TOÁN KHÁCH HÀNG"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
