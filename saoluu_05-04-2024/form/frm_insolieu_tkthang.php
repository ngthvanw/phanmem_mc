    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            if($("#XuatExcel").prop("checked") == true){
                window.open($dir_module_nhapkho+"xuatexceltk.php?sole=<?php echo $sole ?>");
            }else{
                loadiFrame('modules/psmavattu/inphieutkthang.php?sole=<?php echo $sole ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $('.dialog_main_print').load("form/print_phieutkthang.php?sole=<?php echo $sole ?>");
        });
