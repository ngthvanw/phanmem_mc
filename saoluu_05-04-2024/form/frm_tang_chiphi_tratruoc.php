...
if($_GET['ngayghiso']!=""){
    ...
    $ngayghiso = date("Y-m-d");
}
$nguyengia = str_replace(",","",$_GET['nguyengia']);
$tk = $_GET['tk'];
$form = $_GET['form'];
require("../config.php");
?>
...
<div id="dialog-tangtaisan" title="TĂNG CHI PHÍ TRẢ TRƯỚC">
            ...
            <table class="table-dialog" style="vertical-align: middle;width: 100%" border="0">
                <tr>
                    ...
                    <td width="27%"><span style="padding: 2px">
                      <input type="date" name="ngayghiso" value="<?php echo $ngayghiso ?>" style="width:97%" id="ngayghiso"
                               required="require"
                 ...
                 <td width="17%" style="padding: 2px"><label for="name13"> Tham chiếu :</label></td>
                   ...
                   <td width="17%" style="padding: 2px"><label for="name13"> Ngày :</label></td>
                    <td width="27%"><span style="padding: 2px">
                      <input type="date" name="ngay" value="<?php echo $ngayghiso ?>" style="width:97%" id="ngay"
                               required="require"
                               placeholder="Ngày ghi sổ" class="text ui-widget-content ui-corner-all"/>
                    </span></td>
          ...
          <table width="100%" border="0">
              ...
              <tr>
                  ...
                  <td colspan="3"><span style="padding: 2px">
                    <select name="NhomTS" class="text ui-widget-content ui-corner-all" id="NhomTS" style="width: 98%;height:20px;">
                      <option value="1531">Công cụ, dụng cụ</option>
                      <option value="1535">Chi phí trả trước</option>
                    </select>
<datalist id="listNhomTS"></datalist></td>
              ...
              <tr>
                  ...
                  <td colspan="2"><span style="padding: 2px">
                    <input type="date" readonly name="ngaysudung" value="<?php echo date("Y-m-d") ?>" style="width:97%" id="ngaysudung"
                               required="required"
                               placeholder="Ngày ghi sổ" class="text ui-widget-content ui-corner-all"/>
                  </span></td>
              </tr>
              ...
              <tr>
                  ...
                  &nbsp;tháng </td>
                  <td colspan="2" align="right"><label for="name4"> Số tháng PB còn lại:</label></td>
         ...
         <fieldset style="background-color: #afd9ee">
         <legend>Mức phân bổ
           </legend><table class="table-dialog" style="vertical-align: middle;width: 100%" border="0">
                <tr>
...
/// bắt dầu mã bộ phận
        ...
        function laythongtinphieudanhap() {
            if("<?php echo $sottphieukhac; ?>"!=""){
                $data = "";
                $.ajax({
                    url: $dir_module_danhmuccptratruoc + "laythongtintaisanps_theothamchieu.php",
                    data: {thamchieu: "<?php echo $sottphieukhac; ?>"},
                    async: false,
                    success: function (response) {
                ...
                if ($checkphieuthuchi == 0) {
                    checkSTT("");
                    $("#thamchieu").val(<?php echo $sottphieukhac; ?>);
                    $("#matk").val(<?php echo $tk; ?>);
                    $("#nguyengia").val(<?php echo $nguyengia; ?>);
                }else{
                    //alert("2");
                    $("#STT").val($data.mapsts);
                    checkSTT($data.mapsts);
                }
            }
        }
                ...
                if($sophieu!=""){
                    ...
                    if (answer){
                        $.ajax({
                            ...
                            data: {sophieu:$sophieu,loaiphieu:"1"},
                            async: false,
                            success: function (response) {
                                $data = (response);
                            }
...
///-------------------Kết thúc--------------------------------
       function layngayghiso($loaiphieu){
        ...
        $(btnstt).click(function (event) {// Gọi table khách hàng để chọn
            $('.dialog_main_ds_nhapkho').load("form/frm_ds_tanggiam_cptratruoc.php?idstyle=Form-chinh&idinput=STT&idfocus=STT&loaiphieu=1&loai=ccđc");
        });
		...
		$("#nguyengia").focusout(function () {
            ...
            $("#tylekhachhang").val($thoigiansudung);
                ...
                if (valid) {
                    $.ajax({
                        ...
                        success: function (result) {
                           $('.dialog_main_thongbao').load('form/frm_thongbao_tang_taisan.php?sottphieukhac=<?php echo $sottphieukhac ?>&form=<?php echo $form; ?>');
                        }
                    });
                }
        ...
        dialog = $("#dialog-tangtaisan").dialog({
            ...
            buttons: {
                ...
                "Kết thúc": function () {
                    $('.dialog_main_thongbao').load('form/frm_thongbao_tang_taisan_thoat.php?sottphieukhac=<?php echo $sottphieukhac ?>&form=<?php echo $form; ?>');
                }
            }
        });
        dialog.dialog("open");
        laythongtinphieudanhap();
