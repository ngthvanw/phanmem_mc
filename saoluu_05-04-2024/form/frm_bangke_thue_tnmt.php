        ...
        <fieldset style="background-color: #afd9ee;">
            ...
            <table style="font-size: 14px" border="1" width="780px">
                ...
                <tr>
                    ...
                    <td style="text-align: center;width: 150px;" >(6)=(4)X(5)</td>
                </tr>
                <tr>
                    ...
                    if (retVal == true) {
                        $.confirm({
                            ...
                            content: function(){
                                var self = this;
                                return $.ajax({
                                    url: $dir_module_baocaothue + "themtokhaithue_bvmt.php?loaiks=" + $loaiks + "&dvt=" + $dvt + "&tenloai=" + $tenloai + "&soluong=" + $soluong + "&mucphi=" + $mucphi + "&thanhtien=" + $thanhtien + "&thangtinhthue=" + $thangtinhthue + "&loaitokhai="+$loaitokhai+ "&maloaiks="+$maloaiks+ "&tendvt="+$tendvt+ "&namtinhthue="+$namtinhthue,
                                    async: false,
                                });
                            },
                            buttons: {
