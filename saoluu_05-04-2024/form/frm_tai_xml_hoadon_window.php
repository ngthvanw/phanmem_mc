                            ...
                            "Nhập phiếu Thu/Chi/Khác": {
                                keys: ['Y'], action: function () {
                                    $.confirm({
                                        ...
                                        autoClose: 'Thoát|1000',
                                        method: 'POST',
                                        content: 'url:' + $dir_module_chitiet_vattu + 'chepdulieu_sangphieuthu_chi_khac.php?sophieu=<?php echo $sophieu; ?>&TTHoaDon=' + $TTHoaDon1,
                                        contentLoaded: function () {
                                        },
                                        buttons: {
                                            "Thoát": {
                        ...
                        "Đồng ý": {
                            keys: ['Y'], action: function () {
                                ...
                                $.confirm({
                                    ...
                                    content: 'url:' + $dir_module_chitiet_vattu + 'uploadphuchoi.php?nhacungcap=' + $NhaCungCap + '&sophieu=<?php echo $sophieu; ?>&manhom=' + $manhom + '&matkhang=' + $matkhang + '&matkdoanhthu=' + $matkdoanhthu,
            ...
            <tr>
                <td width="150px;">
                    <select style="width: 98%" id="NhaCungCap">
                        ...
                        <option value="TT78">---Thông tư 78</option>
                        <?php if($loaiphieu==""){ ?>
                            <option value="Einvoice">---Einvoice</option>
                            <option value="Vinvoice">---Vinvoice - VNPT</option>
                ...
                <td><a href="../tmp/maubangke.xlsx"><b>Mẫu bảng kê</b></a></td>
            </tr>
            <tr>
                <td width="150px;">
