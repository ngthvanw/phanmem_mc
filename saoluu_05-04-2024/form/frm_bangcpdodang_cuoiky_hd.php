    ...
    <form method="post" id="Form-chinh" enctype="multipart/form-data">
            ...
            <table border="0" style="width: 100%;">
                <tr>
                    <td colspan="2"><select name="loaisanpham" style="width:100%;height:25px;" id="loaisanpham">
                      <option  value="HD">++++ HƠP ĐỒNG</option>
                  </select></td>
                </tr>
                <tr style="display: none">
        ...
        <fieldset style="background-color: #afd9ee;">
            ...
            <table>
                ...
                <tr>
                    <td><input type="checkbox" name="TuDongNapGia" id="TuDongNapGia"></td>
                    <td>&nbsp;Tự động nạp giá nhập kho</td>
                </tr>
            </table>
        </fieldset>
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
			...
			$TuDongNapGia = $("#TuDongNapGia").prop("checked");
            ...
            if(res){
                $.confirm({
                    ...
                    content: function(){
                        var self = this;
                        return $.ajax({
                            url: $dir_module_dmsanpham + "themthongtin_tonghop_doanhthu_chiphi_congtrinh_hd.php",
                            dataType: 'json',
                            method: 'get',
                            data: {
                                tungay:$tungay,
