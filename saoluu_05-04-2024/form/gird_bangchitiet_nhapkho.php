            ...
            if ($('div').hasClass('jconfirm') == false) {
                ...
                if (event.keyCode == Keys.F10) { // Hủy bỏ hàng đang xóa
                    ...
                    if($res){
                        ...
                        if (sotienchietkhau != null && Number.isInteger(sotienchietkhau)) {
                            $sophieuhientai = $("#sophieu").val().trim(); /// Là số phiếu
                            $.ajax({// Lấy tổng chiết khấu
...
//change edit button to update button and delete to cancel.
        ...
        //---------------------------Cập nhật row-----------------------------------------
        function ThanhTien($SoLuong, $DonGia,$TienChietKhau,$ThanhTienNhap,$thuenk,$thuettdb,$thanhtienpmt,$phivc,$phibx) {
            ...
            $thanhtien = $thanhtienchuathue+$thuenk+$thuettdb+$thanhtienpmt+$phivc+$phibx;
        ...
        function ChietKhau($SoLuong, $DonGia, $PhanTram,$TienChietKhauNhap,$ThanhTienNhap,$thuenk,$thuettdb,$thanhtienpmt,$phivc,$phibx) {
            $thanhtien = ThanhTien($SoLuong, $DonGia,0,$ThanhTienNhap,$thuenk,$thuettdb,$thanhtienpmt,$phivc,$phibx);
        ...
        var objnhapkho = {
            ...
            change: function (evt, ui) {// Khi dữ liệu thay đổi
               ...
               // console.log(rowData);
                ...
                $dongiamt = parseFloat(rowData.dongiamt.toString().toString().split(",").join(""));// Lấy đơn giá nhập vào
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {title: "Mã VT", dataType: "string", dataIndx: "mavt", width: 110, sortable: true,
                    editable: function (ui) {// Hiện số tiền tính toán lên lưới
                        $soluong = ui.rowData.soluongnhap;
                        $edit = false;
                        if($soluong!=0){
                            $edit=true;
                        }
                ...
                {
                    title: "Thuế GTGT", width: 100, dataType: "string", dataIndx: "thue", editable: true, align: "right",
                    editor: {
                        type: "number"
                    },
