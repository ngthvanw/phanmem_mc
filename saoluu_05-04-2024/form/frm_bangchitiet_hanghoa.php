...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                $('.dialog_main_thongbao').load("form/frm_insolieu_bangchitiet_hanghoa.php?tungay=" + $tungay + "&denngay=" + $denngay + "&xemchitiet=" + $xemchitiet+"&mavt=" + $mavt+"&intatcatvattu=" + $InTatCaVatTu+ "&loctheoloaiso=" + $LocTheoLoaiSo);
            }
