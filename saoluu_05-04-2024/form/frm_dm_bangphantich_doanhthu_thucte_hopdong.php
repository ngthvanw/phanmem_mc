    ...
    $(function () {
        ...
        var obj = {
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_dmsanpham + "list_chiphithucte_hopdong.php",//-- Load danh sách lên lưới
...
<div id="dialog-sodu_cpdodang_dk"
     title="BẢNG PHÂN TÍCH DOANH THU - CHI PHÍ - HỢP ĐỒNG... (ENTER : Sửa và Lưu , ESC : Thoát )">
    <!-- dialog -->
