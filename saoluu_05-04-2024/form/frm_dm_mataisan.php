        ...
        //--------------------------------Khai báo lưới---------------------------------------.
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                    ...
                    { title: "Mã TS", dataType: "string", dataIndx: "mats", minWidth: 100,sortable: true,editable: false,
                        validations: [
                            { type: 'minLen', value: 4, msg: "Mã tài sản phải có  4 - 14 ký tự  !" },
                            { type: 'maxLen', value: 14, msg: "Mã tài sản phải có 4 - 14 ký tự !" },
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_mataisan+"list.php",//-- Load danh sách lên lưới
...
<div id="dialog-mataisan" title="Thiết lặp số dư tài sản... (INSERT : Chọn tài sản)"><!-- dialog -->
