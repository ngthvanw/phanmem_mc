...
<div id="dialog-tangtaisan" title="THIẾT LẬP ĐẦU KỲ CHI PHÍ TRẢ TRƯỚC">
    ...
    <form method="post" id="Form-chinh" enctype="multipart/form-data">
        <fieldset style="background-color: #afd9ee">
            <table class="table-dialog" style="vertical-align: middle;width: 100%" border="0">
                <tr>
                    ...
                    <td width="17%" style="padding: 2px"></td>
                    <td width="27%"><span style="padding: 2px">
                      <input type="hidden" name="ngayghiso" value="<?php echo date("Y-m-d") ?>" style="width:97%"
                             id="ngayghiso"
                             required="require"
            ...
            <table class="table-dialog" style="vertical-align: middle;width: 100%" border="0">
                <tr style="display:none;">
                    ...
                    <td style="padding: 2px"><input type="hidden" name="btnnoidung" id="btnnoidung"
                                                    class="button" value="..."/>
                        <input type="text" name="manoidung" value="_ATS01" list="listmanoidung" id="manoidung"
                        ...
                        <input name="noidung" type="text" value="Tăng do mua mới hoặc bổ sung" disabled="disabled"
                               required="required" class="text ui-widget-content ui-corner-all" id="noidung"
        ...
        <fieldset style="background-color: #afd9ee">
            <legend>Chi phí trả trước</legend>

            <table width="100%" border="0">

                <tr>
                    <td width="11%"><label for="name11">Chi phí:</label></td>
                    <td colspan="5"><input name="mataisan" type="text"
                                           class="text ui-widget-content ui-corner-all" disabled="disabled"
                                           id="mataisan" style="width: 20%" value=""/>
                        <input name="tentaisan" type="text"
                               class="text ui-widget-content ui-corner-all" id="tentaisan" style="width: 80%" value=""/>
                    </td>
                    <td width="22%"><span style="padding: 0px">
                    <input type="button" name="btntimtaisan" id="btntimtaisan"
                           class="button" value="Tìm chi phí"/>
                  </span></td>
                </tr>
                <tr>
                    <td><label for="name5">Tài khoản :</label></td>
                    <td width="13%"><input name="matk" type="text"
                                           class="text ui-widget-content ui-corner-all" id="matk" style="width: 70%"
                                           value=""/></td>
                    <td width="13%">&nbsp;</td>
                    <td width="16%"><label for="name17">Nhóm CP:</label></td>
                    <td colspan="3"><span style="padding: 2px">
                               <select style="width: 98%;height:20px;" id="NhomTS"
                                       class="text ui-widget-content ui-corner-all">
                                 <option value="1531">Công cụ, dụng cụ</option>
                                 <option value="1532">Chi phí trả trước</option>
                               </select>
                ...
                <tr>
                    ...
                    <input type="date" readonly name="ngaysudung" value="<?php echo date("Y-m-d") ?>" style="width:97%"
                           id="ngaysudung"
                           required="required"
                           placeholder="Ngày ghi sổ" class="text ui-widget-content ui-corner-all"/>
                  </span></td>
                ...
                <tr>
                    <td><label for="name2"> Giá mua:</label></td>
                    <td colspan="2"><input type="text" name="nguyengia"
                                           onkeyup="return format_munber(this.value,'#nguyengia')" id="nguyengia"
                                           value="" style="width: 100%"
                                           class="text ui-widget-content ui-corner-all"/></td>
                    <td colspan="2" align="right"><label for="name14">Giá trị còn lại :</label></td>
                    <td colspan="2"><input type="text" name="giatriconlai"
                                           onkeyup="return format_munber(this.value,'#giatriconlai')" id="giatriconlai"
                                           value="" style="width: 100%"
                                           class="text ui-widget-content ui-corner-all"/></td>
                </tr>
                <tr>
                    <td><label for="name9">Tháng PB:</label></td>
                    <td colspan="2"><input type="text" name="thoigiansudung" id="thoigiansudung" value=""
                                           style="width: 70%"
                                           class="text ui-widget-content ui-corner-all"/>
                        &nbsp;tháng
                    </td>
                    <td colspan="2" align="right"><label for="name10"> Số tháng PB còn lại:</label></td>
                    <td colspan="2"><input type="text" name="tylekhachhang" id="tylekhachhang" value=""
                                           style="width: 100%"
                                           class="text ui-widget-content ui-corner-all"/></td>
                </tr>
        ...
        <fieldset style="background-color: #afd9ee">
            <legend>Mức phân bổ</legend>
            <table class="table-dialog" style="vertical-align: middle;width: 100%" border="0">
                <tr>
                    <td width="13%"><label for="name"> &nbsp;&nbsp;&nbsp;Tháng :</label></td>
                    <td width="24%"><input name="khauhaothang" type="text"
                                           class="text ui-widget-content ui-corner-all" id="khauhaothang"
                                           style="width: 80%" onkeyup="return format_munber(this.value,'#khauhaothang')"
                                           value="" readonly="readonly"/></td>
                    <td width="7%"><label for="name"> Quý :</label></td>
                    <td width="24%"><input name="khauhaoquy" type="text"
                                           class="text ui-widget-content ui-corner-all" id="khauhaoquy"
                                           style="width: 80%" value="" readonly="readonly"/></td>
                    <td width="9%"><label for="name"> Năm :</label></td>
                    <td width="23%"><input name="khauhaonam" type="text"
                                           class="text ui-widget-content ui-corner-all" id="khauhaonam"
                                           style="width: 80%" value="" readonly="readonly"/></td>
        ...
        <fieldset style="background-color: #afd9ee">
            <legend>Khi trích phân bổ tính vào chi phí, thực hiện định khoản sau</legend>
            <table class="table-dialog" style="vertical-align: middle;width: 100%" border="0">
                <tr>
                    <td><label for="name7"> &nbsp;&nbsp;&nbsp;Tài khoản nợ :</label></td>
                    <td><input name="tkno" type="text"
                               class="text ui-widget-content ui-corner-all" id="tkno" style="width: 50%"
                               list="listtaikhoan" value=""/>
                        <datalist id="listtaikhoan"></datalist>
                    </td>
                    <td><label for="name8"> &nbsp;&nbsp;&nbsp;Tài khoản có :</label></td>
                    <td><input name="tkco" type="text"
                               class="text ui-widget-content ui-corner-all" id="tkco" style="width: 50%"
                               list="listtaikhoan" value=""/></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
        ...
        <fieldset style="background-color: #afd9ee">
            <table class="table-dialog" style="vertical-align: middle;width: 100%" border="0">
                ...
                <tr>
                    <td align="right"><input type="checkbox" name="mangsang" id="mangsang"
                                             style="margin-left:30px;margin-top:3px;"/></td>
...
<script>
    $height = 300;
    $width = 700;
    //$dir_module_danhmuccptratruoc = "modules/mabp/";////////////////Khai báo đường dẫn vào mudole
    ...
    $dir_module_danhmuccptratruoc = "modules/danhmuccptratruoc/";//----------------Lưới
...
/////////////////////////////////////////////Kết thúc Danh sách Autocomplex
        ...
        function checkSoHoaDonTrung() {// Check key khi nhấn submit
            ...
            $.ajax({
                url: $dir_module_danhmuccptratruoc + "kiemtrasohoadon.php",
                data: {
                    'loaiphieu': $LoaiPhieu,
                    sohoadon: $sohoadon,
                    sophieu: $sophieu,
            ...
            if ($data == 0) {
				...
				function checkMaCPTTPhatSinhTonTai() {// Check key khi nhấn submit
            $data = "";
			$ma = $("#mataisan").val().trim();
			$sott = $("#STT").val().trim();
			$loai='0';
            $.ajax({
                url: $dir_module_danhmuccptratruoc + "checkkey_mataisan_pstontai.php",
                data: {'ma': $ma,'loai': $loai,'sott': $sott},
                async: false,
                success: function (response) {
                    $data = (response);
                }
                ...
                if ($sophieu != "") {
                    ...
                    if (answer) {
                        $.ajax({
                            ...
                            data: {sophieu: $sophieu, loaiphieu: "0"},
                            async: false,
                            success: function (response) {
                                $data = (response);
                            }
...
///-------------------Kết thúc--------------------------------
        function layngayghiso($loaiphieu) {
            ...
            $LoaiPhieu = $loaiphieu;
            $.ajax({
                url: $dir_module_danhmuccptratruoc + "layngayghiso.php",
        ...
        $(btnstt).click(function (event) {// Gọi table khách hàng để chọn
            $('.dialog_main_ds_nhapkho').load("form/frm_ds_tanggiam_cptratruoc.php?idstyle=Form-chinh&idinput=STT&idfocus=STT&loaiphieu=0&loai=ccdc");
        });
        ...
        $("#nguyengia").focusout(function () {
            ...
            $tylekh = $("#tylekhachhang").val();
            if ($tylekh == "") {
                $("#tylekh").val($thoigiansudung);
            }
            $khthang = Math.round(parseFloat($nguyengia) / parseFloat($thoigiansudung));
        ...
        function goitablemanoidung($vale) {
            if ($vale == "") {// nếu tk nợ trống thì bật tra bảng
                $('.dialog_main_manoidung').load("form/frm_dm_manoidung_form_select.php?idstyle=Form-chinh&idinput=manoidung***noidung&idfocus=makho&loaiphieu=1&plnoidung=TATS&ma='" + $vale + "'");
            } else {// nếu tk có không trống
                $data = "";
                $.ajax({
        ...
        $("#btntimtaisan").click(function () {
            $('.dialog_main_danhmuc_cptratruoc').load("form/frm_danhsach_macptratruoc_form_select.php?loai=ccdc");
        });
        ...
        function checkMaTaiSan($val) {// Check key khi nhấn enter
            ...
            if ($mataisan == "") {//Nếu số thứ tự null sẽ tạo số mới tự động tăng theo mã
                ...
                $data = "";
                $.ajax({
                    url: $dir_module_danhmuccptratruoc + "laythongtintaisan.php",
                    data: {ma: $mataisan},
                    async: false,
                    success: function (response) {
        ...
        function checkSTT(STT) {// Check key khi nhấn enter
            ...
            if ($STT == "") {//Nếu số thứ tự null sẽ tạo số mới tự động tăng theo mã
                var $data;
                $.ajax({
                    url: $dir_module_danhmuccptratruoc + "taomapsts.php",// Tạo số thứ tự của phiếu
                    async: false,
                    data: {tanggiam: 0},
                    success: function (response) {
                        $data = response;
                ...
                $data = "";
                $.ajax({
                    url: $dir_module_danhmuccptratruoc + "laythongtintaisanps.php",
                    data: {maps: $STT, tanggiam: 0},
                    async: false,
                    success: function (response) {
                        $checkphieuthuchi = $.parseJSON(response);
                    }
        ...
        function laydinhkhoan_chitietpsvt() {
            ...
            $.ajax({// Kiểm tra xem STT có tồn tại hay không
                url: $dir_module_danhmuccptratruoc + "laythongtintabledinhkhoan.php",
        ...
        function ChucNang_nhapkho() {// Xử lý khi nhấp button đồng ý
            ...
            valid = valid && checkNull($("#mataisan"), " Mã chi phí ");
			...
			valid = valid && checkNull($("#ngaysudung"), " Ngày sử dụng ");
			valid = valid && checkMaCPTTPhatSinhTonTai();

            valid = valid && checkChonCapTongHop('matk','matkcha',$('#matk'),'Mã tài khoản ');
            valid = valid && checkChonCapTongHop('matk','matkcha',$('#tkno'),'Mã tài khoản ');
            valid = valid && checkChonCapTongHop('matk','matkcha',$('#tkco'),'Mã tài khoản ');
            
            if($("#chonloaisp").val()==0 && ($("#tkno").val().substring(0,3)==621 || $("#tkno").val().substring(0,3)== 622 || $("#tkno").val().substring(0,3)==623 || $("#tkno").val().substring(0,3)==627)){
            ...
            if (valid) {
                $.ajax({
                    url: $dir_module_danhmuccptratruoc + "addpsts.php", // Bao gồm cả add và edit
