...
<div id="dialog-bangchitiet_socai" title="TÌNH HÌNH THANH TOÁN NGÂN SÁCH NHÀ NƯỚC...">
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                $('.dialog_main_thongbao').load("form/frm_insolieu_tinhhinh_thanhtoan_nsnc.php?tungay=" + $tungay + "&denngay=" + $denngay + "&sapxep=" + $sapxep+"&matk=" + $mavt+"&theobophan=" + $theobophan+"&theonoidung=" + $noidung+"&congdonsocai=" + $congdonsocai);
            }
