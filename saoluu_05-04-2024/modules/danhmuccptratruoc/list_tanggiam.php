...
if ( isset($_GET["pq_filter"]))
{
    ...
    $filterQuery = $dsf->query." and ";
} 

if($loai=='xdcb'){
    $OBJ->set_orderby($filterQuery." tanggiam ='$loaiphieu' and manhomts in (1536)");
}else{
    $OBJ->set_orderby($filterQuery." tanggiam ='$loaiphieu' and manhomts not in (1536)");
}
$OBJ->re_query("update pscptt set manhomts='1536' where SUBSTRING(matk,1,3)='241'");
