...
database::re_query("update bangcdkt set sodudk=".$sodudk110.",soduck=".$soduck110." where maso = '110'");
...
database::re_query("update bangcdkt set sodudk=".$sodudk100.",soduck=".$soduck100." where maso = '100'");
...
database::re_query("update bangcdkt set sodudk=".$sodudk210.",soduck=".$soduck210." where maso = '210'");
database::re_query("update bangcdkt set sodudk=".$sodudk221.",soduck=".$soduck221." where maso = '221'");
database::re_query("update bangcdkt set sodudk=".$sodudk224.",soduck=".$soduck224." where maso = '224'");
database::re_query("update bangcdkt set sodudk=".$sodudk227.",soduck=".$soduck227." where maso = '227'");
database::re_query("update bangcdkt set sodudk=".$sodudk220.",soduck=".$soduck220." where maso = '220'");
database::re_query("update bangcdkt set sodudk=".$sodudk230.",soduck=".$soduck230." where maso = '230'");
database::re_query("update bangcdkt set sodudk=".$sodudk240.",soduck=".$soduck240." where maso = '240'");
database::re_query("update bangcdkt set sodudk=".$sodudk250.",soduck=".$soduck250." where maso = '250'");
database::re_query("update bangcdkt set sodudk=".$sodudk260.",soduck=".$soduck260." where maso = '260'");
database::re_query("update bangcdkt set sodudk=".$sodudk200.",soduck=".$soduck200." where maso = '200'");
database::re_query("update bangcdkt set sodudk=".$sodudk270.",soduck=".$soduck270." where maso = '270'");
...
database::re_query("update bangcdkt set sodudk=".$sodudk310.",soduck=".$soduck310." where maso = '310'");
database::re_query("update bangcdkt set sodudk=".$sodudk330.",soduck=".$soduck330." where maso = '330'");
...
database::re_query("update bangcdkt set sodudk=".$sodudk411.",soduck=".$soduck411." where maso = '411'");
database::re_query("update bangcdkt set sodudk=".$sodudk421.",soduck=".$soduck421." where maso = '421'");
database::re_query("update bangcdkt set sodudk=".$sodudk410.",soduck=".$soduck410." where maso = '410'");
database::re_query("update bangcdkt set sodudk=".$sodudk430.",soduck=".$soduck430." where maso = '430'");
database::re_query("update bangcdkt set sodudk=".$sodudk400.",soduck=".$soduck400." where maso = '400'");
database::re_query("update bangcdkt set sodudk=".$sodudk440.",soduck=".$soduck440." where maso = '440'");
}else{
$OBJCT = new ketoantonghop();
