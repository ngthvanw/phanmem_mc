...
$OBJSDDK->themdstk();
database::re_query(" DELETE FROM sdtkdk WHERE matk not in (select matk FROM matk) ");
database::re_query("UPDATE sdtkdk JOIN matk 
...
database::re_query(" update sdtkdk set soduno=0,soduco=0 WHERE SUBSTRING(matk,1,1)>4");
