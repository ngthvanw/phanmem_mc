...
if($_SESSION['NienDo']>=2021){
    ...
    if($_SESSION['theothongtu']=="tt200"){
        ...
        foreach ($dataBANGPLKQKD as $itemPL) {
            ...
            foreach ($arr_tkco as $itemtkco) {
                if($itemtkco=='511'){
                    $tongco += $dataBTPS['KCDOTT']['sotien']+$dataBTPS['KCDTTP']['sotien']+$dataBTPS['KCDTDV']['sotien']+$dataBTPS['KCDTTG']['sotien']+$dataBTPS['KCDTDS']['sotien']+$dataBTPS['KCDTKH']['sotien'];
                }else if($itemtkco=='515'){
                    $tongco += $dataBTPS['KC5151']['sotien']+$dataBTPS['KC5152']['sotien'];
                }else{
        ...
        database::re_query(" update tokhaitndn set sotien=" . $tongtien6 . " where machitieu='6' and loaitokhai='PLKQKD'");
        database::re_query(" update tokhaitndn set sotien=" . $tongtien12 . " where machitieu='12' and loaitokhai='PLKQKD'");
        database::re_query(" update tokhaitndn set sotien=" . $tongtien18 . " where machitieu='18' and loaitokhai='PLKQKD'");
        database::re_query(" update tokhaitndn set sotien=" . $tongtien21 . " where machitieu='21' and loaitokhai='PLKQKD'");
        database::re_query(" update tokhaitndn set sotien=" . $tongtien22 . " where machitieu='22' and loaitokhai='PLKQKD'");
    }else {
        $tongtien6 = 0;
        $tongtien12 = 0;
        $tongtien18 = 0;
        ...
        foreach ($dataBANGPLKQKD as $itemPL) {
            ...
            foreach ($arr_tkco as $itemtkco) {
                if ($itemtkco == '511') {
                    $tongco += $dataBTPS['KCDOTT']['sotien'] + $dataBTPS['KCDTTP']['sotien'] + $dataBTPS['KCDTDV']['sotien'] + $dataBTPS['KC5118']['sotien'];
                }else if($itemtkco=='515'){
                    $tongco += $dataBTPS['KC5151']['sotien']+$dataBTPS['KC5152']['sotien'];
                } else {
                    $tongco += $dataBANGCDTK[$itemtkco]['tongducops'];
            ...
            foreach ($arr_tkno as $itemtkno) {
                if ($itemtkno == '635') {
                    ...
                    $tongno += $dataBTPS['KCCPBH']['sotien'];
                } else if ($itemtkno == '811') {
                    $tongno += $dataBTPS['KCCPHD']['sotien'];
                } else if ($itemtkno == '6422') {
                    $tongno += $dataBTPS['KCCPKD']['sotien'];
                } else {
                    $tongno += $dataBANGCDTK[$itemtkno]['tongdunops'];
                }
    ...
    if($_SESSION['theothongtu']=="tt200"){
        ...
        database::re_query(" update tokhaitndn set sotien=" . $tongtien3 . " where machitieu='3' and loaitokhai='PLKQKD'");
        database::re_query(" update tokhaitndn set sotien=" . $tongtien9 . " where machitieu='9' and loaitokhai='PLKQKD'");
        database::re_query(" update tokhaitndn set sotien=" . $tongtien15 . " where machitieu='15' and loaitokhai='PLKQKD'");
        database::re_query(" update tokhaitndn set sotien=" . $tongtien18 . " where machitieu='18' and loaitokhai='PLKQKD'");
        database::re_query(" update tokhaitndn set sotien=" . $tongtien19 . " where machitieu='19' and loaitokhai='PLKQKD'");
    }else {
        $tongtien3 = 0;
        $tongtien9 = 0;
        $tongtien15 = 0;
