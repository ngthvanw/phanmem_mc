...
$TenKH = mysql_real_escape_string($ARR_TTHoaDon[1]);
$DiaChi = mysql_real_escape_string($ARR_TTHoaDon[2]);
if($Masothue!=""){
...
$OBJ->re_query("insert into chitiet_psvt (mavt,tenvt,dvt,soluongnhap,donggianhap,thanhtienchuack,thanhtien,thuesuat,thue,sophieu) select mavt,tenvt,dvt,soluong,dongia,thanhtien,thanhtien,thuesuat,tienthue,sophieu from nhaphoadon where sophieu='".$SoPhieu."'");
