...
if ( isset($_GET["pq_filter"]))
{
    ...
    $filterQuery = " and ".khu_dau_vn(str_replace("tenkh","tenkd",$dsf->query));
}
if($_GET['loaiphieu']=="ALL"){
     $OBJ->set_orderby("  1=1 ".$filterQuery);
}else{
    $OBJ->set_orderby(" loaiphieu in(".$_GET['loaiphieu'].") ".$filterQuery);
}

$result = $OBJ->loadListNhatKy();
