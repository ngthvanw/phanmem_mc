...
database::re_query(" insert into bangdoanhthuthucte(mact,gtcongtrinh,tyle,doanhthuthucte) select masp,gthopdong,0,0 from masp where loaisp='HD' and masp not in (select mact from bangdoanhthuthucte) ");
database::re_query(" DELETE FROM bangdoanhthuthucte WHERE mact not in (select masp FROM masp) ");

database::re_query("UPDATE bangdoanhthuthucte JOIN masp 
