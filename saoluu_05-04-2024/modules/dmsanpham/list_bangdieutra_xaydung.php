...
database::re_query(" insert into bangdieutraxaydung_congtrinh(mact,tenct,giatrihopdong,ngaykhoicong,ngayhoanthanh,quy,mactcha) select masp,tensp,gthopdong,ngaykhoicong,ngayhoanthanh,{$quy},maspcha from masp where loaisp='CT' and masp not in (select mact from bangdieutraxaydung_congtrinh where quy='{$quy}') ");

database::re_query(" DELETE FROM bangdieutraxaydung_congtrinh WHERE mact not in (select masp FROM masp) ");

database::re_query("UPDATE bangdieutraxaydung_congtrinh JOIN masp 
