...
database::re_query(" delete from banggiathanhtieuchuan");
database::re_query("insert into banggiathanhtieuchuan(masp,mavt,tenvt,dvt,dinhmuc,dongia,thanhtien,loaivl,thang) VALUES ".substr($val,0,-1));
