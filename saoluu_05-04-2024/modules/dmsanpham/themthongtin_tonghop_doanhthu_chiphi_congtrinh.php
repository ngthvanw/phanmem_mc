...
database::re_query("delete from bangtonghop_danhthu_chiphi_giathanhct where `loaipb`='SP'");
...
$sql_emp_pskt = "delete from pskt where loaiphieu='75'";
database::re_query($sql_emp_pskt);
$sql_emp_chitiet_pskt = "delete from chitiet_pskt where loaiphieu='75'";
...
$res_tongtien_nhapsp = database::re_query($sql_tongtien_nhapsp);
$data_tongtien_nhapsp = database::re_fetch($res_tongtien_nhapsp);
...
{// Lấy danh sách giá trị KC từ 154 sang 155 trong danh sách hợp đồng
    ...
    $result_taikhoanchung_623_627 = database::re_query($sql_taikhoanchung_623_627);
    while ($data_taikhoanchung_623_627 = database::re_fetch($result_taikhoanchung_623_627)) {
