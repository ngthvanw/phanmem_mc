...
database::re_query("CREATE TABLE `tmp_taikhoanchung_623_627_phanbo` ( `sott` INT NOT NULL AUTO_INCREMENT , `matk` CHAR(10) NOT NULL , `sotien` BIGINT NOT NULL , `ghichu` TEXT NOT NULL , PRIMARY KEY (`sott`)) ENGINE = InnoDB;");
database::re_query("CREATE TABLE `tmp_taikhoanchung_623_627` ( `sott` INT NOT NULL AUTO_INCREMENT , `matk` CHAR(10) NOT NULL , `sotien` BIGINT NOT NULL , `ghichu` TEXT NOT NULL , PRIMARY KEY (`sott`)) ENGINE = InnoDB;");
database::re_query("DELETE FROM tmp_taikhoanchung_623_627_phanbo");
database::re_query("INSERT INTO tmp_taikhoanchung_623_627_phanbo(sotien,matk)
...
database::re_query("delete from bangphanbo_chiphi_sxchung where loaipb = 'SP'");
