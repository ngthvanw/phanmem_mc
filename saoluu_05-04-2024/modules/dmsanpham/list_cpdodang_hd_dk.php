...
database::re_query(" insert into cpdodangdk(mact,soduno,soduco) select masp,0,0 from masp where loaisp in('CT','SP','HD') and masp not in (select mact from cpdodangdk ) ");
