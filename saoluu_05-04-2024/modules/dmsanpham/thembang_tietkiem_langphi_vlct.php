...
database::re_query("CREATE TABLE `bangtk_lp_vlct` ( `sott` INT NOT NULL AUTO_INCREMENT ,`mact` CHAR(14) NOT NULL, `mavt` CHAR(14) NOT NULL , `tenvt` VARCHAR(500) NOT NULL , `dvt` VARCHAR(100) NOT NULL , `dongia` DOUBLE NOT NULL , `soluongdutru` DOUBLE NOT NULL , `soluongthucnhap` DOUBLE NOT NULL , `tylephantram` DOUBLE NOT NULL , `sotienchenhlech` BIGINT NOT NULL , `tk_lp` VARCHAR(100) NOT NULL,`thang` INT NOT NULL , PRIMARY KEY (`sott`)) ENGINE = InnoDB;");
database::re_query("ALTER TABLE `bangtk_lp_vlct` ADD `thanhtienthucnhap` BIGINT NOT NULL , ADD `thanhtiendutoan` BIGINT NOT NULL AFTER `thanhtienthucnhap`;");
...
database::re_query("delete from bangtk_lp_vlct");
