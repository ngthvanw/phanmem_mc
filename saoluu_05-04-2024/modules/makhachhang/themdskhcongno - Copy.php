...
database::re_query("TRUNCATE tmp_dskhcn");
...
database::re_query("TRUNCATE cnkh");
echo $sql_ins1 = "insert into cnkh(makh,tenkh,matk,nodk,codk,nops,cops,nock,cock,makhcha,nock_,cock_) VALUE ".substr($value1, 0,-1);
