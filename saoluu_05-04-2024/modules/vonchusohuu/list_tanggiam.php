...
$OBJ->re_query("ALTER TABLE `psvoncsh` ADD `vondieuleusd` DOUBLE NOT NULL;");
$OBJ->re_query("ALTER TABLE `psvoncsh` ADD `vongopusd` DOUBLE NOT NULL;");
$OBJ->re_query("ALTER TABLE `psvoncsh` ADD `vondieuletrongkyusd` DOUBLE NOT NULL;");
$OBJ->re_query("ALTER TABLE `psvoncsh` ADD `vongoptrongkyusd` DOUBLE NOT NULL;");
$OBJ->re_query("ALTER TABLE `psvoncsh` ADD `vonchuagopusd` DOUBLE NOT NULL;");
