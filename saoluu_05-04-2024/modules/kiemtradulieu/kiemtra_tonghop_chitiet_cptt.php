...
$res_nhapkho = $OBJ_KIEMTRADULIEU->re_query("select pskt.mapskt,pskt.tkco,pskt.makh,tenkhachhang,chitiet_pskt.tkno1,chitiet_pskt.gtvnd1,chitiet_pskt.tkno2,chitiet_pskt.gtvnd2,(select nguyengia from pscptt where thamchieu=chitiet_pskt.sophieu) as nguyengia from chitiet_pskt INNER JOIN pskt ON (pskt.sophieu = chitiet_pskt.sophieu) WHERE (SUBSTRING(chitiet_pskt.tkno1,1,3)='242' OR SUBSTRING(chitiet_pskt.tkno2,1,3)='242') and pskt.loaiphieu<=30");
