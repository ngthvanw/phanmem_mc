...
class PDF extends tFPDF
{
    ...
    function TieuDe($Ngay, $TKCo, $SoPhieu, $SoTT,$LoaiPhieu,$TenPhieu,$tk1,$tk2,$data)
    {
        ...
        $this->SetFont('times', '', 10);
        $this->Cell(60, 4, 'Mẫu số : 02-VT', 0, 0, R);
        ...
        $this->Cell(50, 4, 'Định khoản', LTRB, 0, C);
            ...
            $this->Cell(20,5,'Nợ','LR','C',false);
            $this->Cell(30,5,'..........','LR','C',false);
            //$this->Ln();// xu?ng hàng bao nhiêu dong
            $this->Ln();// xu?ng hàng bao nhiêu dong
            $this->SetFont('timesb', '', 10);
            $this->SetFont('timesi', '', 10);
            ...
            $this->SetFont('times', '', 10);
            $this->Cell(25, 5, '', 0, 0, R);
            $this->Cell(20,5,' Có','LTRB','C',false);
            $this->Cell(30,5,'..........','LTRB','C',false);
            //$this->Ln();// xu?ng hàng bao nhiêu dong
        $this->Ln(6);
    ...
    function ImprovedTable($header,$data,$datactphieu)
    {
        ...
        $this->Cell(87, 4, mb_substr($data['tenkh'],0,41), '0', 'L');
        ...
        foreach ($datactphieu as $tiemCT) {
            if($tiemCT['tenvt']!=""){
                ...
                $this->Ln(0);
                $tonghang+=$tiemCT['thanhtien'];
                $tongthue+=$tiemCT['thue'];
        ...
        $this->Cell($w[2],5,"Tổng cộng",'LTRB',0,'R');// LTRB là border c?a cell
        ...
        $this->Cell($w[9],5,number_format($tonghang,0,',','.'),'LTRB',0,'R');

        $this->Ln(7);
        $tongcong = convert_number_to_words(str_replace(",", "", round($tonghang)));
        $this->SetFont('times', '', 10);
        ...
        $this->Cell(46, 3, $_SESSION['txtnguoilapphieu'], 0, 0, C);
        $this->Cell(46, 3, '', 0, 0, C);
        $this->Cell(46, 3, '', 0, 0, C);
        $this->Cell(46, 3, $_SESSION['txtketoantruong'], 0, 0, C);
