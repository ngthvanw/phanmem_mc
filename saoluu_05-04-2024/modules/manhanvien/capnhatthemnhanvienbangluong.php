<?php
include("../../config.php");
database::re_query("insert into bangluongnhanvien(manv,tennv,chucvu,trinhdo,luongcb,phucapchucvu,baohiem,socmnd,tienangiuaca,phucapkhongdungbhxh,thuethunhap,matk1,phantramtk,matk2,loaibp,sapxep) 
