...
foreach ($mangsotien as $itemSoTien){
    ...
    database::re_query(" update luuchuyentiente set sodudk=".$itemSoTien['sodudk'].",soduck=".$itemSoTien['soduck'].",tkno = '".$itemSoTien['tkno']."',tkco = '".$itemSoTien['tkco']."'  where maso='".$itemSoTien['maso']."'");
}
//echo $sodudk1;
...
database::re_query(" update luuchuyentiente set sodudk=".$sodudk20.",soduck=".$soduck20." where maso='20'");
database::re_query(" update luuchuyentiente set sodudk=".$sodudk30.",soduck=".$soduck30." where maso='30'");
database::re_query(" update luuchuyentiente set sodudk=".$sodudk40.",soduck=".$soduck40." where maso='40'");
database::re_query(" update luuchuyentiente set sodudk=".$sodudk50.",soduck=".$soduck50." where maso='50'");
database::re_query(" update luuchuyentiente set sodudk=".$sodudk70.",soduck=".$soduck70." where maso='70'");
?>