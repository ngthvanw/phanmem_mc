...
$filterParam = array();
$OBJ->re_query(" CREATE TABLE doichieu_xoahoadon ( `sott` INT NOT NULL AUTO_INCREMENT , `loaphieu` INT NOT NULL , `mauso` VARCHAR(20) NOT NULL , `kyhieu` VARCHAR(10) NOT NULL , `quy` CHAR(3) NOT NULL , `hoadon` CHAR(7) NOT NULL , `hople` INT NOT NULL , `liendo` INT NOT NULL , `thaythe` CHAR(7) NOT NULL , `ghichu` TEXT NOT NULL , PRIMARY KEY (`sott`)) ENGINE = InnoDB; ");
...
$result = $OBJ->loadDanhSach_DoiSoat_HoaDon_xoa_trongky($Quy);
//debug($result);
