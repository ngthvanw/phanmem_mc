...
include("../../config.php");
$OBJ = new makhachhang();
$res = $OBJ->re_query("select count(trangthai) as tong,trangthai from phpmyadmin.danhsach_congty_trinhky_{$noiluu_phanmem} where niendo = '".$_SESSION['NienDo']."' group by trangthai");
