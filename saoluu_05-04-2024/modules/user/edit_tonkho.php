...
$_soluongtonckduyet = $_GET['_soluongtonckduyet'];
$_thanhtientonckduyet = $_GET['_thanhtientonckduyet'];
...
mysqli_query($cnn,"update duyettonkho set _soluongtonckduyet='{$_soluongtonckduyet}',
                                        _thanhtientonckduyet='{$_thanhtientonckduyet}',
