<?php 
    require("../../config.php");
    $MaNhanVien_enc = $_GET['MaNhanVien'];
    $MaNhanVien_str = str_replace("%0AANDOR","#",base64_decode($_GET['MaNhanVien']));
    $MaNhanVien_arr = explode("#",$MaNhanVien_str);
    $count = count($MaNhanVien_arr);
    $count=$count-1;    
?>
  <script>
