...
if ( isset($_GET["pq_filter"]))
{
    ...
    $filterQuery = $filterQuery."and matk>=".$MaTKTu." and matk<=".$MaTKDen;
}else{
    $filterQuery=" matk>=".$MaTKTu." and matk<=".$MaTKDen;
} 
$OBJ->set_orderby($filterQuery);  
$OBJ->set_Cb_LoaiTK($cb_LoaiTK1);  
$result = $OBJ->loadListHTTK_To_From();
