    ...
    public function load_danhsach_congtrinh_dodang_chuaphancap_cocpsxpb($ListCT, $dodangdauky, $arrayNL, $arrayNC, $arrayMay, $arrayCPSXC, $dataDoanhThuThuan, $TongDoanhThuThuan, $TongCPSXCTong, $dataGiaThanh, $dataCPSXCPB, $dataGiaThanhTieuChuan, $HeSoTungSanPham, $DataNCTieuChuan, $TongNCThucTe, $dataSoLuongXuatkhoThanhPham, $DataNVLTieuChuan, $DataCPSXCTieuChuan, $DataMayTieuChuan, $dataSoLuongDuTruSanPham, $sophieu, $tutaobuttoan, $dataNCPB, $masp, $dataNC622PB, $dataTong154, $dataPhanBoPhanXuong,$dataMay_CTTheoTK,$dataCPSXC_CTTheoTK,$dataNC622PBSP,$dataTongCTKhoan,$denngay)// khong sử dụng cho sổ cái
    {
        ...
        foreach ($ListCT as $KMaCT => $iTiem) {
            ...
            if ($iTiem['loaisp'] == "SP") {
                ...
                $value_pskt .= "('" . $sophieu . "','1','" . $denngay . "','154','79','" . abs($sotiennltieuchuan + $sotiennctieuchuan) . "'),('" . ($sophieu + 1) . "','1','" . $denngay . "','154','79','" . abs($TienCPSXRiengTieuChuan623+$TienCPSXChungTieuChuan623 + $TienCPSXRiengTieuChuan+$TienCPSXChungTieuChuan) . "'),";
                $value_chitiet_pskt .= "('" . 1 . "','" . $denngay . "','" . abs($sotiennltieuchuan) . "','" . abs($sotiennctieuchuan) . "','{$KMaCT}','{$KMaCT}','{$iTiem['loaisp']}','100093','Kết chuyển CP nguyên vật liệu tiêu chuẩn - SP:{$KMaCT} ','100093','Kết chuyển CP nhân công tiêu chuẩn - SP:{$KMaCT} ','621','622','" . abs($sotiennltieuchuan + $sotiennctieuchuan) . "','4','79','" . $sophieu . "'),('" . 1 . "','" . $denngay . "','" . abs($TienCPSXRiengTieuChuan623+$TienCPSXChungTieuChuan623) . "','" . abs($TienCPSXRiengTieuChuan+$TienCPSXChungTieuChuan) . "','{$KMaCT}','{$KMaCT}','{$iTiem['loaisp']}','100093','Kết chuyển CP máy tiêu chuẩn - SP:{$KMaCT} ','100093','Kết chuyển CP sản xuất chung tiêu chuẩn - SP:{$KMaCT} ','623','627','" . abs($TienCPSXRiengTieuChuan623 + $TienCPSXRiengTieuChuan+$TienCPSXChungTieuChuan) . "','4','79','" . ($sophieu + 1) . "'),";
                $sophieu += 2;
                ...
                foreach ($dataCPSXC_CTTheoTK[$KMaCT] as $key_matk=> $ItemCPSXC_CTTheoTK){
                    $sophieu++;
                    $value_pskt .= "('" . ($sophieu) . "','1','" . $denngay . "','154','79','" . abs($ItemCPSXC_CTTheoTK['tienno']) . "'),";
                    $value_chitiet_pskt .= "('" . 1 . "','" . $denngay . "','" . abs(0) . "','" . abs($ItemCPSXC_CTTheoTK['tienno']) . "','{$KMaCT}','{$KMaCT}','{$iTiem['loaisp']}','100093','Kết chuyển CP máy - CT:{$KMaCT}','100093','Kết chuyển CP sản xuất chung - CT:{$KMaCT} ','','".$key_matk."','" . abs($ItemCPSXC_CTTheoTK['tienno']) . "','4','79','" . ($sophieu) . "'),";
                }                $sophieu += 2;
