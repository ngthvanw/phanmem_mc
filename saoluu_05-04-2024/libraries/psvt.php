...
class psvt extends database
{
    public $tringorder;
    public $table = "psvt";
    public $table_chitietpskt = "chitiet_psvt";
    ...
    {
        $sql = "select max(mapskt) as mapskt from " . $this->table . "";
        $this->query($sql);
        $data = $this->fetch();
        if ($data['mapskt'] != "") {
    ...
    function loadListPSKT()
    {
        ...
        if ($fill != "")
            $sql_w = " and " . $this->get_orderby();
       $sql = "SELECT psvt.*,tenkh,diachi,masothue,mand.tennoidung,mand.tkco as tkco_mand from psvt inner join makh on(psvt.makh = makh.makh) inner join mand on(mand.mand=psvt.mand) WHERE 0=0 and lp=1 $sql_w  order by sott DESC ";
        $this->query($sql);
        $i = 0;
        while ($data = $this->fetch()) {
    ...
    function loadListChiTietPSKT()
    {
        ...
        if ($fill != "")
            $sql_w = " and " . $this->get_orderby();
        $sql = "SELECT chitiet_pskt.*,tennoidung,mand.tkno as tkno_mand from chitiet_pskt INNER JOIN mand on (chitiet_pskt.mand = mand.mand) WHERE 0=0 $sql_w  order by sott ";
        $this->query($sql);
        $i = 0;
        while ($data = $this->fetch()) {
    ...
    {
       $sql = "INSERT INTO " . $this->table . "(sott,mapskt,mauso,seri,sct,`date`,datehd,datett,tenvt,quycach,noidung,dvt,dvtp,kl,kt,sl,dgvnd,gtvnd,stvnd,prepaid,debt,matk,tkno,tkco,mand,makh,makhno,makhco,`comment`,lp,rate,rate1,vat,ttdb,sogiay,ref,other,address,loaict,maloai,clink,chuthich,tctm)
                 VALUES(" . $this->get_SoTT() . ",'" . $this->getMaPSKT() . "','" . $this->getMauSo() . "','" . $this->getSeri() . "','" . $this->getSCT() . "','" . $this->getNgay() . "','" . $this->getNgayHD() . "','" . $this->getNgayTT() . "','" . $this->get_TenVT() . "','" . $this->get_QuyCach() . "','" . $this->getNoiDung() . "','" . $this->get_DVT() . "','" . $this->get_DVTP() . "','" . $this->get_KL() . "','" . $this->get_KT() . "','" . $this->getSL() . "','" . $this->getDgVND() . "','" . $this->getGTVND() . "','" . $this->getSTVND() . "','" . $this->getPrepaid() . "','" . $this->getDebt() . "','" . $this->get_MaTK() . "','" . $this->getMaTKNo() . "','" . $this->getMaTKCo() . "','" . $this->getMaND() . "','" . $this->getMaKH() . "','" . $this->getMaKHNo() . "','" . $this->getMaKHCo() . "','" . $this->getComment() . "','" . $this->getLP() . "','" . $this->getRate() . "','" . $this->getRate1() . "','" . $this->getVAT() . "','" . $this->getTTDB() . "','" . $this->getSoGiay() . "','" . $this->getREF() . "','" . $this->getOther() . "','" . $this->getAddress . "','" . $this->getLoaiCT() . "','" . $this->getMaLoai() . "','" . $this->getCLink() . "','" . $this->get_ChuThich() . "','" . $this->getTCTM() . "');";
    ...
    {
        $sql = "INSERT INTO " . $this->table_chitietpskt . " (sott,mapskt,mauso,seri,sct,`date`,datehd,datett,tenvt,quycach,diachi,dvt,dvtp,kl,kt,sl,dgvnd,gtvnd,stvnd,prepaid,debt,matk,tkno,tkco,mand,makh,makhno,makhco,masothue,`comment`,lp,rate,rate1,vat,ttdb,sogiay,ref,other,tenkh,address,loaict,maloai,clink,chuthich,tctm,mand2,gtvnd2)
                 VALUES(" . $this->get_SoTT() . ",'" . $this->getMaPSKT() . "','" . $this->getMauSo() . "','" . $this->getSeri() . "','" . $this->getSCT() . "','" . $this->getNgay() . "','" . $this->getNgayHD() . "','" . $this->getNgayTT() . "','" . $this->get_TenVT() . "','" . $this->get_QuyCach() . "','" . $this->getDiaChi() . "','" . $this->get_DVT() . "','" . $this->get_DVTP() . "','" . $this->get_KL() . "','" . $this->get_KT() . "','" . $this->getSL() . "','" . $this->getDgVND() . "','" . $this->getGTVND() . "','" . $this->getSTVND() . "','" . $this->getPrepaid() . "','" . $this->getDebt() . "','" . $this->get_MaTK() . "','" . $this->getMaTKNo() . "','" . $this->getMaTKCo() . "','" . $this->getMaND() . "','" . $this->getMaKH() . "','" . $this->getMaKHNo() . "','" . $this->getMaKHCo() . "','" . $this->getMaSoThue() . "','" . $this->getComment() . "','" . $this->getLP() . "','" . $this->getRate() . "','" . $this->getRate1() . "','" . $this->getVAT() . "','" . $this->getTTDB() . "','" . $this->getSoGiay() . "','" . $this->getREF() . "','" . $this->getOther() . "','" . $this->getTenKH() . "','" . $this->getAddress . "','" . $this->getLoaiCT() . "','" . $this->getMaLoai() . "','" . $this->getCLink() . "','" . $this->get_ChuThich() . "','" . $this->getTCTM() . "','" . $this->getMaND2() . "','" . $this->getGTVND2() . "');";
