...
$cb_ThueSuat = array(
    ...
    array("5" => "5%"),
    array("0" => "0%"),
    array("k" => "KHÔNG CHỊU THUẾ"),
    array("kk" => "KHÔNG KÊ KHAI, TÍNH NỘP THUẾ GTGT")
...
$ThueSuat_BangKe= array(2=>"k",3=>"5", 4=>"10", 5=>"kk",6=>"0");
$ThueSuat_BangKe_MuaVao = array(2 => 0, 3 => 5, 4 => 10, 6 => "k", 8 => 8);// Mua vào không cần thể hiện hàng hoá không kê khai mã là kk
$ThueSuat_BangKe_BanRa =  array(2 => 0, 3 => 5, 4 => 10, 5 => "kk", 6 => "k", 8 => 8);// Bán ra kê khai tất cà bao gòm hàng hoá không kê khai mã kk
...
$String_tkno_KH = "131,331,3388,3387,1386,1388,141,244,344,335,3386,34111,34112,3412,1361,1368,3368,3361,3368";
...
function convert_number_to_words( $number )
{
    ...
    switch (true)
    {
        ...
        default:
            ...
            $remainder = bcmod( $number,  $baseUnit);
