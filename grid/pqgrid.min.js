...
(function($) {
	...
	fnPG.options = {
		...
		totalRecords: 0,
		msg: "",
		rPPOptions: [10, 20, 30, 40, 50, 100,200,500,1000],
		rPP: 20
	};
	fnPG._regional = {
...
(function($) {
					...
					$cell.tooltip({
						...
						open: function(evt, ui) {
							...
							if (style) {
								...
								//ui.tooltip.attr("style", olds + ";" + style).css("zIndex", $cell.zIndex() + 5)// Mặc định
	...
	fn._generateCellRowOutline = function() {
		...
		if (this.$div_focus) {
			...
			//this.$div_focus.css("zIndex", $parent.zIndex() + 5) // Mặc định là mở nhưng bị lỗi 
			...
			if (evt.keyCode == EM.saveKey) {
				...
				if (EM.onSave == "next") {
					obj = {
						rowIndxPage: rowIndxPage,
						colIndx: colIndx,
						edit: false // Mặc định là incr: false
					}
				} else {
					obj = {
						rowIndxPage: rowIndxPage,
...
(function($) {
	...
	fn._create = function() {
		...
		$ele.on("pqtooltipopen" + eventNamespace, function(evt, ui) {
			...
			//ui.tooltip.css("zIndex", $td.zIndex() + 5); // Mặc định
