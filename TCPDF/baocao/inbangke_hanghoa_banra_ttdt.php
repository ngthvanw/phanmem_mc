...
foreach ($DATACIBANRACHUADC as $thuesuat=>$ItemData){
        foreach ($ItemData as $itemDuLieu) {
			   $tructieptrendoanhthu = $itemDuLieu['loaihanghoadichvu'];
                $DATACIBANRA[$tructieptrendoanhthu][] = $itemDuLieu;
        }
}
...
$ThuePPTT = array(
    '5'=>"1. Doanh thu hàng hoá, dịch vụ chịu thuê xuất 0% và không chịu thuế",
    '1'=>"2. Phân phối, cung cấp hàng hoá",
    '6'=>"3. Phân phối, cung cấp hàng hoá không chịu thuế GTGT",
    '2'=>"4. Dịch vụ, xây dựng không bao thầu nguyên vật liệu",
    '7'=>"5. Dịch vụ, xây dựng không bao thầu nguyên vật liệu không chịu thuế GTGT",
    '3'=>"6. Sản xuất, vận tải, dịch vụ có gắn với hàng hoá, xây dựng có bao thầu nguyên vật liệu",
    '8'=>"7. Sản xuất, vận tải, dịch vụ có gắn với hàng hoá, xây dựng có bao thầu nguyên vật liệu không chịu thuế GTGT",
    '4'=>"8. Hoạt động kinh doanh khác"
);
?>
<html>
...
<table border="0" align="center">
  ...
  <tr>
    <td colspan="10"><b>(Kèm theo tờ khai thuế GTGT mẫu số 04/GTGT ngày ' . $ngaylap . ')</b></td>
  </tr>
  <tr>
...
<table border="1" class="display dataTable" width="100%" border="0" cellspacing="1" cellpadding="1">
    ...
    foreach ($DATACIBANRA as $k=>$itemTS) {
        $html_ct ='<tr><td class="td_full" colspan="10" style="text-align: left;"><i><b>'.$ThuePPTT[$k].'</b></i></td></tr>';
