...
$DATACIBANRA = $_SESSION["LISTCTBLCTT"];
...
$html_title='
  <tr>
    <td STYLE="border:0.2px solid #000;" width="270px"><b>CHỈ TIÊU</b></td>
    <td STYLE="border:0.2px solid #000;" width="40px" ><b>Mã số</b></td>
    <td STYLE="border:0.2px solid #000;" width="40px"><b>Thiết minh</b></td>
  ...
  <tr>
    <td STYLE="border:0.2px solid #000;" width="270px">1</td>
    <td STYLE="border:0.2px solid #000;" width="40px" >2</td>
    <td STYLE="border:0.2px solid #000;" width="40px">3</td>
...
$html_title1='
  <tr>
    <td STYLE="border:0.2px solid #000;" width="270px"><b>NGUỒN VỐN</b></td>
    <td STYLE="border:0.2px solid #000;" width="40px" ></td>
    <td STYLE="border:0.2px solid #000;" width="40px"></td>
...
<table width="100%" border="0" style="border-bottom: 1px solid #000">
  <tr>
   ...
   <tr>
   <td align="center"><i>Mẫu số B03-DNN<br/>
...
<table border="0" align="center">
  <tr>
    <td><b>'.$_SESSION["THONGTINPHIEULCTT"]['tenphieu'].'</b></td>
  </tr>
  <tr>
    <td><b style="font-size: 8">(Theo phương pháp trực tiếp)</b></td>
  </tr>
   <tr>
    <td><b>'.$_SESSION["THONGTINPHIEULCTT"]['ngayhoadon'].'</b></td>
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="2">
  ...
  <td align="center" width="35%">&nbsp;<br/>Người lập biểu</td>
    ...
    <em>'.$ThanhPho.' Ngày ';
$time = strtotime($_SESSION["THONGTINPHIEULCTT"]['ngaylap']);
...
$pdf->Output('bang_luu_chuyen_tien_te_pptt.pdf', 'I');
