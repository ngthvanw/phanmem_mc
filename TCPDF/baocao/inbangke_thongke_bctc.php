...
?>
<html>
    <head><title>BẢNG THỐNG KÊ TRÌNH KÝ BCTC (Nhấn CTRL + P để in , ALT + F4 để thoát)</title>
...
<thead>
  <tr>
    ...
    <th STYLE="border:0.5px solid #000;"  rowspan="2" >Trạng thái</th>
  </tr>
   </thead>
  ';
$sott = 0;
...
foreach ($DATA as $itemCT) {
    ...
    $html_ct .= '
        ...
        <td class="td_center" width="120px" >' . $itemCT["ngayduyet"] . '</td>
        <td align="center" class="td_end" width="50px" >';
         if($itemCT["truongnhomduyet"]!=""){
             $html_ct .= 'Trình Ký';
         }else{
             $html_ct .= '';
         }
...
<table align="center"  border="0" width="100%">
  <tr>
    <td align="center" ><b>DANH SÁCH TRÌNH DUYỆT BCTC</b></td>
  </tr>
  <tr>
    <td align="center" ><b>Năm: ' . $kykhaithue . '</b></td>
  </tr>
</table>
