...
<table width="100%" border="0">
  <tr>
   ...
   <tr>
   <td style="font-size: 8px" align="center"><i>Mẫu số 03-1A/TNDN<br/>
        (Ban hành ';
...
<table style="font-size: 9px;" border="0" align="center">
  <tr>
    <td><b>PHỤ LỤC</b><BR/><b>'.$_SESSION["THONGTINPHIEU"]['tenphieu'].'</b></td>
  </tr>
  <tr>
    <td>
        <table width="100%" cellpadding="2">
        <tr><td style="font-size:9px;">
                <b>Dành cho người nộp thuế thuộc các ngành sản xuất, thương mại, dịch vụ</b><br/><i>(kèm theo tờ khai quyết toán thuế thu nhập doanh nghiệp số 03/TNDN)</i>
            </td></tr>
            <tr><td>
                <b>Kỳ tính thuế: '.$_SESSION["THONGTINPHIEU"]['ngayhoadon'].'</b>
            </td></tr>
