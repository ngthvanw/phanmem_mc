...
<table class="display dataTable" width="100%" border="0" cellspacing="1" cellpadding="1">
    ...
    foreach ($DATACIBANRA as $k=>$itemTS) {
        ...
        <td width="60px" class="td_center" >'.date("d-m-Y",strtotime($itemCT["ngayhoadon"])).'</td>
        <td width="280px" class="td_center" align="left">' . $itemCT["tenkh"] . '</td>
...
$html_sum='<table width="700" class="page_break" border="0">
  ...
  <tr>
    ...
    <td align="right"><b>'.number_format($tongdoanhthucothue,0,",",".").'</b></td>
  </tr>
  <tr>
