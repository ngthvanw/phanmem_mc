...
<table border="1" class="display dataTable" width="100%" cellspacing="1" cellpadding="1">
    ...
    <tr>
        ...
        <th STYLE="border:0.5px solid #000;" rowspan="2" width="120px">Giá trị HHDV mua vào chưa có thuế</th>
        <th width="27px" STYLE="border:0.5px solid #000;" rowspan="2">Thuế suất %</th>
        <th STYLE="border:0.5px solid #000;" width="90px" rowspan="2">Thuế giá trị gia tăng</th>
    ...
    foreach ($DATACIBANRA as $k => $itemTS) {
		...
		$ThueSuatTam = round(($itemCT["thue"]/$itemCT["thanhtien"])*100);
    ...
    ';
        ...
        <td class="td_full" align="right" style="text-align: right" ><b><i>' . number_format($tongtienloaihanghoa, 0, ",", ".") . '</i></b></td>
        <td class="td_full" align="center" ></td>
