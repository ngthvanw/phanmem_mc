...
$DATADSKHAUHAOTS_CUOITHANG = $_SESSION['DSKHAUHAOTAISAN_CUOITHANG'];
$denthang = $_GET['denthang'];
?>
<html>
<head><title>Bảng phân bổ chi phí (Nhấn CTRL + P để in , ALT + F4 để thoát)</title>
...
foreach ($DATADSKHAUHAOTS as $itemCT) {
    ...
    if ($itemCT["theodoi"] != 0) {
        ...
        <td STYLE="border-left:0.5px solid #000;border-right:0.5px solid #000;border-top:0.5px dashed #000;border-bottom:0px dashed #fff;' . $indam . '" align="center">' . $DATADSKHAUHAOTS_CUOITHANG[$itemCT["mats"]]['tkno'] . '</td>
        <td STYLE="border-left:0.5px solid #000;border-right:0.5px solid #000;border-top:0.5px dashed #000;border-bottom:0px dashed #fff;' . $indam . '" align="center">' . $DATADSKHAUHAOTS_CUOITHANG[$itemCT["mats"]]['tkco'] . '</td>
...
echo $html;
?>
<table style="margin-top: 50px;margin-bottom: 50px; border-bottom: 1px solid black;" width="100%" class="no-print">
    <tr>
        <td></td>
    </tr>
</table>
