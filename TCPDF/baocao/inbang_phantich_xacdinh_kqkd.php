...
$DATACIBANRA = $_SESSION["LISTCTBANGKQKD"];
...
$html_title='
  <tr>
    <td STYLE="border:0.2px solid #000;" width="150px" rowspan="2"><b>CHỈ TIÊU</b></td>
    <td STYLE="border:0.2px solid #000;" width="30px" rowspan="2"><b>Mã số</b></td>
    <td STYLE="border:0.2px solid #000;" width="30px" rowspan="2"><b>TM</b></td>
    <td STYLE="border:0.2px solid #000;" width="100px" rowspan="2"><b>Số cuối năm</b></td>
    <td STYLE="border:0.2px solid #000;" width="100px" rowspan="2"><b>Số đầu năm</b></td>
    <td STYLE="border:0.2px solid #000;" width="150px"><b>So sánh</b></td>
  </tr>
   <tr>
    <td STYLE="border:0.2px solid #000;" width="50px"><b>%</b></td>
    <td STYLE="border:0.2px solid #000;" width="100px"><b>Số tiền</b></td>
  </tr>
  <tr>
    <td STYLE="border:0.2px solid #000;" width="150px">1</td>
    <td STYLE="border:0.2px solid #000;" width="30px" >2</td>
    <td STYLE="border:0.2px solid #000;" width="30px">3</td>
    <td STYLE="border:0.2px solid #000;" width="100px" >4</td>
    <td STYLE="border:0.2px solid #000;" width="100px">5</td>
    <td STYLE="border:0.2px solid #000;" width="50px">(6=5/4)</td>
    <td STYLE="border:0.2px solid #000;" width="100px">(7=5-4)</td>
  </tr>
  ';
$sott=0;
$tongcuoi=0;
...
$tongdau1=0;
    foreach ($DATACIBANRA as $itemCT) {
...

        {
            ...
            $ChenhLech = $itemCT["namnay"]-$itemCT["namtruoc"];
			$PhanTram = (($ChenhLech*100)/$itemCT["namnay"]);
            $html_ct .= '
        <tr >
        <td STYLE="border-top:0.2px solid #FFF;border-right:0.2px solid #000;border-left:0.2px solid #000;border-bottom:0.2px dashed  #000;'.$indam.'" align="left">' . ($itemCT["chitieu"]) . '</td>
        ...
        <td  STYLE="border-top:0.2px solid #FFF;border-right:0.2px solid #000;border-left:0.2px solid #000;border-bottom:0.2px dashed  #000;'.$indam.'" align="right">';
                $html_ct .= (number_format($itemCT["namnay"] != 0) ? "".number_format($itemCT["namnay"], 0, ",", ".")."" : "");
            $html_ct .= '</td>
        <td align="right" STYLE="border-top:0.2px solid #FFF;border-right:0.2px solid #000;border-left:0.2px solid #000;border-bottom:0.2px dashed  #000;'.$indam.'" align="right">';
                $html_ct .= (number_format($itemCT["namtruoc"] != 0) ? "".number_format($itemCT["namtruoc"], 0, ",", ".")."" : "");
            $html_ct .= '</td>
        <td align="right" STYLE="border-top:0.2px solid #FFF;border-right:0.2px solid #000;border-left:0.2px solid #000;border-bottom:0.2px dashed  #000;'.$indam.'" align="right">';
                $html_ct .= (number_format($PhanTram != 0) ? "".number_format($PhanTram, 2, ",", ".")."%" : "");
            $html_ct .= ' </td>
        <td align="right" STYLE="border-top:0.2px solid #FFF;border-right:0.2px solid #000;border-left:0.2px solid #000;border-bottom:0.2px dashed  #000;'.$indam.'" align="right">';
...
<table width="100%" border="0" style="border-bottom: 1px solid #000">
  <tr>
   ...
   <tr>
   <td align="center"><i>Mẫu số B02-DNN<br/>
