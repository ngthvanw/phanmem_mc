...
更改密码"); ?></a></li>
                            ...
                            <?php if($_SESSION['Level']!=5 && $_SESSION['Level']!=6 ){ ?>
                                <li style="background: url('icon/5.gif') no-repeat left center;<?php echo $HienThi; ?>"><a href="saoluu" target="_blank"><?php echo HienNgonNgu($_SESSION['NGONNGU'],"Sao lưu & phục hồi dữ liệu","Backup & restore data","备份和恢复数据"); ?></a></li>
...
更新数据"); ?></a>
                    ...
                    <li style="background: url('icon/nokh.gif') no-repeat left center;<?php echo $HienThi; ?>"><!-- Menu Đối tác -->
                        ...
                        <?php if($_SESSION['Level']!=5 && $_SESSION['Level']!=6 ){ ?>
                            <ul>
                                <li style="background: url('icon/1.gif') no-repeat left center;"><a href="#" onclick="$('.dialog_main_dinhmuc_sanpham').load('form/frm_bangthanhtoan_khonghoadon.php');"><?php echo HienNgonNgu($_SESSION['NGONNGU'],"Bảng kê mua, hàng hóa dịch vụ mua vào không có hóa đơn","Purchase list without invoice","无发票采购清单"); ?></a></li>
                            </ul>
                        <?php } ?>
                    </li><!--End Menu Đối tác -->
                    ...
                    <li style="background: url('icon/thue.gif') no-repeat left center;<?php echo $HienThi; ?>"><!-- Menu Báo cáo thuế-->
                        ...
                        <?php if($_SESSION['Level']!=5 && $_SESSION['Level']!=6 ){ ?>
                            <ul>
                                <li style="background: url('icon/1.gif') no-repeat left center;"><a href="#"><?php echo HienNgonNgu($_SESSION['NGONNGU'],"Tờ khai thuế","Value-added tax return","增值税申报表"); ?></a>
                                    <ul>    
                                        ...
                                        <li onclick='window.open("TCPDF/baocao/hkd_01-2BK-HDKD.php","hkd_01-2BK-HDKD","height="+(getHeight()-80)+",width="+getWidth());' style="background: url('icon/2.gif') no-repeat left center;"><a href="#">Bảng kê 01-2/BK-HĐKD</a></li>
                                        <li onclick="$('.dialog_main_hinhthuc_khaibaothue').load('form/frm_hinhthuc_khaibaothue.php');" style="background: url('icon/3.gif') no-repeat left center;"><a href="#"><?php echo HienNgonNgu($_SESSION['NGONNGU'],"Thiết lập kỳ khai thuế","Set up tax return","设置纳税申报表"); ?></a></li>
                                        <li  onclick="$('.dialog_main_bangke_hanghoa_muavao').load('form/frm_bangke_hanghoa_muavao.php');" style="background: url('icon/4.gif') no-repeat left center;"><a href="#"><?php echo HienNgonNgu($_SESSION['NGONNGU'],"Bảng kê HH, DV mua vào","List of goods and services purchased","购买的商品和服务清单"); ?></a></li>
                                        <li onclick="$('.dialog_main_bangke_hanghoa_banra').load('form/frm_bangke_hanghoa_banra.php');" style="background: url('icon/5.gif') no-repeat left center;"><a href="#"><?php echo HienNgonNgu($_SESSION['NGONNGU'],"Bảng kê HH, DV bán ra","List of goods and services sold","已售商品和服务清单"); ?></a></li>
                                    </ul>
                                    <li style="background: url('icon/2.gif') no-repeat left center;"><a href="#"><?php echo HienNgonNgu($_SESSION['NGONNGU'],"Báo cáo","Value-added tax return","增值税申报表"); ?></a>
                                    <ul>
                                        <li onclick='window.open("TCPDF/baocao/hkd_s1_hkd.php","hkd_s1_hkd","height="+(getHeight()-80)+",width="+getWidth());' style="background: url('icon/1.gif') no-repeat left center;"><a href="#">Sổ chi tiết doanh thu bán hàng hóa, dịch vụ (S1-HKD)</a></li>
                                    </ul>
                                    </li>
                                </li>
                            </ul>
