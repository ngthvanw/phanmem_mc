...
(function($) {
	...
	fnPG.options = {
		...
		totalRecords: 0,
		msg: "",
		rPPOptions: [10, 20, 30, 40, 50, 100,150,200,10000],
		rPP: 20
	};
	fnPG._regional = {
...
(function($) {
	...
	fn.options = {
		...
		pageModel: {
			...
			totalPages: 0,
			rPP: 10,
			rPPOptions: [100,150,200,500,1000,10000]
		},
		resizable: false,
		roundCorners: true,
		rowBorders: true,
				...
				if (edtype == "textarea" || edtype == "select" || edtype == "textbox" || edtype == "date" ||  edtype == "number") {
					if (edtype == "textarea") {
						...
						if (edtype == "select") {
							...
							inp = "<input class='" + cls2 + "' " + attr + " " + style + " type=date name='" + dataIndx + "' />"
						}
                        else if(edtype == "number") {
                            inp = "<input class='" + cls2 + " sothapphan' " + attr + " " + style + " type=number name='" + dataIndx + "' />"
                        }
                        else {
