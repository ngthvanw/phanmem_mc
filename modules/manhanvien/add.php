<?php
    ...
    $OBJ->set_MaBPGoc(check_data($_GET['mabp']));
    ...
    $OBJ->set_NgayTao(date("yyyy-mm-dd"));
    ...
    $OBJ->re_query("ALTER TABLE `manhanvien` CHANGE `masothue` `masothue` CHAR(14) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;");
    $OBJ->themMaNV();
    echo "{\"recId\": \"" . $sott . "\"}";
?>