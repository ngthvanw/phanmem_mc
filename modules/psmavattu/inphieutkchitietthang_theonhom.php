    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
			$(document).on('click','#xuatexcel',function(e) {
				...
				link.download = "Tong_Hop_TK_" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
				link.href = result;
				link.click();
			});
...
if($tiemCT['soluongtondk']!=0 || $tiemCT['soluongtonck']!=0 || $tiemCT['soluongnhap']!=0 || $tiemCT['soluongxuat']!=0) {
    ...
    $html_ct .= '
        ...
        <td class="td_center" width="90px" align="right" >' . (($tiemCT['soluongtondk'] == 0) ? "":NB_Format($tiemCT['soluongtondk'])) . '</td>
        <td align="right" class="td_end" width="100px" >';
    $html_ct .= (($tiemCT['thanhtientondk'] == 0) ? "":number_format($tiemCT['thanhtientondk'],0,",","."));
    $html_ct .= '</td>
        <td class="td_center" width="90px" align="right" >' . (($tiemCT['soluongnhap'] == 0) ? "":NB_Format($tiemCT['soluongnhap'])) . '</td>
        <td align="right" class="td_end" width="100px" >';
    $html_ct .= (($tiemCT['thanhtiennhap'] == 0) ? "":number_format($tiemCT['thanhtiennhap'],0,",","."));
    $html_ct .= '</td>

        <td class="td_center" width="90px" align="right" >' . (($tiemCT['soluongxuat'] == 0) ? "":NB_Format($tiemCT['soluongxuat'])) . '</td>
        <td align="right" class="td_end" width="100px" >';
    ...
    $html_ct .= '</td>
        ...
        <td class="td_center" width="90px" align="right" >' . (($tiemCT['soluongtonck'] == 0) ? "":NB_Format($tiemCT['soluongtonck'])) . '</td>
...
<table width="100%" border="0" style="border-bottom: 1px solid #000">
  <tr>
    <td colspan="8" align="left" WIDTH="55%"><B>' . $_SESSION["TenCongTy"] . '</B><br/>' . $_SESSION["DiaChi"] . '<br/>MST: ' . $_SESSION["MST"] . '</td>    
    <td colspan="2" align="center" WIDTH="15%"></td>
    <td colspan="3" WIDTH="30%" align="right" style="font-size:11px;">
		Mẫu số: S03a-SKT/DNN<br/>
		Ban hành ' . $_SESSION['THONGTUMANG'][$_SESSION['theothongtu']]['thongtu'] . ' ngày ' . $_SESSION['THONGTUMANG'][$_SESSION['theothongtu']]['ngay'] . ' của Bộ trưởng Bộ Tài Chính  
	</td>
  </tr>
</table>
...
<table align="left"  border="0" width="100%">
  <tr>
    <td colspan="13" align="left" ><b>' . $_SESSION["THONGTINPHIEU"]['tenphieu'] . '</b></td>
  </tr>
  <tr>
    <td colspan="13" align="left" >Tồn cuối: <b>' . $_SESSION["THONGTINPHIEU"]['ngayhoadon'] . '</b></td>
  </tr>
    <tr>
    <td colspan="13"align="left" >Kho hàng: <b>' . $_SESSION['DSKHOHANG'][$k]['tenkho'] . '</b></td>
  </tr>
</table>
