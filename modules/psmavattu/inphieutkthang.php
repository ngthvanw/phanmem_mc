...
class PDF extends tFPDF
{
    ...
    {
        $w = array(0,7,25,77,13,17,17,20,26);
    ...
    foreach ($_SESSION["LISTTKTHANG"] as $tiemCT) {
        ...
        $this->Cell($w[6], 5, number_format($tiemCT['soluongtonck']), 'LR', 0, 'R');
        $this->Cell($w[7], 5,number_format($tiemCT['dongiabinhquan'],$_SESSION["THONGTINPHIEU"]['sole']) , 'LR', 0, 'R');
        $this->Cell($w[8], 5,number_format($tiemCT['thanhtientonck']), 'LR', 0, 'R');
        ...
        $this->Cell($w[8],5,number_format($tongcong),'LTRB',0,'R');
