...
function backup_Database($hostName,$userName,$password,$DbName,$driver,$filename,$tables = '*',$chuyentatcatonkho)
{
    ...
    foreach($tables as $table)
    {
		if($table=="duyettonkho"){// Chuyển số dư công nợ khách hàng		
			$data.="CREATE TABLE IF NOT EXISTS `duyettonkho` (
		...
		if($table=="tokhaitndn_tt80"){// Chuyển số dư công nợ khách hàng		
			$data.="CREATE TABLE IF NOT EXISTS `tokhaitndn_tt80` (
                                              `sott` int(11) NOT NULL,
        ...
        if($table=="tokhai_05kk_tncn"){// Chuyển số dư công nợ khách hàng		
			$data.="CREATE TABLE `tokhai_05kk_tncn` (
                                            `sott` int(11) NOT NULL,
                                            `maso` char(5) NOT NULL,
                                            `chitieu` varchar(1000) NOT NULL,
                                            `machitieu` int(11) NOT NULL,
                                            `machitieucha` int(11) NOT NULL,
                                            `donvitinh` varchar(10) NOT NULL,
                                            `sotien` bigint(20) NOT NULL,
                                            `namtinhthue` int(4) NOT NULL,
                                            `kytinhthue` char(5) NOT NULL,
                                            `loaitokhai` int(1) NOT NULL
                                            ) ENGINE=InnoDB DEFAULT CHARSET=utf8;";		
		}
