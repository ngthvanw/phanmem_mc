...
$backup_response = backup_Database($_SESSION['HOST'],'root',$_SESSION['PASS_DB'],$_SESSION['TIENTO'].$_SESSION['MST']."_".$_SESSION['NienDo'],$driver,$filename,'*',$chuyentatcatonkho);

if ($NienDo >2000) { {
        $theothongtu = $_SESSION['theothongtu'];		
		if($theothongtu=='tt200'){
			$filename = $driver.'/datafile/khac/datafile_tt200.rar';
		}else{
			$filename = $driver.'/datafile/khac/datafile.rar';
		}
