...
<table width="100%" border="1" >
    <tr>
        <th style="text-align: center;" colspan="7"><b>DANH SÁCH DUYỆT SỐ DƯ TÀI KHOẢN</b></th>
    </tr>
    <tr>
        <th style="text-align: center;" colspan="7"><a style="cursor: pointer" data-name="'<?php echo $matk; ?>'" class="ketquatrave">Xem chi tiết duyệt</a></th>
    </tr>
<tr>
...
?>
        <tr>
            ...
            <td style="text-align: center;" width="15px"><?php echo $item['matk']; ?></td>
