...
$OBJ->re_query("INSERT INTO `manhom` (`sott`, `manhom`, `tennhom`, `ghichu`, `rank`) VALUES ('100', '1100', 'Thành phẩm', '', '0');");
$OBJ->re_query("insert into mavt(mavt,tenvt,dvt,matk,manhom,tennhom,tenkd,`rate`,tkdoanhthu) select masp,tensp,dvt,'155','1100','Thành Phẩm',tenkd,10,'5112' from masp where masp not in (SELECT mavt from mavt) and loaisp='SP'");
$OBJ->re_query("UPDATE mavt JOIN masp 
