...
if($congdontheosocai=="0"){
    foreach ($matk_arr as $item_tk){
        foreach ($dataChi[$item_tk] as $item_danhsach){
            ...
            $check = false;
            if($tk=='33312'){
                if(((($item_danhsach['tkdu']=='34111'|| $item_danhsach['tkdu']=='1111' || substr($item_danhsach['tkdu'],0,-2)=='1121' || $item_danhsach['tkdu']=='131' || $item_danhsach['tkdu']=='1331') && $item_danhsach['tienno']!="0") || ($tk!='33311' && $item_danhsach['tienco']!="0" ))){/// Lấy danh sách các loại thuê đã nộp NSNN
