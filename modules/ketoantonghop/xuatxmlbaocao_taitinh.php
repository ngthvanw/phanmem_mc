...
$dataLuuChuyenTienTe = $_SESSION["dataLUUCHUYENTIENTE"];

$dataBCDKT = $_SESSION["dataBCDKT"];
$tungay = $_GET['tungay'];
...
if($_SESSION['theothongtu']=="tt200"){
	...
	$xmlload = simplexml_load_file( $_SESSION['DRIVER_PM']."/tmp/200_BCTC_{$version}.xml");
	//echo "<pre>";
	//print_r($dataBCDKT);
	//echo "</pre>";
	/// ------ Thông tin tờ khai --------------------------
    ...
    $xmlload->HSoKhaiThue->TTinChung->TTinTKhaiThue->TKhaiThue->KyKKhaiThue->kyKKhaiTuNgay= date("d/m/Y",$tungay_time);
    ...
    if($version=="4.0.x"){
        ...
        $xmlload->HSoKhaiThue->CTieuTKhaiChinh->CDKT_HoatDongLienTuc->ngayLap =date("Y-m-d");
        $xmlload->HSoKhaiThue->CTieuTKhaiChinh->CDKT_HoatDongLienTuc->giamDoc =".";
    }else {
	...
	$data_array =  json_decode(json_encode($xmlload),true);

	foreach($data_array['HSoKhaiThue']['CTieuTKhaiChinh']['CDKT_HoatDongLienTuc']['SoCuoiNam'] as $dirKey => $dirVal) {
		$maso = substr($dirKey,2,4);
		if($maso=='223'){// Nếu rồi vào chỉ tiều này thì điền giá trị âm :: Cập nhật thêm nếu phát hiện thiếu 
			$xmlload->HSoKhaiThue->CTieuTKhaiChinh->CDKT_HoatDongLienTuc->SoCuoiNam->$dirKey= -(number_format($dataBCDKT[$maso]['soduck'],0,",",""));
			$xmlload->HSoKhaiThue->CTieuTKhaiChinh->CDKT_HoatDongLienTuc->SoDauNam->$dirKey= -(number_format($dataBCDKT[$maso]['sodudk'],0,",",""));
	...
	/// ------ KQKD --------------------------
		...
		foreach($data_array['HSoKhaiThue']['PLuc']['PL_KQHDSXKD']['NamNay'] as $dirKey => $dirVal) {
			$maso = substr($dirKey,2,4);
			$xmlload->HSoKhaiThue->PLuc->PL_KQHDSXKD->NamNay->$dirKey=number_format($dataDanhSachXDKQKD[$maso]['namnay'],0,",","");
			$xmlload->HSoKhaiThue->PLuc->PL_KQHDSXKD->NamTruoc->$dirKey=number_format($dataDanhSachXDKQKD[$maso]['namtruoc'],0,",","");
		}

	/// ------ Bảng Lưu chuyển tiền tẹ--------------------------

    foreach($data_array['HSoKhaiThue']['PLuc']['PL_LCTTTT']['NamNay'] as $dirKey => $dirVal) {
        $maso = (int)substr($dirKey,2,4);
        $xmlload->HSoKhaiThue->PLuc->PL_LCTTTT->NamNay->$dirKey=number_format($dataLuuChuyenTienTe[$maso]['soduck'],0,",","");
        $xmlload->HSoKhaiThue->PLuc->PL_LCTTTT->NamTruoc->$dirKey=number_format($dataLuuChuyenTienTe[$maso]['sodudk'],0,",","");
    }

    file_put_contents($_SESSION['DRIVER_PM']."/datafile/".$_SESSION['MST']."/".$_SESSION['NienDo']."/200_BCTC_{$version}.xml", $xmlload->asXML());
...
/// ------ Thông tin bảng cân đối kế toán --------------------------
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct110=number_format($dataBCDKT['110']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct110=number_format($dataBCDKT['110']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct120=number_format($dataBCDKT['120']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct120=number_format($dataBCDKT['120']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct121=number_format($dataBCDKT['121']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct121=number_format($dataBCDKT['121']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct122=number_format($dataBCDKT['122']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct122=number_format($dataBCDKT['122']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct123=number_format($dataBCDKT['123']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct123=number_format($dataBCDKT['123']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct124=number_format($dataBCDKT['124']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct124=number_format($dataBCDKT['124']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct130=number_format($dataBCDKT['130']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct130=number_format($dataBCDKT['130']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct131=number_format($dataBCDKT['131']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct131=number_format($dataBCDKT['131']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct132=number_format($dataBCDKT['132']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct132=number_format($dataBCDKT['132']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct133=number_format($dataBCDKT['133']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct133=number_format($dataBCDKT['133']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct134=number_format($dataBCDKT['134']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct134=number_format($dataBCDKT['134']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct135=number_format($dataBCDKT['135']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct135=number_format($dataBCDKT['135']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct136=number_format($dataBCDKT['136']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct136=number_format($dataBCDKT['136']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct140=number_format($dataBCDKT['140']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct140=number_format($dataBCDKT['140']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct141=number_format($dataBCDKT['141']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct141=number_format($dataBCDKT['141']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct142=number_format($dataBCDKT['142']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct142=number_format($dataBCDKT['142']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct150=number_format($dataBCDKT['150']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct150=number_format($dataBCDKT['150']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct151=number_format($dataBCDKT['151']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct151=number_format($dataBCDKT['151']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct152=number_format($dataBCDKT['152']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct152=number_format($dataBCDKT['152']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct160=number_format($dataBCDKT['160']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct160=number_format($dataBCDKT['160']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct161=number_format($dataBCDKT['161']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct161=number_format($dataBCDKT['161']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct162=number_format($dataBCDKT['162']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct162=number_format($dataBCDKT['162']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct170=number_format($dataBCDKT['170']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct170=number_format($dataBCDKT['170']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct180=number_format($dataBCDKT['180']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct180=number_format($dataBCDKT['180']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct181=number_format($dataBCDKT['181']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct181=number_format($dataBCDKT['181']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct182=number_format($dataBCDKT['182']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct182=number_format($dataBCDKT['182']['sodudk'],0,",","");

    $sum200ck = $dataBCDKT['110']['soduck']+$dataBCDKT['120']['soduck']+$dataBCDKT['130']['soduck']+$dataBCDKT['140']['soduck']+$dataBCDKT['150']['soduck']+$dataBCDKT['160']['soduck']+$dataBCDKT['170']['soduck']+$dataBCDKT['180']['soduck'];
    $sum200dk = $dataBCDKT['110']['sodudk']+$dataBCDKT['120']['sodudk']+$dataBCDKT['130']['sodudk']+$dataBCDKT['140']['sodudk']+$dataBCDKT['150']['sodudk']+$dataBCDKT['160']['sodudk']+$dataBCDKT['170']['sodudk']+$dataBCDKT['180']['sodudk'];


    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct200=$sum200ck;
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct200=$sum200dk;

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct300=number_format($dataBCDKT['300']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct300=number_format($dataBCDKT['300']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct311=number_format($dataBCDKT['311']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct311=number_format($dataBCDKT['311']['sodudk'],0,",","");


    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct312=number_format($dataBCDKT['312']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct312=number_format($dataBCDKT['312']['sodudk'],0,",","");


    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct313=number_format($dataBCDKT['313']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct313=number_format($dataBCDKT['313']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct314=number_format($dataBCDKT['314']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct314=number_format($dataBCDKT['314']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct315=number_format($dataBCDKT['315']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct315=number_format($dataBCDKT['315']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct316=number_format($dataBCDKT['316']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct316=number_format($dataBCDKT['316']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct317=number_format($dataBCDKT['317']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct317=number_format($dataBCDKT['317']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct318=number_format($dataBCDKT['318']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct318=number_format($dataBCDKT['318']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct319=number_format($dataBCDKT['319']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct319=number_format($dataBCDKT['319']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct400=number_format($dataBCDKT['400']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct400=number_format($dataBCDKT['400']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct411=number_format($dataBCDKT['411']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct411=number_format($dataBCDKT['411']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct412=number_format($dataBCDKT['412']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct412=number_format($dataBCDKT['412']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct413=number_format($dataBCDKT['413']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct413=number_format($dataBCDKT['413']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct414=number_format($dataBCDKT['414']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct414=number_format($dataBCDKT['414']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct415=number_format($dataBCDKT['415']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct415=number_format($dataBCDKT['415']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct416=number_format($dataBCDKT['416']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct416=number_format($dataBCDKT['416']['sodudk'],0,",","");

    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoCuoiNam->ct417=number_format($dataBCDKT['417']['soduck'],0,",","");
    $xmlload->HSoKhaiThue->CTieuTKhaiChinh->SoDauNam->ct417=number_format($dataBCDKT['417']['sodudk'],0,",","");

    $sum500ck = ($dataBCDKT['300']['soduck']+$dataBCDKT['400']['soduck']);
    $sum500dk = ($dataBCDKT['300']['sodudk']+$dataBCDKT['400']['sodudk']);
