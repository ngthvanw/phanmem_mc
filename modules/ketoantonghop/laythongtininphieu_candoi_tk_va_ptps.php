...
///// Chạy lại bảng cân đối tài khoản--------------------------------------------------------
    ...
    $OBJCT->re_query("delete from tmp_bangcdtk");
    $OBJCT->re_query("ALTER TABLE tmp_bangcdtk AUTO_INCREMENT=1;");
    $OBJCT->re_query("create table tmp_bangcdtk select * from bangcdtk;");
}else {
    $OBJPSKT = new pskt();
    $sophieu = $OBJPSKT->createSoPhieu();
    $tungay = $_GET['tungay'];
