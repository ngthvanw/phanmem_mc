...
foreach ($mangsotien as $itemSoTien){
    ...
    $OBJ->re_query(" update bangcdkt set sodudk=".$itemSoTien['sodudk'].",soduck=".$itemSoTien['soduck']."  where maso='".$itemSoTien['maso']."'");
}
...
$OBJ->re_query("update bangcdkt set sodudk=".$sodudk120.",soduck=".$soduck120." where maso = '120'");
$OBJ->re_query("update bangcdkt set sodudk=".$sodudk130.",soduck=".$soduck130." where maso = '130'");
$OBJ->re_query("update bangcdkt set sodudk=".$sodudk140.",soduck=".$soduck140." where maso = '140'");
$OBJ->re_query("update bangcdkt set sodudk=".$sodudk150.",soduck=".$soduck150." where maso = '150'");
$OBJ->re_query("update bangcdkt set sodudk=".$sodudk160.",soduck=".$soduck160." where maso = '160'");
$OBJ->re_query("update bangcdkt set sodudk=".$sodudk180.",soduck=".$soduck180." where maso = '180'");
...
$OBJ->re_query("update bangcdkt set sodudk=".$sodudk300.",soduck=".$soduck300." where maso = '300'");
$OBJ->re_query("update bangcdkt set sodudk=".$sodudk400.",soduck=".$soduck400." where maso = '400'");
?>