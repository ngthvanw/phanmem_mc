...
foreach ($mangsotien as $itemSoTien){
    ...
    $OBJ->re_query(" update tokhaitndn set sotien=".$$sotien.",ghichu='".$itemSoTien['ghichu']."' where machitieu='".$itemSoTien['machitieu']."' and loaitokhai='TNDN'");
}
...
if($_SESSION['NienDo']>=2021){// Áp dụng theo thông tư 80 từ ngày 01/01/2022
    ...
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienC3." where machitieu='C3' and loaitokhai='TNDN'");
    ...
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienC9." where machitieu='C9' and loaitokhai='TNDN'");
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienC10." where machitieu='C10' and loaitokhai='TNDN'");
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienC17." where machitieu='C17' and loaitokhai='TNDN'");
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienD1." where machitieu='D1' and loaitokhai='TNDN'");
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienD3." where machitieu='D3' and loaitokhai='TNDN'");
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienD5." where machitieu='D5' and loaitokhai='TNDN'");
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienD8." where machitieu='D8' and loaitokhai='TNDN'");
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienE2." where machitieu='E2' and loaitokhai='TNDN'");
    ...
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienH1." where machitieu='H1' and loaitokhai='TNDN'");
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienH2." where machitieu='H2' and loaitokhai='TNDN'");
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienH3." where machitieu='H3' and loaitokhai='TNDN'");
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienI1." where machitieu='I1' and loaitokhai='TNDN'");
    $OBJ->re_query(" update tokhaitndn set sotien=".$sotienI2." where machitieu='I2' and loaitokhai='TNDN'");
    ...
    if ($TongTienTruocThue >= 0) {
        if ($TienLaiSauThue >= 0) {// Neu loi nhuan >0
            ...
            $OBJ->re_query(" UPDATE buttoanps SET `sotien` = '{$TienThue}' WHERE maso = 'KCTNDN';");
            $OBJ->re_query(" UPDATE buttoanps SET `sotien` = '{$TienThue}' WHERE maso = 'KCTHDN';");
            $OBJ->re_query(" UPDATE buttoanps SET `sotien` = '0' WHERE maso = 'KCLAKD';");
            $OBJ->re_query(" UPDATE buttoanps SET `sotien` = '{$TienLaiSauThue_KhuAm}' WHERE maso = 'KCLOKD';");
