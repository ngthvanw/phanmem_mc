...
foreach ($array_dungchung as $itemDungChung) {
    $str_w = " and dungchung=" . $itemDungChung . " and thuesuat in('" . $str_thue . "') and ngaykhaithue >='" . $tungay . "' and ngaykhaithue<= '" . $denngay . "' and maloai='1' and duandautu='1' ";
    $str_w2 = " and dungchung=" . $itemDungChung . " and thuesuat1 in('" . $str_thue . "') and ngaykhaithue >='" . $tungay . "' and ngaykhaithue<='" . $denngay . "' and maloai='1' and duandautu='1' ";
...
$tmp40 = $T36 - $T22 + $gtgtgiam - $gtgttang;
if ($tmp40 >= 0) {
    $T40a = $tmp40;
    $T41 = 0;
} else {
...
$T43 = round((abs($T41) - $T42-$T40b-$T39));
...
$sophieu++;
    ...
    $value_chitiet_pskt .= "(1,'" . $denngay . "','" . $denngay . "','" . abs($tongkh632_1331) . "','" . abs($tong632_1332) . "','0001','Toàn bộ','100092','Phân bổ thuế GTGT đầu vào cho hàng không chịu thuế " . $tenthang . "','100093','Phân bổ thuế GTGT đầu vào cho hàng không chịu thuế" . $tenthang . "','1331','1332','" . abs($Thuemuavaosaukhautru) . "','4','73','" .($sophieu+1) . "','73'),";
