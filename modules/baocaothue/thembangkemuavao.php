...
$OBJCT->re_query("delete from tmp_bangke_daura");
$OBJCT->re_query("ALTER TABLE tmp_bangke_daura AUTO_INCREMENT = 1");

$OBJCT->re_query($sqlin.substr($val,0,-1));
...
<table width="100%" border="1" id="table_vuot20trieu">
    ...
    foreach ($datavuot as $itemvuot){
        if($itemvuot['tongtien']>=20000000 && $itemvuot['tkco']='1111' && $itemvuot['ngayhoadon']<"2025-07-01") {
            $dem++;
            ?>
                <tr>
            ...
            <?php
        }else if($itemvuot['tongtien']>=5000000 && $itemvuot['tkco']='1111' && $itemvuot['ngayhoadon']>="2025-07-01"){
            $dem++;
            ?>
                <tr>
                    <td align="center"><?php echo $itemvuot['mapskt']; ?></td>
