...
$thuesuat = str_replace(",", "",$_GET['thuesuat']);
$thueandinh = str_replace(",", "",$_GET['mucthueandinh']);
$thuephatsinh = str_replace(",", "",$_GET['thuepstrongky']);
$thuegiam = str_replace(",", "",$_GET['thuemiengiam']);
...
$OBJCT->ThemToKhaiThue_TN($loaiks,$tenloai,$maloaiks,$dvt,$soluong,$mucphi,$thanhtien,$loaitokhai,$thangtinhthue."-".$namtinhthue,$tendvt,$thuesuat,$thueandinh,$thuephatsinh,$thuegiam);
