...
foreach ($array_dungchung as $itemDungChung) {
    if($loaitokhai==0){
        $str_w = " and dungchung=" . $itemDungChung . " and thuesuat in('" . $str_thue . "') and ((ngayhoadon >='" . $tungay . "' and ngayhoadon<= '" . $denngay . "')) and duandautu='1' ";
        $str_w2 = " and dungchung=" . $itemDungChung . " and thuesuat1 in('" . $str_thue . "') and ((ngayhoadon >='" . $tungay . "' and ngayhoadon<='" . $denngay . "')) and duandautu='1' ";
    }else{
        $str_w = " and dungchung=" . $itemDungChung . " and thuesuat in('" . $str_thue . "') and (ngayghiso >='" . $tungay . "' and ngayghiso<= '" . $denngay . "') and duandautu='1' ";
        $str_w2 = " and dungchung=" . $itemDungChung . " and thuesuat1 in('" . $str_thue . "') and (ngayghiso >='" . $tungay . "' and ngayghiso<='" . $denngay . "') and duandautu='1' ";
    }
...
foreach ($array_thue1 as $itemThue){
    if($loaitokhai==0) {
        $str_w = " and thuesuat='" . $itemThue . "' and ((ngayhoadon >='" . $tungay . "' and ngayhoadon<= '" . $denngay . "'))";
        $str_w2 = " and thuesuat1='" . $itemThue . "' and ((ngayhoadon >='" . $tungay . "' and ngayhoadon<='" . $denngay . "'))";
    }else{
