...
foreach ($result as $item){
    $TongPhaiThu+=$item[sdkno];
    $TongPhaiTra+=$item[sdkco];
    $TongNTPhaiThu+=$item['thanhtienntpt'];
    $TongNTPhaiTra+=$item['thanhtienntptr'];
}
$result_xuat = array("TongPhaiThu"=>$TongPhaiThu,"TongPhaiTra"=>$TongPhaiTra,"TongNTPhaiThu"=>$TongNTPhaiThu,"TongNTPhaiTra"=>$TongNTPhaiTra);
