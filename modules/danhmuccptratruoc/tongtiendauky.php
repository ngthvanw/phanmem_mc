...
if($loai=='xdcb'){
    $OBJ->set_orderby($filterQuery." tanggiam ='$loaiphieu' and SUBSTRING(matk,1,3)=241 ");
}else{
    $OBJ->set_orderby($filterQuery." tanggiam ='$loaiphieu' and SUBSTRING(matk,1,3)!=241 ");
}
...
foreach ($result as $item){
    ...
    $TongGTConLai+=$item['giatriconlai'];
}
$result_xuat = array("TongNguyenGia"=>$TongNguyenGia,"TongGTConLai"=>$TongGTConLai);
