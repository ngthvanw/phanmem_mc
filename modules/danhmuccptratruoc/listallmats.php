...
if ( isset($_GET["pq_filter"]))
{
   ...
   // $string = khu_dau_vn(str_replace("manhom","mavt.manhom",$dsf->query));
    $filterQuery = khu_dau_vn(str_replace("tents","tenkd",$dsf->query))." and ";
} 
//echo $filterQuery;
if($loai=='xdcb'){
    $OBJ->set_orderby($filterQuery." manhomts in (1536)");
}else{
    $OBJ->set_orderby($filterQuery." manhomts not in (1536)");
}

if(isset($_GET['pq_filter'])){
    $result = $OBJ->loadListAllDSSPTRATRUOC_W(0,10);
}else{
     $result = $OBJ->loadListAllDSSPTRATRUOC(0,10);
}
