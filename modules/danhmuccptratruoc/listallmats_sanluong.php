...
$OBJ->re_query("CREATE TABLE `sanluong_phanbo_congcu` ( `sott` BIGINT NOT NULL AUTO_INCREMENT , `mats` VARCHAR(20) NOT NULL,`matscha` VARCHAR(20) NOT NULL , `tents` VARCHAR(1000) NOT NULL , `thang1` BIGINT NOT NULL DEFAULT '0' , `thang2` BIGINT NOT NULL DEFAULT '0' , `thang3` BIGINT NOT NULL DEFAULT '0' , `thang4` BIGINT NOT NULL DEFAULT '0' , `thang5` BIGINT NOT NULL DEFAULT '0' , `thang6` BIGINT NOT NULL DEFAULT '0' , `thang7` BIGINT NOT NULL DEFAULT '0' , `thang8` BIGINT NOT NULL DEFAULT '0' , `thang9` BIGINT NOT NULL DEFAULT '0' , `thang10` BIGINT NOT NULL DEFAULT '0' , `thang11` BIGINT NOT NULL DEFAULT '0' , `thang12` BIGINT NOT NULL DEFAULT '0' , `tongcong` BIGINT NOT NULL,`tenkd` VARCHAR(1000) NOT NULL , PRIMARY KEY (`sott`)) ENGINE = InnoDB;");
$OBJ->re_query("ALTER TABLE `sanluong_phanbo_congcu` ADD UNIQUE(`mats`);");
$OBJ->re_query("INSERT INTO sanluong_phanbo_congcu(mats,tents,matscha,tenkd) SELECT mats,tents,matscha,tenkd FROM cptratruoc");
$OBJ->re_query("UPDATE `sanluong_phanbo_congcu` set tongcong = thang1+thang2+thang3+thang4+thang5+thang6+thang7+thang8+thang9+thang10+thang11+thang12");
$OBJ->re_query("UPDATE cptratruoc a INNER JOIN sanluong_phanbo_congcu b ON a.mats = b.mats SET b.tents = a.tents,b.tenkd = a.tenkd");
