...
$OBJ->re_query(" insert into bangdoanhthuthucte(mact,gtcongtrinh,tyle,doanhthuthucte) select masp,0,0,0 from masp where loaisp='SP' and masp not in (select mact from bangdoanhthuthucte) ");
