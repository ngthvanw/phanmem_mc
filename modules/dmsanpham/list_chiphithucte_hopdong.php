...
$OBJ->re_query(" insert into bangdoanhthuthucte(mact,gtcongtrinh,tyle,doanhthuthucte) select masp,gthopdong,0,0 from masp where loaisp='HD' and masp not in (select mact from bangdoanhthuthucte) ");
