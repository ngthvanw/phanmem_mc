...
$thanhtoanphidichvu = trim(($_GET['thanhtoanphidichvu']));
...
$str.=":". $thietlapdailythue . ":" . $txt_masothue_daily.":" . $txt_tencongtydaily.":" . $txt_hovatendaily.":".$txt_chungchindaily.":".$ngonngu.":".$txt_seritoken.":".$chukysodaky.":".$butrucongno.":".$dinhdangsophieu.":".$phuongphaptonkho.":".$capnhatgiavontucthoi.":".$txt_PartnerGUID.":".$txt_PartnerToken.":".$tudongtinhdongia.":".$giam30thuegtgt.":".$hienthichinhanh.":".$ngoaite.":".$duandautu.":".$phanloaihanghoadauvao.":".$chungtuthamchieu.":".$thanhtoanphidichvu;
$congty = $str;
