...
$OBJ->re_query("ALTER TABLE `chitiet_pskt` ADD `chiphikhongloaitru` INT NOT NULL;");
$OBJ->re_query("ALTER TABLE `chitiet_pskt` ADD `loaitokhai` INT NOT NULL DEFAULT '1'");
$OBJ->re_query("ALTER TABLE `chitiet_pskt` ADD `capnhat_chungtugoc` DATETIME NOT NULL;");
$OBJ->re_query("ALTER TABLE `chitiet_pskt` ADD `capnhat_chiphikhongloaitru` DATETIME NOT NULL;");
...
$OBJ->re_query("ALTER TABLE `pskt` ADD `tencanhan` CHAR(200) NOT NULL;");
$OBJ->re_query("ALTER TABLE `chitiet_pskt` ADD `lacongtrinh` INT(1) NOT NULL;");
...
if($_GET['chungtugoc']==0){
    ...
    $OBJ->re_query("update chitiet_pskt set capnhat_chungtugoc = '".date("Y-m-d h:i:s")."' where sophieu='".$sophieu."'");
}
if($_GET['chiphikhongloaitru']==1){
    $OBJ->re_query("update chitiet_pskt set capnhat_chiphikhongloaitru = '".date("Y-m-d h:i:s")."' where sophieu='".$sophieu."'");
}
