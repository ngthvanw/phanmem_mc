...
<div id="dialog-bangcandoiketoan" title="BÁO CÁO LƯU CHUYỂN TIỀN TỆ...">
    ...
    <form method="post" id="Form-chinh" enctype="multipart/form-data">
        ...
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
                <tr>
                    <td colspan="2"><select name="Intheothuesuat" style="width:100%;height:25px;display:none;" id="Intheothuesuat">
                  ...
                  <button type="button" onclick="$('.dialog_main_thietlap_tokhai_phuluc').load('form/frm_thietlap_bangluuchuyen_tiente.php');" style="width:100%;border:1px solid #990" class="ui-button ui-corner-all ui-widget">Thay đổi số liệu...</button>
                  </td>
                </tr>
                <tr style="display:none">
                    <td><b>Chứng từ :
                        ...
                        <table style="width: 100%;display: none;">
                            <tr>
                                <td><input name="xemchitiet" type="checkbox" id="xemchitiet"
                                           checked="checked"></td>
                                <td>Khóa sổ và chuyển số dư sang năm mới</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                var res = confirm("CẢNH BÁO!!\nDữ liệu cũ đã có . Bạn có muốn ghi đè lên dữ liệu không ?");
                if(res) {
                    $.confirm({
                        title: 'Thành công.',
                        type: 'green',
                        ...
                        content: function () {
                            ...
                            return $.ajax({// Chuyển tồn kho cho năm mới
                                url: $dir_module_ketoantonghop + "thembang_luuchuyen_tiente.php",
                                data: {
                                    tungay: $tungay,
                                    denngay: $denngay,
                                    intheothuesuat: $Intheothuesuat,
                        ...
                        buttons: {
                            "OK": function () {
                                $('.dialog_main_thongbao').load("form/frm_insolieu_bangluuchuyen_tiente.php?tungay=" + $tungay + "&denngay=" + $denngay + "&intheothuesuat=" + $Intheothuesuat + "&intheochungtu=" + $Intheochungtu + "&sapxeptheohoadon=" + $sapxeptheohoadon + "&theothongtu=" + $theothongtu + "&kieuin=" + $kieuin + "&xemchitiet=" + $xemchitiet);
                            }
                        }
        ...
        function GoiThietLap_SoDuDK(){
            $('.dialog_main_thietlap_tokhai_phuluc').load("form/frm_thietlap_bangluuchuyen_tiente.php");
        }
