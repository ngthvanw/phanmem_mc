...
<div id="dialog-baocao_kqkd" title="Bảng phân tích kết quả kinh doanh...">
                            ...
                            buttons: {
                                "OK": {
                                    keys: ['Y'], action: function () {
                                        $('.dialog_main_thongbao').load("form/frm_insolieu_phantich_ketqua_hoatdong_kinhdoanh.php?quy=" + $quy + "&bangchiphitc=" + $bangchiphitc);
                                    }
                                }
                            }
                        });
