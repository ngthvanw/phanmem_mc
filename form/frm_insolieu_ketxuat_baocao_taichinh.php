                        ...
                        "OK": {
                            keys: ['Y'], action: function () {
                                if($("#XuatXML").prop("checked") == true){
									if("<?php echo $_SESSION['theothongtu'];?>"=="tt200"){
										window.open("<?php echo $_SESSION['URI']."/datafile/".$_SESSION['MST']."/".$_SESSION['NienDo'].""."/"; ?>"+"200_BCTC_"+$version+".xml","baocaotaichinh","menubar=0,resizable=1");
									}else{
                    ...
                    <table width="100%" border="0">
                        ...
                        <tr>
                          <td style="text-align:right"><br/>
                            &nbsp;&nbsp;<input style="display:none;" type="checkbox" name="XuatExcel" id="XuatExcel" />
                            </td>
