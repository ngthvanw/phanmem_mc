                        ...
                        keys: ['Y'], action: function () {
                            if ($("#XuatExcel").prop("checked") == true) {
                                ...
                                if ("<?php echo $loaisanpham ?>" == "CT") {
                                    ...
                                    if("<?php echo $theopp ?>"=="tyle"){
                                        loadiFrame('tcpdf/baocao/inbang_tonghop_danhthu_chiphi_giathanh_sanpham_tyle.php');
                                    }else{
                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if ("<?php echo $loaisanpham ?>" == "CT") {
                                ...
                                if("<?php echo $theopp ?>"=="tyle"){
                                    window.open("tcpdf/baocao/inbang_tonghop_danhthu_chiphi_giathanh_sanpham_tyle.php", "cpso", "menubar=0,resizable=0");
                                }else{
