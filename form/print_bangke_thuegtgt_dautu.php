...
<div style="width: 500px;;" id="dialog_insolieu_nhapxuat" title="In số liệu">
    <iframe id="fred" style="border:1px solid #666CCC" title="" src="modules/baocaothue/inphieu_tokhai_thuegtgt_theopp_dautu.php?<?php echo $query; ?>"
        ...
        dialog = $("#dialog_insolieu_nhapxuat").dialog({
            ...
            buttons: {
                ...
                "Sổ nhật ký tờ khai": function () {
					if("<?php echo $loaitokhai ?>"==1){
						window.open('form/frm_phieukiemtra_nhatky_tokhai_thuegtgt_window.php?loaiphieu=13,15','kiemtraphieuthu9','height='+(getHeight()-80)+',width='+getWidth());
					}else{
						window.open('form/frm_phieukiemtra_nhatky_tokhai_thuegtgt_window.php?loaiphieu=13,15','kiemtraphieuthu11','height='+(getHeight()-80)+',width='+getWidth());
					}
                },
                "Phiếu kiểm tra": function () {
					if("<?php echo $loaitokhai ?>"==1){
						window.open('form/frm_phieukiemtra_tokhai_thuegtgt_window.php?loaiphieu=13&tuphieu=<?php echo $thang."-".$namtinhthue; ?>&denphieu=<?php echo $DenPhieu; ?>&gt1=<?php echo $ThueGTGTPhaiNop; ?>&gt2=<?php echo $ThueGTGTChuaKT; ?>','kiemtraphieuthu<?php echo $LoaiPhieu; ?>','height='+(getHeight()-80)+',width='+getWidth());
						
					}else{
						window.open('form/frm_phieukiemtra_tokhai_thuegtgt_window.php?loaiphieu=15&tuphieu=<?php echo $thang."-".$namtinhthue;; ?>&denphieu=<?php echo $DenPhieu; ?>&gt1=<?php echo $ThueGTGTPhaiNop; ?>&gt2=<?php echo $ThueGTGTChuaKT; ?>','kiemtraphieuthu<?php echo $LoaiPhieu; ?>','height='+(getHeight()-80)+',width='+getWidth());
