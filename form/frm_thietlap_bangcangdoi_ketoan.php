            ...
            if ($('div').hasClass('jconfirm') == false) {
                ...
                if (event.keyCode == Keys.F7) { // copy
                    if (rowSelect != false) {
                        ...
                        //--------------------------------------------Thay đổi khi copy---------------------------------
                        var _dataRow = {
                            matsnv: rowData.matsnv,
                            tentsnv: rowData.tentsnv,
                            maso: rowData.maso,
                            matsnvcha: rowData.matsnvcha,
                            loaitsnv: rowData.loaitsnv,
                            matk: rowData.matk
                        };
        ...
        var obj = {
            ...
            change: function (evt, ui) {// Khi dữ liệu thay đổi                
                ...
                var obj = rowList[0],
                    ...
                    type = obj.type,
                    rowData = obj.rowData;
                var column = $("#grid_editing_bangcandoi_ketoan").pqGrid("getData", {dataIndx: ['sodudk','soduck','maso']});
                ...
                if (type == 'update') {
                    ...
                    if (valid) {
                        if (rowData[recIndx] == null) {
                            url = $dir_module_ketoan_tonghop + "edit_thietlap_cdkt.php";
                        }
                        else {
                            url = $dir_module_ketoan_tonghop + "edit_thietlap_cdkt.php";
                        }
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Năm nay", width: 80, dataType: "integer", dataIndx: "soduck", align: "right",
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.soduck, 0, ".", ",");
                    }
                },
                {
                    title: "Năm trước", width: 80, dataType: "integer", dataIndx: "sodudk", align: "right",
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_ketoan_tonghop + "list_thietlap_cdkt.php",//-- Load danh sách lên lưới
...
<div id="dialog-bangcandoi_ketoan" title="Thiết lập bảng cân đối kế toán"><!-- dialog -->
