...
<head>
    <meta charset="utf-8"/>
    <title>BẢNG TỔNG HỢP DANH SÁCH THANH - KIỂM TRA CÔNG TY</title>
    ...
    $(function () {
        ...
        $("#dialog-makhachhang").keydown(function (event) {//--------------Các phím tắt
            ...
            if ($('div').hasClass('jconfirm') == false) {
                if (event.keyCode == Keys.F7) { // copy
                    ...
                    //--------------------------------------------Thay đổi khi copy---------------------------------
                    var _dataRow = {masothue: rowData.masothue, tencongty: rowData.tencongty, nguoiphutrach: rowData.nguoiphutrach, kehoachkiemtra: rowData.kehoachkiemtra, ngaykiemtra: rowData.ngaykiemtra, kykiemtra: rowData.kykiemtra, sotientruythu: rowData.sotientruythu, lydotruythu: rowData.lydotruythu, ghichu: rowData.ghichu};
                    ...
                    buttons: {
                        "Đồng ý": {
                            keys: ['Y'], action: function () {
                                ...
                                $.ajax($.extend({}, ajaxObj, {
                                    context: $grid,
                                    url: $dir_module_user + "del_kiemtra.php",
                                    data: {id: sott, ma: ma},
        ...
        var obj = {
                ...
                if (type == 'update') {
                    ...
                    if (valid) {
                        if (rowData[recIndx] == null) {
                            url = $dir_module_user + "add_kiemtra.php";
                        }
                        else {
                            url = $dir_module_user + "edit_kiemtra.php";
                        }
                    }
                }
                if (valid) {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Tên công ty", minWidth: 300, dataType: "string", align: "left", dataIndx: "tencongty",editable:true,
                },
                {
                    title: "Phụ trách", minWidth: 70, dataType: "string", dataIndx: "nguoiphutrach",editable:true,
                ...
                },
                {
                    ...
                    validations: [
                        {type: 'minLen', value: 4, msg: "Kế hoạch kiểm tra phải có  4 ký tự - ví dụ năm 2020 !"},
                        {type: 'maxLen', value: 4, msg: "Kế hoạch kê khai phải có  4 ký tự - ví dụ năm 2020 !"},
                    ],

                },
                {
                    title: "Ngày kiểm tra", minWidth: 120, dataType: "string", align: "center", dataIndx: "ngaykiemtra",editable:true,
                    editor: {
                        type: 'date'
                    },
                    render: function (ui) {
                        var $yyyy_mm_dd = ui.rowData.ngaykiemtra;
                ...
                },
                {
                    ...
                    dataType: "string",
                    align: "left",
                    dataIndx: "sotientruythu",
                    editable: true,
                    editor: {type: "textarea", attr: "rows=3"}

                },
                {
                    title: "Lý do truy thu",
                    minWidth: 120,
                    dataType: "string",
                    align: "center",
                    dataIndx: "lydotruythu",
                    hidden: false,
                    editable: true,
                    editor: {type: "textarea", attr: "rows=3"}
                },
            ...
            dataModel: {
                ...
                url: $dir_module_user + "list_danhsach_kliemtra.php",//-- Load danh sách lên lưới
...
<div id="dialog-makhachhang"
     title="BẢNG TỔNG HỢP DANH SÁCH THANH - KIỂM TRA (F7: Sao chép,F8: Xoá)"><!-- dialog -->
