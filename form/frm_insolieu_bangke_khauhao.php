...
<script>
    $(function () {
        $dir_module_mataisan = "modules/mataisan/";
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_mataisan + "laythongtinkhauhaotaisan.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                window.open($dir_module_mataisan+"xuatexceltkchitiet_theonhom.php");
            }else{
                if($tonghopcanam=="false") {
                    loadiFrame('TCPDF/baocao/inbang_bangkhauhao_taisan.php');
                }else{
                    loadiFrame('TCPDF/baocao/inbang_bangkhauhao_taisan_tonghop.php');
                }
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            if($tonghopcanam=="false") {
                window.open("TCPDF/baocao/inbang_bangkhauhao_taisan.php", "bangkekhaitaisan", "menubar=0,resizable=1");
            }else{
                window.open("TCPDF/baocao/inbang_bangkhauhao_taisan_tonghop.php", "bangkekhaitaisan", "menubar=0,resizable=1");
            }
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BẢNG PHÂN BỔ KHẤU HAO TÀI SẢN CỐ ĐỊNH"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
