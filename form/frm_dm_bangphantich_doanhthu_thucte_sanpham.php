...
<script>
    ...
    $(function () {
        ...
        function capnhatdoanhthu_thuchien_sp() {
            $TuNgay = $("#congdontuthang").val();
            $DenNgay = $("#congdondenthang").val();
            $.confirm({
                title: 'Xác nhận',
                type: 'orange',
                content: 'Bạn có chắc chắn muốn cập nhật số liệu không?',
                buttons: {
                    "Xác nhận": {
                        btnClass: 'btn-green',
                        action: function () {
                            $.confirm({
                                ...
                                type: 'green',
                                autoClose: 'OK|1000',
                                content: 'url:' + $dir_module_dmsanpham + 'capnhat_doanhthu_thuchien_sp.php?tungay='+$TuNgay+'&denngay='+$DenNgay,
                                contentLoaded: function (data, status, xhr) {
                                    this.setContentAppend('Cập nhật số liệu thành công.');
                                },
                                buttons: {
                                    "OK": {
                                        keys: ['Y'], action: function () {
                                            $("#grid_editing_cpdodang_dk").pqGrid("refreshDataAndView");
                                        }
                                    }
                                }
                            });
        ...
        var obj = {
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_dmsanpham + "list_chiphithucte_sanpham.php",//-- Load danh sách lên lưới
        ...
        function tongtiendauky() {
            ...
            $.ajax({// Kiểm tra xem STT có tồn tại hay không
                url: $dir_module_dmsanpham + "tongtien_doanhthu_thucte_sanpham.php",
                async: false,
...
<div id="dialog-sodu_cpdodang_dk"
     title="BẢNG PHÂN TÍCH DOANH THU - CHI PHÍ - SẢN PHẨM... (ENTER : Sửa và Lưu , ESC : Thoát )">
    <!-- dialog -->
