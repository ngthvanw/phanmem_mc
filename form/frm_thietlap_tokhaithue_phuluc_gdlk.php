    ...
    $(function () {
        ...
        var objtokhaiphuluc = {
            ...
            change: function (evt, ui) {// Khi dữ liệu thay đổi                
                ...
                var url = "";
                if (type == 'update') {
                    $chiphilaivay = parseInt(rowData.chiphilaivay); //1
                    $laitiengui = parseInt(rowData.laitiengui);//2
                    $laivaytrutiengui = $chiphilaivay-$laitiengui;//3
                    rowData.laivaytrutiengui = $laivaytrutiengui;//3
                    $chiphikhauhao = parseInt(rowData.chiphikhauhao);//4
                    $loinhuanthuan = parseInt(rowData.loinhuanthuan);//5
                    $ebitda = $laivaytrutiengui+$chiphikhauhao+$loinhuanthuan;//6
                    rowData.ebitda = $ebitda;//6
                    $laivayduoctru = $ebitda*0.3;//7
                    rowData.laivayduoctru = $laivayduoctru;
                    $chiphilaivaykhongduoctru = $laivaytrutiengui -$laivayduoctru //8
                    rowData.chiphilaivaykhongduoctru = $chiphilaivaykhongduoctru;//8
                    rowData.chiphilaivaykhongduoctruchuyentiep = $chiphilaivaykhongduoctru;//9

                    var valid = grid.isValid({rowData: rowData, allowInvalid: true}).valid;
                    if (valid) {
                        if (rowData[recIndx] == null) {
                            //url = $dir_module_baocaothue+"add_tokhai_thuetndn.php";
                            url = $dir_module_baocaothue + "edit_sotien_tokhai_plgdlk.php";
                        }
                        else {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Chi phí lãi vay (1)", width: 100, dataType: "integer", dataIndx: "chiphilaivay", align: "right",
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.chiphilaivay, 0, ".", ",");
                    }
                },
                {
                    title: "Lãi tiền gửi, lãi cho vay (2)", width: 100, dataType: "integer", dataIndx: "laitiengui", align: "right",
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.laitiengui, 0, ".", ",");
                    }
                },
                {
                    title: "Chi phí lãi vay trừ lãi tiền gửi, cho vay (3)=(1)-(2)", width: 100, dataType: "integer", dataIndx: "laivaytrutiengui", align: "right",editable: false,cls: 'disabled',
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.laivaytrutiengui, 0, ".", ",");
                    }
                },
                {
                    title: "Chi phí khấu hao (4)", width: 100, dataType: "integer", dataIndx: "chiphikhauhao", align: "right",editable: true,
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.chiphikhauhao, 0, ".", ",");
                    }
                },
                {
                    title: "Lợi nhuần thuần từ hoạt động SXKD trong kỳ (5)", width: 100, dataType: "integer", dataIndx: "loinhuanthuan", align: "right",editable: true,
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.loinhuanthuan, 0, ".", ",");
                    }
                },
                {
                    title: "EBITDA (6)=(3)+(4)+(5)", width: 100, dataType: "integer", dataIndx: "ebitda", align: "right",editable: false,cls: 'disabled',
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.ebitda, 0, ".", ",");
                    }
                },
                {
                    title: "Lãi vay được trừ (7)=30%x(6)", width: 100, dataType: "integer", dataIndx: "laivayduoctru", align: "right",editable: false,cls: 'disabled',
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.laivayduoctru, 0, ".", ",");
                    }
                },
                {
                    title: "Chi phí lãi vay không được trừ kỳ này (8)=(3)-(7)", width: 100, dataType: "integer", dataIndx: "chiphilaivaykhongduoctru", align: "right",editable: false,cls: 'disabled',
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.chiphilaivaykhongduoctru, 0, ".", ",");
                    }
                },
                {
                    title: "CP lãi vay không được trừ được chuyển tiếp trừ kỳ sau (9) ", width: 100, dataType: "integer", dataIndx: "chiphilaivaykhongduoctruchuyentiep", align: "right",editable: false,cls: 'disabled',
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.chiphilaivaykhongduoctruchuyentiep, 0, ".", ",");
                    }
                },
                {
                    title: "Ghi chú",
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_baocaothue + "list_tokhai_thuetndn_plgdlk.php",//-- Load danh sách lên lưới
...
<div id="dialog-thietlap_tokhai_phuluckqkd" title="THIẾT LẬP PHỤ LỤC GDLK NGHỊ ĐỊNH 132"><!-- dialog -->
