...
<div id="dialog-tangtaisan" title="GIẢM XÂY DỰNG CƠ BẢN DỞ DANG">
            ...
            <table class="table-dialog" style="vertical-align: middle;width: 100%" border="0">
                <tr>
                    ...
                    <td width="27%"><span style="padding: 2px">
                      <input type="date" name="ngayghiso" value="<?php echo date("Y-m-d") ?>" style="width:97%"
                             id="ngayghiso"
                             required="require"
            ...
            <table class="table-dialog" style="vertical-align: middle;width: 100%" border="0">
                <tr>
                    ...
                    <td style="padding: 2px"><input type="hidden" name="btnnoidung" id="btnnoidung"
                                                    class="button" value="..."/>
                        <input type="text" name="manoidung" value="_ATS04" list="listmanoidung" id="manoidung"
                        ...
                        <input name="noidung" type="text" value="Giảm do thanh lý, nhượng bán" disabled="disabled"
            ...
            <table width="100%" border="0">
                ...
                <tr>
                    ...
                    <td colspan="5"><input name="mataisan" type="text" disabled="disabled"
                                           class="text ui-widget-content ui-corner-all" id="mataisan" style="width: 20%"
                                           value=""/>
                ...
                <tr>
                    ...
                    <select name="NhomTS" class="text ui-widget-content ui-corner-all" id="NhomTS"
                ...
                </select>                    <datalist id="listNhomTS"></datalist></td>
                </tr>
                <tr>
...
///-------------------Kết thúc--------------------------------
        ...
        $(btnstt).click(function (event) {// Gọi table khách hàng để chọn
            $('.dialog_main_ds_nhapkho').load("form/frm_ds_tanggiam_cptratruoc.php?idstyle=Form-chinh&idinput=STT&idfocus=STT&loaiphieu=2&loai=xdcb");
        });
        ...
        function checkSTT(STT) {// Check key khi nhấn enter
            ...
            if ($STT == "") {//Nếu số thứ tự null sẽ tạo số mới tự động tăng theo mã
                ...
                $.ajax({
                    ...
                    data: {maps: $STT, tanggiam: 2,loai:'xdcb'},
                    async: false,
                    success: function (response) {
                        $checkphieuthuchi = $.parseJSON(response);
                    }
