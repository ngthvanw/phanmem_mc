...
<script>
    $(function () {
		...
		$("#kiemtra_doanhthu-chiphi").click(function () {
            $.confirm({
                title: 'THÔNG BÁO . ',
                type: 'green',
                columnClass: 'xlarge',
                buttons: {
                    "IN DANH SÁCH": {
                        btnClass: 'btn-blue',
                        action: function () {
                            window.open( $dir_module_kiemtradulieu + 'get_kiemtra_doanhthu_chiphi.php', "HDBHP");
                        }
                    },
                    "KẾT THÚC": {
                        btnClass: 'btn-blue',
                ...
                content: 'url:' + $dir_module_kiemtradulieu + 'get_kiemtra_doanhthu_chiphi.php',
        ...
        <tr>
            <td style="width: 50%;" valign="top">
                <fieldset>
                   ...
                   <button id="kiemtra_doanhthu-chiphi"
                           class="ui-button ui-widget ui-corner-all" style="width: 100%;margin-bottom: 2px;"><span
                               style="font-size: 16px;">KIỂM TRA DT - CHI PHÍ</span></button>
