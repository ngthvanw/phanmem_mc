...
<head>
    <meta charset="utf-8"/>
    <title>NHẬT KÝ KIỂM TRA CHỨNG TỪ</title>
...
<script>
    ...
    $(function () {
        ...
        function change_data_quit_makh() { // Cảnh báo thoát khi thay đổi dữ liệu////////////////////////////////////////////////////{
            $.confirm({
                title: 'CHÚ Ý',
                content: 'Bạn có muốn thoát khỏi cửa sổ này không ? .<br/>Nhấn phím <strong style="color:blue;">[Y]</strong> để thoát phím <strong style="color:red;">[N]</strong> để hủy bỏ',
                icon: 'fa fa-warning',
                type: 'red',
                buttons: {
                    "Đồng ý": {
                    ...
                    buttons: {
                        "Đồng ý": {
                            keys: ['Y'], action: function () {
                                ...
                                $.ajax($.extend({}, ajaxObj, {
                                    context: $grid,
                                    url: $dir_module_phieukiemtra + "del_nhatky.php",
                                    data: {id: sott, ma: ma},
        ...
        var obj = {
                ...
                if (type == 'update') {
                    ...
                    if (valid) {
                        if (rowData[recIndx] == null) {
                            ...
                            url = $dir_module_phieukiemtra + "edit_phieukiemtra.php";
                        }
                    }
                }
                if (valid) {
                        rowData.loaiphieu = '<?php echo $LoaiPhieu; ?>';
                    if(rowData.pq_cellcls.giamdocduyet=="pq-cell-dirty" && <?php echo $_SESSION['Level'] ?>=='1'){
                        rowData.nguoiduyet = '<?php echo $_SESSION['User']; ?>';
                        rowData.ngayduyet = '<?php echo date("Y-m-d H:i:s"); ?>';
                    }
                    if(rowData.pq_cellcls.giamdocduyet1=="pq-cell-dirty" && <?php echo $_SESSION['Level'] ?>=='1'){
                        rowData.nguoiduyet1 = '<?php echo $_SESSION['User']; ?>';
                        rowData.ngayduyet1 = '<?php echo date("Y-m-d H:i:s"); ?>';
                    }
                    $.ajax({
                        url: url,
                        data: rowData,
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Tháng/Quý", minWidth: 80, dataType: "string", dataIndx: "tuso",
                    editable:false,
                ...
                {
                    title: "Tiền thuế", minWidth: 100, dataType: "string", dataIndx: "gt1", align: "right",
                    editable:false,
                    render: function (ui) {
                        var gt1 = parseInt(ui.rowData.gt1);
                        var gt2 = parseInt(ui.rowData.gt2);
                        $tong = gt1+gt2;
                        return $.number($tong,0,".",",");
                    }
                },
                 {
                    title: "Chứng từ",
                    ...
                    render: function (ui) {
                        ...
                        if (value == 1) {
                            ...
                            return "KHAI THUẾ LẦN 1"
                        }else if (value == 10) {
                            return "BÁO CÁO HÓA ĐƠN"
                        }else if (value == 11) {
                            return "KHAI THUẾ BỔ SUNG"
                        }else if (value == 13) {
                            return "ĐẦU TƯ LẦN 1"
                        }else if (value == 15) {
                            return "ĐẦU TƯ BỔ SUNG"
                        }else if (value == 17) {
                            return "KK/05-TNCN LẦN 1"
                        }else if (value == 19) {
                            return "KK/05-TNCN BỔ SUNG"
                        }else if (value == 12) {
                            return "TỜ KHAI BMVT LẦN 1"
                        }else if (value == 14) {
                            return "TỜ KHAI BMVT BỔ SUNG"
                        }else if (value == 16) {
                            return "TỜ KHAI TN LẦN 1"
                        }else if (value == 18) {
                            return "TỜ KHAI TN BỔ SUNG"
                        }
                    }
                },
                {
                ...
                },
                {
                    ...
                    dataType: "integer",
                    align: "center",
                    dataIndx: "giamdocduyet1",
                    <?php echo $khoadong_nv . $khoadong_truongphong; ?>
                    <?php echo $hiden_truongphong; ?>
                    editor: {
                        type: "select", options: function (ui) {
                            //remote validation
                            var parsedJson = [{0: "CHƯA DUYỆT"}, {1: "ĐÃ DUYỆT"},{2: "LÀM LẠI"}];
                    ...
                    render: function (ui) {
                        var value = ui.rowData.giamdocduyet1;
                        if (value == '1') {
                            return "<img src='../icon/check.png' alt='Đang chờ duyệt' width='20px'/>";
                        } else if (value == '2') {
                            return "<img src='../icon/reload.png' alt='Làm lại' width='20px' />";
            ...
            dataModel: {
                ...
                url: $dir_module_phieukiemtra + "list_nhatky.php",//-- Load danh sách lên lưới
...
<div id="dialog-makhachhang"
     title="NHẬT KÝ KIỂM TRA CHỨNG TỪ (F8:XÓA)"><!-- dialog -->
