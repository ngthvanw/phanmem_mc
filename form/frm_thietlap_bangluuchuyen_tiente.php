        ...
        $("#dialog-thietlap_tokhai_phuluckqkd").keydown(function (event) {//--------------Các phím tắt
            ...
            if ($('div').hasClass('jconfirm') == false) {
                ...
                if (event.keyCode == Keys.F7) { // copy
                    $Conf = confirm("Bạn có muốn chép dữ liệu cuối kỳ năm trước vào đầu kỳ không?");
                    if ($Conf == true) {
                        $.confirm({
                            title: 'Chép dữ liệu thành công!',
                            type: 'green',
                            autoClose: 'OK|1000',
                            content: function () {
                                var self = this;
                                return $.ajax({
                                    url: $dir_module_baocaothue + "chepdulieu_dauky.php?loai=LCTT",
                                    dataType: 'json',
                                    method: 'get'
                                });
                            },
					...
					"Xác nhận": {
						...
						action: function () {
							$.confirm({
								...
								type: 'green',
								autoClose: 'OK|1000',
								content: 'url:' + $dir_module_baocaothue + 'capnhat_lctt_dauky.php',
        ...
        var objtokhaiphuluc = {
            ...
            change: function (evt, ui) {// Khi dữ liệu thay đổi
                ...
                var obj = rowList[0],
                    ...
                    type = obj.type,
                    rowData = obj.rowData;
                var column = $("#grid_editing_bangcandoi_ketoan").pqGrid("getData", {dataIndx: ['sodudk','soduck','tkno', 'tkco','maso']});
                ...
                if (type == 'update') {
                    ...
                    if (valid) {
                        if (rowData[recIndx] == null) {
                            ...
                            url = $dir_module_baocaothue + "edit_tokhai_luuchuyentiente.php";
                        }
                        else {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Năm nay", width: 50, dataType: "integer", dataIndx: "soduck", align: "right",
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.soduck, 0, ".", ",");
                    },
                    editable: function (ui) {
                        var machitieu = ui.rowData.maso;

                        if (machitieu == "" || machitieu == "20" || machitieu == "30" || machitieu == "40" || machitieu == "50" || machitieu == "70") {
                            return false;
                        } else {
                            return true;
                        }
                ...
                {
                    title: "Năm trước", width: 50, dataType: "integer", dataIndx: "sodudk", align: "right",
                    render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                        return $.number(ui.rowData.sodudk, 0, ".", ",");
                    },
                    editable: function (ui) {
                        var machitieu = ui.rowData.maso;
                        if (machitieu == ""|| machitieu == "20" || machitieu == "30" || machitieu == "40" || machitieu == "50" || machitieu == "70") {
                ...
                },
                {
                    ...
                    editable: function (ui) {
                        ...
                        //if (machitieu == "" ||  machitieu == "20" || machitieu == "30" || machitieu == "40" || machitieu == "50") {
                        // return false;
                        // } else {
                        return true;
                        // }
                ...
                {
                    title: "TK Có", dataType: "string", dataIndx: "tkco", width: 20, sortable: false,
                    editable: function (ui) {
                        var machitieu = ui.rowData.maso;
                        if (machitieu == "" ||  machitieu == "20" || machitieu == "30" || machitieu == "40" || machitieu == "50" || machitieu == "70") {
                            return false;
            ...
            dataModel: {
                ...
                url: $dir_module_baocaothue + "list_luuchuyen_tiente.php",//-- Load danh sách lên lưới
...
<div id="dialog-thietlap_tokhai_phuluckqkd" title="THIẾT LẬP BÁO CÁO LƯU CHUYỂN TIỀN TỆ (F7: CHÉP DỮ LIỆU ĐẦU KỲ)"><!-- dialog -->
