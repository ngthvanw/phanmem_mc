...
<div id="dialog-bangkekhai_taisan" title="kê khai tài sản...">
    ...
    <form method="post" id="Form-chinh" enctype="multipart/form-data">
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
                <tr style="display:none;">
                    <td style="display:none;"><input name="rd_thangtonkho" type="radio" id="rd_thangtonkho"></td>
                    <td style="display:none;">Tháng</td>
                ...
                <tr>
                    <td style="display:none;"><input name="rd_thangtonkho" type="radio" id="rd_congdonthangtonkho" checked="checked"></td>
                    <td style="display:none;">Từ ngày</td>
                    <td style="display:none;" align="right"><input type="date" name="congdontuthang" style="width:130px;" id="congdontuthang"
                                             class="text ui-widget-content ui-corner-all"
                                             value="<?php if($_SESSION['TuNgay']!=""){ echo $_SESSION['TuNgay'];}else{echo $_SESSION['NienDo'] . "-" . date("m-d");} ?>"/></td>
                    <td>Kê khai đến ngày</td>
                    <td align="right">
        ...
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
                <tr>
                    <td colspan="2"><select name="Intheothuesuat" style="width:100%;height:25px;" id="Intheothuesuat">
                      <option value="tents">Tên tài sản</option>
                      <option value="matk">Mã tài khoản</option>
                  </select></td>
                </tr>
                <tr style="display:none">
                    <td><b>Chứng từ :
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td><input name="xemchitiet" type="checkbox" id="xemchitiet"
                                           checked="checked"></td>
                                <td>Xem chi tiết nội dung hoặc bộ phận</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            $sapxepthep = $("#Intheothuesuat").val();
			valid = valid && checkNull($("#congdondenthang"), " Ngày bảng kê ");
            if (valid) {
                $('.dialog_main_thongbao').load("form/frm_insolieu_bangkekhai_taisan.php?denngay=" + $denngay + "&sapxeptheo=" + $sapxepthep);
            }
            return valid;
        }

        function xoadialog_bangketoankho() {// đóng form
            reset_dialog(".dialog-bangkekhai_taisan");
            reset_dialog(".dialog_main_bangkekhai_taisan");
        }

        dialog = $("#dialog-bangkekhai_taisan").dialog({
            autoOpen: false,
            height: "auto",
            width: $width,
            modal: true,
