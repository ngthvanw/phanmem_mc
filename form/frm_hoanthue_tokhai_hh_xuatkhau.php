		...
		var obj_makh = {
			...
			toolbar: {
                items: [
				{
                    ...
                    },
                    {
                        ...
                        listeners: [{
                            "click": function (evt) {
                                const url = $dir_module_hoanthue + "xuatexcel_tokhai_hh_xuatkhau.php";
                ...
                if (type == 'update') {                        
                    ...
                    if (valid) {
                        if (rowData[recIndx] == null) {
                            url = $dir_module_hoanthue+"add.php?loaitokhai=X";
                        }
                        else {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                { title: "Mã loại hình", dataType: "string", dataIndx: "maloaihinh", minWidth: 200,sortable: true,
                    editor: {type: "select", options: [{"": "-- CHỌN MÃ LOẠI HÌNH --"},{"B11": "B11 - Xuất kinh doanh"}, {"B12": "B12 - Xuất sau khi đã tạm xuất"}, {"B13": "B13 - Xuất khẩu hàng đã nhập khẩu"}]},
                    validations: [
                    ...
                    render: function (ui) {
                        ...
                        if ($value == "") {
                            ...
                            return "B11 - Xuất kinh doanh";
                        } else if ($value == "A12") {
                            return "B12 - Xuất sau khi đã tạm xuất";
                        }else if ($value == "B13") {
                            return "B13 - Xuất khẩu hàng đã nhập khẩu";
                        }
                    },
                    filter: {
                        type: 'textbox',
                ...
                { title: "Nước nhập khấu", minWidth: 150, dataType: "string", dataIndx: "nuocnhapkhau",hidden: false,
                    validations: [
                        {type: 'minLen', value: 1, msg: "Nước nhập khẩu không được trống !"},
                    ],
                },
			...
			dataModel: {
                ...
                location: "remote",
                recIndx: "sophieu",
                url: $dir_module_hoanthue+"list.php?loaitokhai=X",//-- Load danh sách lên lưới
...
<div id="dialog-makhachhang_Select" title="TỜ KHAI HÀNG HOÁ XUẤT KHẨU (Enter: Để chọn mã KH ,F4: Thêm , F7: Sao chép , F8: Xóa )"><!-- dialog -->
