...
<script>
    $(function () {
        $dir_module_vonchusohuu = "modules/vonchusohuu/";
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_vonchusohuu + "laythongtinkhauhaotaisan.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                window.open($dir_module_vonchusohuu+"xuatexceltkchitiet_theonhom.php");
            }else{
                loadiFrame('TCPDF/baocao/inbang_bangkechitiet_vonchusohuu.php');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
			...
			window.open("TCPDF/baocao/inbang_bangkechitiet_vonchusohuu.php","bangkekhaitaisan","menubar=0,resizable=1");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="SỐ DƯ CHI TIẾT VỐN CHỦ SỞ HŨU"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
