    ...
    $(function () {
        ...
        var obj = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Phân bổ", minWidth: 70, dataType: "integer", align: "center", dataIndx: "khauhao",
                ...
                {
                    title: "Theo dõi", minWidth: 70, dataType: "integer", align: "center", dataIndx: "theodoi",
                    editor: {type: "select",options: function (ui) {
                            //remote validation
                            var parsedJson = [ { 0:"KHÔNG"}, {1: "CÓ"}] ;
                            return parsedJson;
                ...
                },
                {
                    ...
                    editor: {type: "select",options: function (ui) {
                        ...
                        $.ajax({// Load danh sách mã khách hàng
                            ...
                            async: false,
                            data:{ma:'154,611,621,622,623,627,631,632,635,641,642,811'},
                            success: function (response) {
