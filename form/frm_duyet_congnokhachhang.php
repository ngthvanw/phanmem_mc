...
<head>
    <meta charset="utf-8"/>
    <title>DUYỆT BẢNG CÔNG NỢ KHÁCH HÀNG - <?php echo $mst . " - " . $tencongty; ?></title>
    ...
    $(function () {
        ...
        var obj = {
                ...
                if (type == 'update') {
                    ...
                    if (valid) {
                        if (rowData[recIndx] == null) {
                            url = $dir_module_user + "edit_cnkh.php";
                        }
                        else {
                            url = $dir_module_user + "edit_cnkh.php";
                        }
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Mã KH ", minWidth: 100, dataType: "string", align: "left", dataIndx: "makh", editable: false,
                ...
                {
                    title: "Mã KH cha", minWidth: 80, dataType: "string", dataIndx: "makhcha", editable: false,
                    filter: {type: 'textbox', condition: 'contain', listeners: ['keyup']}
                },
                {
                    title: "Nợ ĐK",
            ...
            dataModel: {
                ...
                url: $dir_module_user + "list_dsduyet_congno_khachhang.php",//-- Load danh sách lên lưới
...
<div id="dialog-makhachhang"
     title="DUYỆT BẢNG CÔNG NỢ KHÁCH HÀNG - <?php echo $mst . " - " . $tencongty; ?>"><!-- dialog -->
