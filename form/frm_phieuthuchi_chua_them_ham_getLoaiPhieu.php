...
// Khai báo các btntkco trên form
        ...
        function giam30theonghidinh(){
            ...
            $DenNgayGiamThue_12 = new Date("2025/01/01");
        ...
        $(btnthem).click(function (event) {// Gọi table khách hàng để chọn
			...
			if (!$kiemtrakhackykekhai && ($loaict == 1 || $loaict==2)) {
				alert("THÔNG BÁO \n Hoá đơn kê khai không cùng kỳ kê khai thuế. Vui lòng kiểm tra lại ngày kê khai.");
				$("#ngayhoadon").focus();
				return false;
			}
            {
