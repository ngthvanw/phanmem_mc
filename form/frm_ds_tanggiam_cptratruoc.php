...
$loai = $_GET['loai']; // Lấy biến để truyền vào list
if($loai=="xdcb"){
    $ten="DANH SÁCH TĂNG,GIẢM XÂY DỰNG CƠ BẢN DỞ DANG";
}else{
    $ten="DANH SÁCH TĂNG,GIẢM CHI PHÍ TRẢ TRƯỚC";
}
?>
<style>
    div.pq-grid * {
...
<script>
    ...
    $(function () {
        ...
        function addRow($grid, $obj_addrow="") {
            ...
            var mapskt =1;
            $.ajax({
                url: $dir_module_danhmuccptratruoc+"taomapskt.php",// tao mã phiếu pskt
                async: false,
                    ...
                    buttons: {
                        "Đồng ý": {
                            keys: ['Y'], action: function () {
                                ...
                                $.ajax($.extend({}, ajaxObj, {
                                    context: $grid,
                                    url: $dir_module_danhmuccptratruoc + "del.php",
                                    data: {id: sott, ma: ma},
        ...
        var obj = {
			...
			toolbar: {
                items: [
                    ...
                    },
                    {
                        ...
                        listeners: [{
                            "click": function (evt) {
                                window.open('form/frm_tai_excel_tang_giam_cptt.php', 'TaiExcelTaiSan', 'height=1000','width=2000')
                            }
                        }]
                    },
                ]
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "STT", dataType: "integer", dataIndx: "mapsts", editable: true, width: 0, hidden: false,align: "center",
                    filter: {
                        type: 'textbox',
                        condition: 'begin',
                        listeners: ['keyup']
                ...
                {
                    title: "ĐVT", minWidth: 100, dataType: "string", dataIndx: "dvt",align: "center",
                },
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                postData: {loaiphieu:<?php echo $LoaiPhieu; ?>,loai:'<?php echo $loai; ?>'},
...
<div id="dialog-ds_nhapkho"
     title="<?php echo $ten; ?>... (INSERT: chọn mã, ESC: Thoát)">
    <!-- dialog -->
