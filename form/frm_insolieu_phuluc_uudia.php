    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_baocaothue + "laythongtininphieu_tokhaithue_tndn_pluudai.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                loadiFrame('tcpdf/baocao/inbang_phuluc_uudai.php');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            window.open("tcpdf/baocao/inbang_phuluc_uudai.php","PLTHUETNDNUUDAI","menubar=0,resizable=1");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="THUẾ THU NHẬP DOANH NGHIỆP ĐƯỢC ƯU ĐÃI"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
                            <td><input type="text" name="NgayHoaDon_InPhieu_ThuChi" style="width:100%"
                                       id="NgayHoaDon_InPhieu_ThuChi" value="<?php echo " từ 01/01/".$_SESSION['NienDo']." đến 31/12/".$_SESSION['NienDo'] ;  ?>"/></td>
                        </tr>
                        <tr>
                            <td>Ngày Lập</td>
