...
<div id="dialog-bangcandoiketoan" title="BÁO CÁO TÌNH HÌNH TÀI CHÍNH...">
        ...
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
                <tr>
                  ...
                  <button onclick="$('.dialog_main_bangcandoitaikhoan').load('form/frm_thietlap_bangcangdoi_ketoan.php');" type="button" style="width:100%;border:1px solid #990" class="ui-button ui-corner-all ui-widget">Thiết lập số dư...</button>
                  </td>
                </tr>
                <tr style="display:none">
                    <td><b>Chứng từ :
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                ...
                $.ajax({// Lấy thông tin phiếu và lưu vào session
                    url: $dir_module_ketoantonghop + "them_bangcandoi_ketoan.php",
                    data: {
                        tungay: $tungay,
                        denngay: $denngay,
                        intheothuesuat: $Intheothuesuat,
                    ...
                    success: function (response) {
                        $('.dialog_main_thongbao').load("form/frm_insolieu_bangcandoiketoan.php?tungay=" + $tungay + "&denngay=" + $denngay + "&intheothuesuat=" + $Intheothuesuat + "&intheochungtu=" + $Intheochungtu + "&sapxeptheohoadon=" + $sapxeptheohoadon + "&theothongtu=" + $theothongtu + "&kieuin=" + $kieuin + "&xemchitiet=" + $xemchitiet);
                    }
                });
            }else{
                    $('.dialog_main_thongbao').load("form/frm_insolieu_bangcandoiketoan.php?tungay=" + $tungay + "&denngay=" + $denngay + "&intheothuesuat=" + $Intheothuesuat + "&intheochungtu=" + $Intheochungtu + "&sapxeptheohoadon=" + $sapxeptheohoadon + "&theothongtu=" + $theothongtu + "&kieuin=" + $kieuin + "&xemchitiet=" + $xemchitiet);
