                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if("<?php echo $congdonhanghoa; ?>"=="1")
                                window.open("tcpdf/baocao/inbangke_chitiet_hanghoa_laigop_nhapkho.php?sole=<?php echo $sole ?>","bankelaigop","menubar=0,resizable=1");
                            else
                                window.open("tcpdf/baocao/inbangke_chitiet_hanghoa_laigop_chitiet_nhapkho.php?sole=<?php echo $sole ?>","bankelaigop_chitiet","menubar=0,resizable=1");
                        }
                    }
                }
            });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BẢNG KÊ HÀNG HÓA NHẬP KHO"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
