        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                content: function(){
                    var self = this;
                    return $.ajax({
                        url: $dir_module_ketoantonghop + "xuatexcelthuyetminhtaichinh.php",
                        dataType: 'json',
                        method: 'get',
                        data: {
                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                window.open("<?php echo $_SESSION['URI']."/datafile/".$_SESSION['MST']."/".$_SESSION['NienDo'].""."/thuyetminhtaichinh.xls"; ?>");
                            }else{
                    ...
                    <table width="100%" border="0">
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="THUYẾT MINH BÁO CÁO TÀI CHÍNH"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
                        ...
                        <tr>
                          <td style="text-align:right">
                            &nbsp;&nbsp;<input type="checkbox" disabled="disabled" checked name="XuatExcel" id="XuatExcel" />
                            </td>
                          <td>Xuất excel</td>
                        </tr>
                    </table>
