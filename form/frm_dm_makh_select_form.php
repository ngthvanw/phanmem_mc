    ...
    var httk_select = function (ui) {
        ...
        var obj = {                        
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                    ...
                    { title: "Mã KH", dataType: "string", dataIndx: "makh", minWidth: 120,sortable: true,
                        validations: [
                     ...
                     { title: "Mã số thuế", minWidth: 120, dataType: "string", dataIndx: "masothue",
                     filter: {
                             type: 'textbox',
                             condition: 'begin',
                             listeners: ['keyup']
...
<div id="dialog-makhachhang_Select" title="Chọn mã khách hàng (Enter: Để chọn mã KH ,F2: Sửa , F7: Sao chép , F8: Xóa , F9: Lưu , END : Hủy dòng đang sửa)"><!-- dialog -->
