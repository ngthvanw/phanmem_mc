...
<div id="dialog-bangkekhauhao_taisan" title="Bảng kê khấu hao tài sản...">
    ...
    <form method="post" id="Form-chinh" enctype="multipart/form-data">
        ...
        <fieldset style="background-color: #afd9ee">
            <legend>Tính khấu hao tài sản theo sản lượng</legend>
            <table WIDTH="100%">
                <tr>
                    <td>
                        <button onclick="$('.dialog_main_mataisan').load('form/frm_danhsach_khauhao_sanluong.php');" type="button" style="width:100%;border:1px solid #990" class="ui-button ui-corner-all ui-widget">CHỌN TÀI SẢN TÍNH KHẤU HAO THEO SẢN LƯỢNG</button></td>
                </tr>
            </table>
        </fieldset>
         <fieldset style="background-color: #afd9ee">
