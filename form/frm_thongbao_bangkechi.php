...
<script>
    $(function () {
        ...
        $("#InPhieuNhapKho").click(function () {
            $('.dialog_main_thongtin_nhapxuatkho').load('form/frm_insolieu_bangkechitien.php?mabangke=<?php echo $mabangke; ?>');
        });
        $("#NhapBangKeNgoai").click(function () {
            xoadialog_thongbao_nhapkho();
            xoadialog_phieunhapkho();
            $('.dialog_main_dinhmuc_sanpham').load('form/frm_bangthanhtoan_tienthuengoai.php?mabangke=<?php echo $mabangke; ?>');
        });

        $("#NhapBangKeKhongHoaDon").click(function () {
            xoadialog_thongbao_nhapkho();
            xoadialog_phieunhapkho();
            $('.dialog_main_dinhmuc_sanpham').load('form/frm_bangthanhtoan_khonghoadon.php?mabangke=<?php echo $mabangke; ?>');
        });

        $("#InPhieuBienLai").click(function () {
            $('.dialog_main_thongtin_nhapxuatkho').load('form/frm_insolieu_bienlaichitien.php?mabangke=<?php echo $mabangke; ?>');
        });
        ...
        <tr>
            <td style="width: 50%;">
                <fieldset>
                    ...
                    <button id="NhapBangKeNgoai"
                            class="ui-button ui-widget ui-corner-all" style="width: 100%;margin-bottom: 2px;"><span
                                style="font-size: 16px;">Nhập bảng kê thuê ngoài...</span></button>
                    <button id="InPhieuNhapKho"
                            class="ui-button ui-widget ui-corner-all" style="width: 100%;margin-bottom: 2px;"><span
                                style="font-size: 16px;">In bảng kê chi tiền...</span></button>
                    <button  id="InPhieuBienLai"
                            class="ui-button ui-widget ui-corner-all" style="width: 100%;margin-bottom: 2px;"><span
                                style="font-size: 16px;">In biên lai chi tiền...</span></button>

                </fieldset>
            </td>
            <td style="width: 50%;padding-top: 10px;" valign="top">
                <fieldset style="padding-top: 15px;">
                    <button id="NhapBangKeKhongHoaDon"
                            class="ui-button ui-widget ui-corner-all" style="width: 100%;margin-bottom: 2px;"><span
                                style="font-size: 16px;">Nhập bảng kê không hoá đơn...</span></button>
