        ...
        var objmanhomkh = {
                ...
                items: [
                    {
                        ...
                        listeners: [{
                            "click": function (evt) {
                                $("#grid_editing_manhom_makh").pqGrid("exportCsv", {url: "export_xuatexcel.php"});
                            }
                        }]
                    }
                ]
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
					...
					validations: [
						...
						{type: 'maxLen', value: 15, msg: "Tên đăng nhập phải có từ 2 đến 15 ký tự !"},
						{
							type: function (ui) {
								...
								if (isEdit) {
									var value = ui.value,
										originalValue = ui.rowData.tendangnhap; // Lưu giá trị ban đầu
										
									// Kiểm tra xem giá trị đã thay đổi chưa
									if (value != originalValue) {
									var _found = false, sott = ui.rowData.sott;
				...
				},
                {
                    ...
                    validations: [
                        {type: 'minLen', value: 8, msg:  "Trường này phải có từ 8 đến 32 ký tự !"},
                        {type: 'maxLen', value: 32, msg: "Trường này phải có từ 8 đến 32 ký tự !"}
                        ]
                },
                {
