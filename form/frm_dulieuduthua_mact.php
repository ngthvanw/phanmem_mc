...
<div id="dialog-bangchitiet_hanghoa" title="DỮ LIỆU MÃ CÔNG TRÌNH DƯ THỪA...">
    ...
    <form method="post" id="Form-chinh" enctype="multipart/form-data">
        ...
        <fieldset style="background-color: #afd9ee">
            <legend>Chọn mã công trình cần xoá <b STYLE="color: red;">(XỬ LÝ BẢNG DỞ DANG CK TRƯỚC KHI THỰC HIỆN XOÁ DỮ LIỆU)</b></legend>
            <table border="0" style="width: 100%;">
                <tr>
                    <td colspan="2">
...
<script>
    ...
    $dir_module_masp = "modules/dmsanpham/";//----------------Lưới
    ...
    $(function () {
        ...
        var obj = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Tên CT", width: 400, dataType: "string", dataIndx: "tensp",
                    validations: [
                ...
                {
                    title: "Mã CT cha", dataType: "string", dataIndx: "maspcha", width: 120, sortable: true,
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_masp + "list_mactthua.php",//-- Load danh sách lên lưới
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                if ($InTatCaVatTu) {
                    $res = confirm("Bạn có muốn xoá tất cả mã công trình không ?");
                    if ($res) {
                        $.confirm({
                            ...
                            content: function () {
                                var self = this;
                                return $.ajax({
                                    url: $dir_module_masp + "xoadulieu_mact_duthua.php",
                                    dataType: 'json',
                                    method: 'get',
                                    data: {
                                        mavt: $mavt,
                    ...
                    $res = confirm("Bạn có muốn xoá mã công trình " + $mavt + " này không ?");
                    if ($res) {
                        $.confirm({
                            title: 'Xoá dữ liệu thành công',
                            type: 'green',
