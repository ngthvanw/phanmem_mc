...
<div id="dialog-hinhthuc_khaibaothue" title="Thiết lập chi nhánh...">
...
<script>
    ...
    $dir_module_doannghiep = "modules/doannghiep/";//----------------Lưới
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                $.ajax({
                    url: $dir_module_doannghiep+"chonchinhanh.php", // Thay dổi file
                    type: "get", // chọn phương thức gửi là get
                    dateType: "text", // dữ liệu trả về dạng text
                    data: { // Danh sách các thuộc tính sẽ gửi đi
                        ChiNhanh: $("#PhuongPhapTinhThue").val(),
                        TenCN: $("#PhuongPhapTinhThue :selected").text(),
                    },
                    success: function(result) {
                        ...
                        $.confirm({
                            title: 'Thông báo',
                            content: ' Chọn chi nhánh thành công.',
                            autoClose: 'OK|1000',
