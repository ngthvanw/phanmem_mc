        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                content: function(){
                    var self = this;
                    return $.ajax({
                        url: $dir_module_ketoantonghop + "laythongtininphieunhatkychung.php",
                        dataType: 'json',
                        method: 'get',
                        data: {
                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                ...
                                loadiFrame('tcpdf/baocao/inbang_nhatky_chung.php?sole=<?php echo $sole ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
                            window.open("tcpdf/baocao/inbang_nhatky_chung.php","sonhatkychung","menubar=0,resizable=1");
                        }
                    }
                }
            });
