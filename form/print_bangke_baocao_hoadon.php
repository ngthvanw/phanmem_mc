...
<div style="width: 500px;;" id="dialog_insolieu_nhapxuat" title="In số liệu">
    <iframe id="fred" style="border:1px solid #666CCC" title="" src="tcpdf/baocao/inbangke_tinhinh_sudung_hoadon.php?quy=<?php echo $thang; ?>"
...
<script>
    $(function () {
        ...
        dialog = $("#dialog_insolieu_nhapxuat").dialog({
            ...
            buttons: {
                    "Sổ nhật ký": function () {
                        window.open('form/frm_phieukiemtra_nhatky_tokhai_thsudunghd_window.php?loaiphieu=10','kiemtraphieuthu10','height='+(getHeight()-80)+',width='+getWidth());
                    },
                    "Phiếu kiểm tra": function () {
                        window.open('form/frm_phieukiemtra_tokhai_thsudunhd_window.php?loaiphieu=10&tuphieu=<?php echo $thang; ?>&denphieu=<?php echo $DenPhieu; ?>&gt1=<?php echo $gt1; ?>&gt2=<?php echo $gt2; ?>','kiemtraphieuthu<?php echo $LoaiPhieu; ?>','height='+(getHeight()-80)+',width='+getWidth());
                    },
                "Kết thúc": function () {
                    xoadialog_print_insolieu_thuchi();
                }
