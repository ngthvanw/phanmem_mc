    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_baocaothue + "laythongtininphieu_tokhaithue_tndn.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                window.open($dir_module_baocaothue+"xuatexceltkchitiet.php?sole=<?php echo $sole ?>");
            }else{
                loadiFrame('tcpdf/baocao/inbang_tokhaithue_tndn.php');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
			...
			window.open("tcpdf/baocao/inbang_tokhaithue_tndn.php","TKTNDN","menubar=0,resizable=1");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="TỜ KHAI QUYẾT TOÁN THUẾ THU NHẬP DOANH NGHIỆP"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
                            <td><input type="text" name="NgayHoaDon_InPhieu_ThuChi" style="width:100%"
                                       id="NgayHoaDon_InPhieu_ThuChi" value="<?php echo $_SESSION['NienDo']." từ 01/01/".$_SESSION['NienDo']." đến 31/12/".$_SESSION['NienDo'] ;  ?>"/></td>
                        </tr>
                        <tr>
                            <td>Ngày Lập</td>
