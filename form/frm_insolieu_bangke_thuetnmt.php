    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_baocaothue + "laythongtininphieukekhaithue_bvmt.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                loadiFrame('modules/baocaothue/inphieu_tokhai_phi_tn.php?<?php echo $query; ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $('.dialog_main_print').load("form/print_bangke_phi_bvmt.php?<?php echo $query; ?>");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="TỜ KHAI PHÍ BẢO VỆ MÔI TRƯỜNG (Mẫu số 01/BVMT)"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
