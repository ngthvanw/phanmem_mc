...
<style>
    ...
    <div id="dialog-tangtaisan" title="TĂNG VỐN CHỦ SỞ HỮU">
...
///-------------------Kết thúc--------------------------------
       function layngayghiso($loaiphieu){
		...
		$(btnstt).click(function (event) {// Gọi table khách hàng để chọn
            $('.dialog_main_ds_nhapkho').load("form/frm_ds_tanggiam_vondieule.php?idstyle=Form-chinh&idinput=STT&idfocus=STT&loaiphieu=1");
        });
        //---------------------End maKH--------------
        //////////Begin ma kh////////////////////////////
