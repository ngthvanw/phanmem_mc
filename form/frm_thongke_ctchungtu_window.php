...
<head>
    <meta charset="utf-8"/>
    <title>THỐNG KÊ SỐ LƯỢNG CHI TIẾT CHỨNG TỪ</title>
...
<script>
    ...
    $(function () {
        ...
        var obj = {
			...
			toolbar: {
                items: [
                    { type: 'button', icon: ' ui-icon-arrowreturnthick-1-s', label: 'QUAY LẠI THỐNG KÊ TRUY CẬP', listeners: [
                        { "click": function (evt, ui) {
								//window.href="frm_thongke_truycap_window.php";
								window.location="frm_thongke_truycap_window.php";
                        }
                        }
                    ]
                    }
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                postData: {masothue: '<?php echo $masothue; ?>',ngaynhap: '<?php echo $ngaynhap; ?>',tencongty: '<?php echo $tencongty; ?>',tendangnhap: '<?php echo $tendangnhap; ?>'},
                url: $dir_module_user + "list_ctchungtu.php",//-- Load danh sách lên lưới
...
<div id="dialog-makhachhang"
     title="THỐNG KÊ CHI TIẾT NHẬP CHỨNG TỪ"><!-- dialog -->
