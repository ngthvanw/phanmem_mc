...
$TuNgay_DenNgay = "Từ ngày ".$tungay_fm." đến ngày ".$denngay_fm;
                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                window.open($dir_module_ketoantonghop+"xuatexceltkchitiet.php?xemchitiet=<?php echo $xemchitiet ?>&denngay=<?php echo $denngay ?>");
                            }else{
                                loadiFrame('tcpdf/baocao/inbang_candoi_taikhoan.php?sole=<?php echo $sole ?>&denngay=<?php echo $denngay ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
                            window.open("tcpdf/baocao/inbang_candoi_taikhoan.php?xemchitiet=<?php echo $xemchitiet ?>&denngay=<?php echo $denngay ?>","mywindow","menubar=0,resizable=0");
                        }
                    }
                }
            });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BẢNG CÂN ĐỐI TÀI KHOẢN"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
                            <td><input type="text" name="NgayHoaDon_InPhieu_ThuChi" style="width:100%"
                                       id="NgayHoaDon_InPhieu_ThuChi" value="<?php echo $TuNgay_DenNgay;  ?>"/></td>
                        </tr>
                        <tr>
                            <td>Ngày Lập</td>
                            <td><input type="date" name="NgayLap_InPhieuThuChi" style="width:100%"
                                       value="<?php echo $denngay; ?>" id="NgayLap_InPhieuThuChi"/></td>
                        </tr>
                        <tr>
