...
<div id="dialog-capnhat_matkhau" title="THAY ĐỔI CÁC TÙY CHỌN">
    ...
    <form method="post" id="Form-CapNhap_MatKhau" enctype="multipart/form-data">
            ...
            <table class="table-dialog" border="0" cellpadding="10" cellspacing="5">
                ...
                <tr>
                    ...
                    <td width="5"><input type="checkbox" <?php if ($arr_doanhnghiep[39] == 1) echo "checked"; ?>
                                         name="duandautu" id="duandautu_frm_tuychon"/></td>
        ...
        <fieldset>
            ...
            <table class="table-dialog" border="0" cellpadding="10" cellspacing="5">
                <tr>
                    <td width="5"><input type="radio" name="checkboxdoanhnghiep" id="doanhnghieplon" checked
                                         style="margin-top: 4px;"></td>
                    <td width="130">Thông tư doanh nghiệp</td>
                    <td width="180"><select id="thongtudoanhnghieplon"  style="height: 20px;width: 100%;">
                            <option value="">---------- Chọn thông tư ----------</option>
                            <option <?php if($_SESSION['theothongtu']=="tt99"){echo 'selected=selected'; } ?> value="tt99">Theo thông tư 99 - Ngày 17/10/2025</option>
		...
		<fieldset>
            <legend><b>Khoá niên dộ</b></legend>
            <table class="table-dialog" border="0" cellpadding="10" cellspacing="5">
                <tr>
                    <td width="5"><input type="checkbox" <?php if ($arr_doanhnghiep[42] == 1) echo "checked"; ?>
                                         name="thanhtoanphidichvu" id="thanhtoanphidichvu"/></td>
                    <td width="130">Khoá niên độ hiện tại</td>
                    <td width="180"></td>
                </tr>
            </table>
        </fieldset>
...
<script>
    $(function () {
        ...
        function ChucNang_CapNhat_MatKhau() {
            ...
            if ($("#duandautu_frm_tuychon").is(":checked")) {
                $duandautu = 1;
            } else {
                $duandautu = 0;
            }
			...
			if ($("#thanhtoanphidichvu").is(":checked")) {
                $thanhtoanphidichvu = 1;
            } else {
                $thanhtoanphidichvu = 0;
            }
            ...
            if (valid) {
                $.ajax({
                    ...
                    data: { // Danh sách các thuộc tính sẽ gửi đi
                        ...
                        thanhtoanphidichvu:$thanhtoanphidichvu,
                    },
        ...
        dialog = $("#dialog-capnhat_matkhau").dialog({
            ...
            close: function(event, ui) {
                // Xóa toàn bộ hộp thoại khi nó đóng
                xoadialog();
            }
        });
