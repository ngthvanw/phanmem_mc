    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_nhapkho + "laythongtininphieunhapxuat.php",
                data: {
                    sophieu: $sophieu,
					loaiphieu: $loaiphieu,
                    tuphieu: $tuphieu,
            ...
            loadiFrame('modules/psmavattu/inphieubiennhan.php');
        ...
        $("#xemtruockhiin_insolieu_xuatkho").click(function () {
            ...
            // window.open($dir_module_manv_chamcong+'exportexcel.php?json='+encode64(parsedJson)+"&mactnhom="+(stringmact_nhom)+"&tuan="+encode64($tuan));
            $('.dialog_main_print').load("form/print_phieubiennhan.php?tuphieu="+$tuphieu+"&denphieu="+$denphieu);
        });
        ...
        $("#xuatexcel_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                ...
                async: false,
                success: function (response) {
                    window.open($dir_module_nhapkho+"xuatexcelphieuxuatkho.php?sole=<?php echo $sole ?>");
                }
            });
        });
                        ...
                        <tr>
                            ...
                            <td width="70%">
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="<?php if ($LoapPhieu == 1) echo 'BIÊN LAI THU TIỀN'; else echo 'BIÊN LAI THU TIỀN'; ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
                            <td><input type="text" name="NgayHoaDon_InPhieu_ThuChi" style="width:100%"
                                       id="NgayHoaDon_InPhieu_ThuChi" value="<?php echo date("d-m-Y",strtotime($NgayHD)); ?>"/></td>
                        </tr>
                        <tr>
                            <td>Ngày Lập</td>
