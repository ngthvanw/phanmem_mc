    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_baocaothue + "laythongtinbaocao_doisoat_hoadon_xoa_trongky.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                loadiFrame('tcpdf/baocao/inbangke_doisoat_hoadon_trongky.php?sole=<?php echo $sole ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $('.dialog_main_print').load("form/print_bangke_baocao_doisoat_hoadon_trongky.php?quy=<?php echo $denngay ?>");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BIÊN BẢN ĐỐI SOÁT HOÁ ĐƠN XOÁ TRONG KỲ"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
