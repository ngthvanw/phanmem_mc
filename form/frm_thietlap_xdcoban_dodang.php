...
<div id="dialog-tangtaisan" title="THIẾT LẬP ĐẦU KỲ XÂY DỰNG CƠ BẢN DỞ DANG">
    ...
    <form method="post" id="Form-chinh" enctype="multipart/form-data">
        ...
        <fieldset style="background-color: #afd9ee">
            <legend>Xây dựng cơ bản dở dang</legend>

            <table width="100%" border="0">

                <tr>
                    <td width="11%"><label for="name11">Tên:</label></td>
                ...
                <tr>
                    ...
                    <td width="13%"><input name="matk" type="text"
                                           ...
                                           value=""/></td>
                    <td width="13%">&nbsp;</td>
                    <td width="16%"><label for="name17">Nhóm XD:</label></td>
                    <td colspan="3"><span style="padding: 2px">
                               <select style="width: 98%;height:20px;" id="NhomTS"
                                       class="text ui-widget-content ui-corner-all">
                                 <option value="2411">Mua sắm TSCĐ</option>
                                 <option value="1536">Xây dựng cơ bản dở dang</option>
                                 <option value="2413">Sửa chữa lớn TSCĐ</option>
                               </select>
                ...
                if ($sophieu != "") {
                    ...
                    if (answer) {
                        $.ajax({
                            ...
                            data: {sophieu: $sophieu, loaiphieu: "0",loai:'xdcb'},
                            async: false,
                            success: function (response) {
                                $data = (response);
                            }
...
///-------------------Kết thúc--------------------------------
        ...
        $(btnstt).click(function (event) {// Gọi table khách hàng để chọn
            $('.dialog_main_ds_nhapkho').load("form/frm_ds_tanggiam_cptratruoc.php?idstyle=Form-chinh&idinput=STT&idfocus=STT&loaiphieu=0&loai=xdcb");
        });
        ...
        $("#btntimtaisan").click(function () {
            $('.dialog_main_danhmuc_cptratruoc').load("form/frm_danhsach_macptratruoc_form_select.php?loai=xdcb");
        });
        ...
        function checkSTT(STT) {// Check key khi nhấn enter
            ...
            if ($STT == "") {//Nếu số thứ tự null sẽ tạo số mới tự động tăng theo mã
                ...
                $.ajax({
                    ...
                    data: {maps: $STT, tanggiam: 0,loai:'xdcb'},
                    async: false,
                    success: function (response) {
                        $checkphieuthuchi = $.parseJSON(response);
                    }
