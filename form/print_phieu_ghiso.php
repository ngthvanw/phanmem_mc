...
?>
  ...
  .ui-menu{
    ...
    <div style="width: 500px;;" id="dialog-print_bangluong" title="In chứng từ ghi sổ">
            <iframe id="fred" style="border:1px solid #666CCC" title="PDF in an i-Frame" src="modules/pskghiso/inphieuthu_chi.php" frameborder="1" scrolling="auto" height="600" width="100%" ></iframe>
</div>
  <script>
...
$(function() {
        ...
        dialog.dialog("open");
    $("#dialog-print_bangluong").keydown(function (event) {//--------------Các phím tắt
