                        ...
                        <table width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td><input style="text-transform: uppercase" type="text" name="kyhieu" value="<?php echo $_SESSION['txt_kyhieu'] ?>"
                                           id="kyhieu" maxlength="10" required="require"
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="sohoadon" value="" id="sohoadon" required="require"
                                           placeholder="Số hóa đơn" maxlength="12" class="text ui-widget-content ui-corner-all"/></td>
                            </tr>
                            <tr>
                ...
                <tr>
                    ...
                    <td style="padding: 2px">
                        <table width="100%" border="0">
                            <tr>
                                <td width="9%">
                                    <input type="button" name="btntkno2" id="btntkno2" class="button"
                                                      value="..."/></td>
...
/// bắt dầu mã bộ phận
		...
		function getLoaiPhieu(tkco, isPhieuThu) {
			// Bản đồ ánh xạ giá trị tkco -> LoaiPhieu cho Phiếu Thu
			const loaiPhieuMapThu = {
			...
			// Bản đồ ánh xạ giá trị tkco -> LoaiPhieu cho Phiếu Chi
			const loaiPhieuMapChi = {
			...
			// Giá trị mặc định
			const defaultLoaiPhieu = isPhieuThu ? 1 : 2;
			// Chọn bản đồ phù hợp
			const map = isPhieuThu ? loaiPhieuMapThu : loaiPhieuMapChi;
			// Trả về giá trị tương ứng hoặc mặc định nếu không tìm thấy
			return map[tkco] || defaultLoaiPhieu;
		}
///-------------------------Di chuyễn các phần tử bằng enter----------------
        ...
        $("#chonloaisp").focusout(function (event) {// Gọi table mã nội dung để chọn
			...
			if (phieuthu.is(":checked")) {
				$LoaiPhieu = getLoaiPhieu($tkco, true); // Phiếu Thu
			}
			if (phieuchi.is(":checked")) {
				$LoaiPhieu = getLoaiPhieu($tkco, false); // Phiếu Chi
			}
                ...
                if (valid) {
                    $.ajax({
                        ...
                        data: { // Danh sách các thuộc tính sẽ gửi đi
                            ...
                            makhachhang3: makhachhang.val().trim(),
                            tenkhachhang3: tenkhachhang.val().trim(),
                        ...
                        success: function (result) {
                            ...
                            if ($LoaiPhieu%2==0 && (tkno1.val().trim().substring(0,3) == "211"|| tkno2.val().trim().substring(0,3) == "211" || (tkno1.val().trim().substring(0, 3) == "212") || (tkno2.val().trim().substring(0, 3) == "212") || (tkno1.val().trim().substring(0,3) == "242") || (tkno1.val().trim().substring(0,3) == "241") || tkno1.val().trim() == "1562")) {
