        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                content: function(){
                    var self = this;
                    return $.ajax({
                        url: $dir_module_ketoantonghop + "laythongtinsocai_tinhhinh_thanhtoan_ngansach.php",
                        dataType: 'json',
                        method: 'get',
                        data: {
                        ...
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                ...
                                if(<?php echo $congdontheosocai ?>=="0"){
                                    loadiFrame('tcpdf/baocao/inbangke_sochitiet_tinhhinh_thanhtoan_ngansach.php?congdontheosocai=<?php echo $congdontheosocai ?>');
                                }else{
                                    loadiFrame('tcpdf/baocao/inbangke_sochitiet_tinhhinh_thanhtoan_ngansach.php?congdontheosocai=<?php echo $congdontheosocai ?>');
                                }
            ...
            $.confirm({
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
                            if(<?php echo $congdontheosocai ?>=="0"){
                                window.open("tcpdf/baocao/inbangke_sochitiet_tinhhinh_thanhtoan_ngansach.php?congdontheosocai_nopnsnn=<?php echo $congdontheosocai ?>","sotheodoithuegtgt","menubar=0,resizable=0");
                            }else{
                                window.open("tcpdf/baocao/inbangke_sochitiet_tinhhinh_thanhtoan_ngansach.php?congdontheosocai_nopnsnn=<?php echo $congdontheosocai ?>","sotheodoithuegtgt","menubar=0,resizable=0");
                            }
                        }
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="SỔ CHI TIẾT THEO DÕI THUẾ GTGT "/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
