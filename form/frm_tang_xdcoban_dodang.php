...
<div id="dialog-tangtaisan" title="TĂNG XÂY DỰNG CƠ BẢN DỞ DANG">
          ...
          <table width="100%" border="0">
              ...
              <tr>
                  ...
                  <td width="13%"><input name="matk" type="text"
                               ...
                               <td width="13%">&nbsp;</td>
                                <td width="16%"><label for="name17">Nhóm:</label></td>
                ...
                if($sophieu!=""){
                    ...
                    if (answer){
                        $.ajax({
                            ...
                            data: {sophieu:$sophieu,loaiphieu:"1",loai:'xdcb'},
                            async: false,
                            success: function (response) {
                                $data = (response);
                            }
...
///-------------------Kết thúc--------------------------------
       function layngayghiso($loaiphieu){
        ...
        $(btnstt).click(function (event) {// Gọi table khách hàng để chọn
            $('.dialog_main_ds_nhapkho').load("form/frm_ds_tanggiam_cptratruoc.php?idstyle=Form-chinh&idinput=STT&idfocus=STT&loaiphieu=1&loai=xdcb");
        });
            ...
            if ($STT == "") {//Nếu số thứ tự null sẽ tạo số mới tự động tăng theo mã
                ...
                $data = "";
                    $.ajax({
                        ...
                        data: {maps: $STT,tanggiam:1,loai:'xdcb'},
                        async: false,
                        success: function (response) {
                            $checkphieuthuchi = $.parseJSON(response);
                        }
