            ...
            toolbar: {
                items: [
                    ...
                    },
                    {
                        ...
                        listeners: [{
                            "click": function (evt) {
                                window.open('form/frm_tai_excel_mact_window.php', 'updatedata', 'height=1000','width=2000')
                            }
                        }]
                    }
                ]
...
$grid.pqGrid( "removeClass", {rowIndx: rowIndx, cls: 'rownotsave'} );
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Ngày khởi công", minWidth: 150, dataType: "string", dataIndx: "ngaykhoicong",align: "right",
                    render: function (ui) {
                ...
                {
                    title: "Ngày hoàn thành", minWidth: 150, dataType: "string", dataIndx: "ngayhoanthanh",align: "right",
                    render: function (ui) {
                ...
                {
                    title: "Máy", minWidth: 150, dataType: "string", dataIndx: "may",align: "right", hidden: false,
                    render: function (ui) {
...
<div id="dialog-danhmuc_sanpham" title="DANH MỤC CÔNG TRÌNH (ENTER : SỬA VÀ LƯU , F7: SAO CHÉP , F8: XÓA , ESC : THOÁT)">
    <!-- dialog -->
