...
<div id="dialog-bangchitiet_socai" title="SỔ THEO DÕI CHI TIẾT THUẾ GTGT...">
                ...
                <tr>
                    ...
                    <td align="right">
                        <input type="date" name="congdondenthang" id="congdondenthang" style="width:130px;"
                               class="text ui-widget-content ui-corner-all"
                               value="<?php if($_SESSION['DenNgay']!=""){ echo $_SESSION['DenNgay'];}else{echo $_SESSION['NienDo'] . "12-31";} ?>"/></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
            </table>
        ...
        <fieldset style="background-color: #afd9ee;display: none;">
          <legend>Chọn tài khoản           </legend>
            <table border="0" style="width: 100%;">
                ...
                <tr>
                    <td><b>Lọc theo bộ phận:

                        </b><input type="hidden" id="mavattu" value="33311"/></td>
                    <td>
                ...
                <tr >
                    ...
                    <td><select name="sapxep" id="sapxep" style="width:100%;height:25px;">
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                $('.dialog_main_thongbao').load("form/frm_insolieu_bangchitiet_tinhhinh_thanhtoan_nsnc.php?tungay=" + $tungay + "&denngay=" + $denngay + "&sapxep=" + $sapxep+"&matk=" + $mavt+"&theobophan=" + $theobophan+"&theonoidung=" + $noidung+"&congdonsocai=" + $congdonsocai);
            }
