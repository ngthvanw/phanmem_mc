...
$grid.pqGrid( "addClass", {rowIndx: rowIndx, cls: 'rownotsave'} );
		...
		var objmavt = {
                ...
                items: [
                    {
                        ...
                        listeners: [{
                            "click": function (evt) {
                                $("#grid_editing_mavt").pqGrid("exportCsv", {url: "export_xuatexcel.php"});
                            }
                        }]
                    }
                ]
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                { title: "Lưu", dataType: "integer", dataIndx: "sott", editable: false, width: 20, hidden:false,align: "center",
                    render: function (ui) {
                    ...
                    },
                {
                    ...
                    { title: "Mã TK", minWidth: 60, dataType:"string", dataIndx: "matk", align: "center",
					editor: {
        		            type: "number"
        		    },
                         validations: [
                ...
                { title: "TK doanh thu", minWidth: 60, dataType:"string", dataIndx: "tkdoanhthu", align: "center",
					editor: {
        		            type: "number"
        		    },
                    validations: [
                ...
                { title: "Giá vốn", minWidth: 120, dataType: "string", align: "right", dataIndx: "giamua",hidden:true,
                    editor: {
                        type: formart_num
                    },
                    validations: [
        ...
        $grid.one("pqgridload", function (evt, ui) {
			...
			$("#grid_editing_mavt .pq-search-hd-field[name='tenvt']").focus();
...
<div id="dialog-mavattu" title="Danh mục vật tư, hàng hóa... (k: hàng hóa không chịu thuế)(F4: Thêm , F7: Sao chép , F8: Xóa )"><!-- dialog -->
