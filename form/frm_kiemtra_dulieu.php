...
<script>
    $(function () {
        ...
        $("#check_khachhang_chacon").click(function () {
		 ...
		 $("#check_khachhang_khongtontai").click(function () {
            $.confirm({
                title: 'THÔNG BÁO . ',
                type: 'green',
				columnClass: 'xlarge',
                ...
                content: 'url:' + $dir_module_kiemtradulieu + 'kiemtra_khachhang_khongtontai.php',
                contentLoaded: function (data, status, xhr) {
		...
		$("#check_mavt_khongtontai").click(function () {
            $.confirm({
                title: 'THÔNG BÁO . ',
                type: 'green',
				columnClass: 'xlarge',
                ...
                content: 'url:' + $dir_module_kiemtradulieu + 'kiemtra_mavt_khongtontai.php',
                contentLoaded: function (data, status, xhr) {
		...
		$("#check_khachhang_khonggiongnhau").click(function () {
            $.confirm({
                title: 'THÔNG BÁO . ',
                type: 'green',
				columnClass: 'xlarge',
                ...
                content: 'url:' + $dir_module_kiemtradulieu + 'kiemtra_khachhang_khonggiongnhau.php',
                contentLoaded: function (data, status, xhr) {
        ...
        $("#kiemtrahoadon_bathopphap").click(function () {
		 ...
		 $("#kiemtrahoadon_trung").click(function () {
            $.confirm({
                title: 'THÔNG BÁO . ',
                type: 'green',
                columnClass: 'xlarge',
                buttons: {
                    "IN DANH SÁCH": {
                        btnClass: 'btn-blue',
                        action: function () {
                            window.open( $dir_module_kiemtradulieu + 'kiemtra_trung_hoadon_gtgt.php', "HDBHP");
                        }
                    },
                    "KẾT THÚC": {
                        btnClass: 'btn-blue',
                ...
                content: 'url:' + $dir_module_kiemtradulieu + 'kiemtra_trung_hoadon_gtgt.php',
                contentLoaded: function (data, status, xhr) {
        ...
        <tr>
            <td style="width: 50%;" valign="top">
                <fieldset>
					...
					<button id="check_khachhang_khongtontai"
                            class="ui-button ui-widget ui-corner-all ui-state-hover"
                            style="width: 100%;margin-bottom: 2px;"><span style="font-size: 16px;">Kiểm tra khách hàng không tồn tại</span>
                    </button>
					
					<button id="check_mavt_khongtontai"
                            class="ui-button ui-widget ui-corner-all ui-state-hover"
                            style="width: 100%;margin-bottom: 2px;"><span style="font-size: 16px;">Kiểm tra hàng hoá không tồn tại</span>
                    </button>
					
					<button id="check_khachhang_khonggiongnhau"
                            class="ui-button ui-widget ui-corner-all ui-state-hover"
                            style="width: 100%;margin-bottom: 2px;"><span style="font-size: 16px;">Kiểm tra khách hàng không giống nhau trong cùng phiếu</span>
                    </button>
            ...
            <td valign="top" style="width: 50%;">
                <fieldset>
                    ...
                    <button id="kiemtrahoadon_trung"
                            class="ui-button ui-widget ui-corner-all" style="width: 100%;margin-bottom: 2px;"><span
                                style="font-size: 16px;">Trùng hoá đơn GTGT</span></button>
