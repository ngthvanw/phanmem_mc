...
<div style="width: 500px;;" id="dialog_insolieu_nhapxuat" title="In số liệu ">
    <iframe id="fred" style="border:1px solid #666CCC" title="" src="TCPDF/baocao/inphieu_tokhai_thuegtgt_theopp_hkd.php?<?php echo $query; ?>&nhomnganh=<?php echo substr($ppkhautru, 4, 1) ?>"
