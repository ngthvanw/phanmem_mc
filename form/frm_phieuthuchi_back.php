        ...
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" class="table-dialog" style="vertical-align: middle;width: 780PX">
                <tr>
                    ...
                    <td width="17%">
                        <input type="text" name="STT" id="STT" value="" style="width: 100%"
...
///-------------------------Di chuyễn các phần tử bằng enter----------------
        ...
        function checkSoHoaDonTrung_Vuot($LoaiPhieu) {// Check khi vượt 20tr trên 1 ngày
            ...
            $tk = $("#tkco").val().trim();
            if ($LoaiPhieu == 2 && ($loaict == 1 || $loaict == 2)) {
                $.ajax({
...
// Khai báo các btntkco trên form
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            {
                alert("CHÚ Ý \n\n  Ngày ghi sổ không nằm trong năm tài chính <?php echo $_SESSION['NienDo']; ?> ! Vui lòng nhập lại .");
                return false;
            }
            $loitk = true;
            if(($tkco.substring(0,3)!=111 && $tkco.substring(0,3)!=112) && $loitk ){
...

            {
                ...
                if ("<?php echo $_SESSION['thietlaphddt'] ?>" == "1") {
                    if (valid && $LoaiPhieu == 1 && $LoaiCT == '1' && $hoadondientu != 0 && $hoadondientu != 9 && $loaitokhai == '1' && "<?php echo $_SESSION['txt_hddt_tendangnhap'] ?>" != "" && "<?php echo $_SESSION['txt_hddt_matkhau'] ?>" != "" && "<?php echo $_SESSION['txt_hddt_duongdan'] ?>" != "") {// Nếu là phiếu chi và loại chứng từ là thuế GTGT thì thực hiện lập hoá đơn điện tử
                        $res = {
                ...
                if (valid) {
                    $.ajax({
                        ...
                        success: function (result) {
                            if ($LoaiPhieu%2==0 && (tkno1.val().trim() == "2111" || tkno1.val().trim() == "2112" || tkno1.val().trim() == "2113" || tkno2.val().trim() == "2111" || tkno2.val().trim() == "2112" || tkno2.val().trim() == "2113" || tkno1.val().trim().substring(0, 3) == "242" || tkno1.val().trim() == "1562")) {
