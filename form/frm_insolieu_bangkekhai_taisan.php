    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            if($("#XuatExcel").prop("checked") == true){
                window.open($dir_module_mataisan+"xuatexceltkchitiet.php?sole=<?php echo $sole ?>");
            }else{
                loadiFrame('tcpdf/baocao/inbang_bangkekhai_taisan.php?denngay=<?php echo $denngay; ?>&sapxeptheo=<?php echo $sapxeptheo; ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            //$('.dialog_main_print').load("form/print_bangcandoi_taikhoan.php?keuin?=<?php echo $kieuin; ?>");
			window.open("tcpdf/baocao/inbang_bangkekhai_taisan.php?denngay=<?php echo $denngay; ?>&sapxeptheo=<?php echo $sapxeptheo; ?>","bangketaisancodinh","menubar=0,resizable=0");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BẢNG KÊ KHAI TÀI SẢN CỐ ĐỊNH"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
                            <td><input type="text" name="NgayHoaDon_InPhieu_ThuChi" style="width:100%"
                                       id="NgayHoaDon_InPhieu_ThuChi" value="<?php echo 'Tính đến ngày: '.$denngay_fm;  ?>"/></td>
                        </tr>
                        <tr>
                            <td>Ngày Lập</td>
