    ...
    $(function () {
            ...
            if ($('div').hasClass('jconfirm') == false) {
                ...
                if (event.keyCode == Keys.INSERT) { // Xóa
                    ...
                    if($sott==0 || $sott=="" || typeof $sott == 'undefined'){
                        alert("Tài sản này chưa được lưu, vui lòng lưu dữ liệu trước khi chọn tài sản ! ");
                        return false;
                    }
                    $("#mataisan").val(rowData.mats);
                    $("#tentaisan").val(rowData.tents);
                    $("#NhomTS").val(rowData.manhomts);
                    $("#congsuat").val(rowData.congsuat);
                    $("#nuocsanxuat").val(rowData.nuocsx);
        ...
        var obj = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                { title: "Lưu", dataType: "integer", dataIndx: "sott", editable: false,align: "center", width: 10, hidden:false,align: "center",
                    render: function (ui) {
                ...
                {
                    title: "Mã TK-CP", minWidth: 100, dataType: "string", dataIndx: "matk",align: "center", editable: true,
                    validations: [
                ...
                {
                    title: "Nhóm TS", minWidth: 100, dataType: "string", align: "center", dataIndx: "manhomts", editable: true,
                    validations: [
                        {type: 'minLen', value: 1, msg: "Đơn vị tính không được trống !"},
                    ],
                    editor: {type: "select",options: function (ui) {
                ...
                {
                    title: "Mã TK giảm", minWidth: 100, dataType: "string", dataIndx: "matkgiam",align: "center", editable: true,
                    validations: [
                        {
                            type: function (ui) {
                                var value = ui.value,
