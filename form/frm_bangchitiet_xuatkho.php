...
//change edit button to update button and delete to cancel.
        ...
        objxuatkho.render = function (evt, ui) {
            $summary = $("<div class='pq-grid-summary'  ></div>")
                .prependTo($(".pq-grid-bottom", this));
            calculateSummary();
        }

        objxuatkho.cellSave = function (evt, ui) {
            objxuatkho.refresh.call(this);
        }
        objxuatkho.refresh = function (evt, ui) {
            calculateSummary();
            var data = [totalData]; //2 dimensional array
            var objxuatkho = { data: data, $cont: $summary }
            $(this).pqGrid("createTable", objxuatkho);
        }
...
<div id="dialog-bangchitiet_nhapkho"title="Nhập đơn giá, số lượng hàng hóa vật tư (ESC: Thoát , F4: Thêm, INSERT: Lấy danh sách, F2: Chuyển đổi )">
    <!-- dialog -->
