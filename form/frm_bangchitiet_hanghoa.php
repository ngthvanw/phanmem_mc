...
<div id="dialog-bangchitiet_hanghoa" title="Sổ chi tiết vật tư,hàng hóa...">
    ...
    <form method="post" id="Form-chinh" enctype="multipart/form-data">
        <fieldset style="background-color: #afd9ee">
            ...
            <table border="0" style="width: 100%;">
                ...
                <tr>
                    <td><input name="rd_LocTheo" value="theokho" checked="checked" type="radio" id="rd_LocTheoKho" /></td>
                    <td><b>Loại sổ :</b></td>
                    <td align="right">
                        <select name="LocTheoLoaiSo" style="width:100%;height:25px;" id="LocTheoLoaiSo">
                            <option value="1">Sổ chi tiết vật tư, hàng hóa</option>
                            <option value="2">Sổ chi tiết bán hàng</option>
                        </select></td>
                    <td>&nbsp;</td>
                    <td align="right">&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr  style="display:block;">
                    <td colspan="2">
                        <table style="width: 100%">
                            <tr>
                                <td><input name="xemchitiet" type="checkbox" id="xemchitiet"
                                           checked="checked"></td>
                                <td>&nbsp;In cột tồn</td>
                                <td><input type="hidden" id="mavattu" /></td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
        ...
        <fieldset style="background-color: #afd9ee;">
            <legend>In tất cả vật tư,hàng hoá</legend>
            <table>
                <tr>
                    <td><input type="checkbox" name="InTatCaVatTuHangHoa" id="InTatCaVatTuHangHoa"></td>
                    <td>&nbsp;In tất cả vật tư,hàng hoá</td>
                </tr>
            </table>
        </fieldset>
    </form>
    ...
    $(function () {
        ...
        var obj = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                { title: "Mã VT", dataType: "string", dataIndx: "mavt", width: 150,sortable: true,
                ...
                { title: "Tên VT", width: 400, dataType: "string", dataIndx: "tenvt",
                    validations: [
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
			...
			$mavt=$("#mavattu").val();
            $InTatCaVatTu = $("#InTatCaVatTuHangHoa").prop("checked");
			if($mavt=="" && $InTatCaVatTu==false){
				alert("Chưa chọn hàng hóa, vật tư");
				valid=false;
			}
            $xemchitiet=0;
            ...
            $LocTheoLoaiSo = $("#LocTheoLoaiSo").val();
            if (valid) {
                $('.dialog_main_thongbao').load("form/frm_insolieu_bangchitiet_hanghoa.php?tungay=" + $tungay + "&denngay=" + $denngay + "&xemchitiet=" + $xemchitiet+"&mavt=" + encodeURIComponent($mavt)+"&intatcatvattu=" + $InTatCaVatTu+ "&loctheoloaiso=" + $LocTheoLoaiSo);
            }
        ...
        function xoadialog_bangketoankho() {// đóng form
            reset_dialog(".dialog-bangchitiet_hanghoa");
            reset_dialog(".dialog_main_bangchitiet_hanghoa");
        }

        dialog = $("#dialog-bangchitiet_hanghoa").dialog({
            autoOpen: false,
            height: $height,
            width: $width,
            modal: true,
