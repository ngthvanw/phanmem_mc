        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                content: function(){
                    var self = this;
                    return $.ajax({
                        url: $dir_module_dmsanpham + "laythongtin_phanbo_chiphichung_congtrinh.php",
                        dataType: 'json',
                        method: 'get',
                        data: {
                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                ...
                                loadiFrame('tcpdf/baocao/inbang_phanbo_chiphisxchung_congtrinh.php?sole=<?php echo $sole ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
                            window.open("tcpdf/baocao/inbang_phanbo_chiphisxchung_congtrinh.php?phuongphapphanbo=<?php echo $phuongphapphanbo ?>","mywindow","menubar=0,resizable=0");
                        }
                    }
                }
            });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BẢNG PHÂN BỔ CHI PHÍ SẢN XUẤT CHUNG"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
