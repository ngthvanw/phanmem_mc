    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_ketoantonghop + "laythongtinsocai_ngoaite.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                if(<?php echo $congdontheosocai ?>=="0"){
                    loadiFrame('tcpdf/baocao/inbangke_sochitiet_soquy_ngoaite.php?congdontheosocai=<?php echo $congdontheosocai ?>');
                }else{
                    loadiFrame('tcpdf/baocao/inbangke_sochitiet_soquy_ngoaite.php?congdontheosocai=<?php echo $congdontheosocai ?>');
                }
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            if(<?php echo $congdontheosocai ?>=="0"){
                window.open("tcpdf/baocao/inbangke_sochitiet_soquy_ngoaite.php?congdontheosocai=<?php echo $congdontheosocai ?>","insoquy_ngoaite","menubar=0,resizable=0");
            }else{
                window.open("tcpdf/baocao/inbangke_sochitiet_soquy_ngoaite.php?congdontheosocai=<?php echo $congdontheosocai ?>","insoquy_ngoaite","menubar=0,resizable=0");
            }
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="SỔ CHI TIẾT THEO DÕI NGOẠI TỆ"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
