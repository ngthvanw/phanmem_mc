    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_baocaothue + "laythongtininphieu_tokhaithue_tndn_plchuyenlo.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                loadiFrame('tcpdf/baocao/inbang_phuluc_chuyenlo.php');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            window.open("tcpdf/baocao/inbang_phuluc_chuyenlo.php","PLCHUYENLO","menubar=0,resizable=1");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="CHUYỂN LỖ TỪ HOẠT ĐỘNG SXKD"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
