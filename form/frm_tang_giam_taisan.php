...
<div id="dialog-bangkekhai_taisan" title="Bảng kê tăng/giảm tài sản...">
            ...
            <table border="0" style="width: 100%;">
                <tr>
                    <td colspan="2"><select name="Intheothuesuat" style="width:100%;height:25px;" id="Intheothuesuat">
                      ...
                      <option value="mabp">Bộ phận</option>
                  </select></td>
                </tr>
                <tr style="display:none">
                    <td><b>Chứng từ :
...
///-------------------Kết thúc--------------------------------
        ...
        function ChucNang_ThuChi() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                $('.dialog_main_thongbao').load("form/frm_insolieu_bangketang_giam_taisan.php?denngay=" + $denngay + "&sapxeptheo=" + $sapxepthep);
            }
