            ...
            if ($tonghopcanam == false) {
                ...
                for ($i = $tuthang; $i <= $denthang; $i++) {
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: {tuthang: $i, denthang: $i, tonghopcanam: $tonghopcanam,khongtaobuttoandinhkhoan:$khongtaobuttoandinhkhoan,xoakhauhaodatrichtrongky:$xoakhauhaodatrichtrongky},
                        method: 'get',
                        async: false,
