                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                ...
                                loadiFrame('tcpdf/baocao/inbang_phantich_xacdinh_kqkd.php');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
                            window.open("tcpdf/baocao/inbang_phantich_xacdinh_kqkd.php","xacdinh_kqkd","menubar=0,resizable=1");
                        }
                    }
                }
            });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BẢNG PHÂN TÍCH KẾT QUẢ HOẠT ĐỘNG KINH DOANH"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
