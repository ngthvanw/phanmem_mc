...
<div id="dialog-tangtaisan" title="GIẢM CHI PHÍ TRẢ TRƯỚC">
...
///-------------------Kết thúc--------------------------------
        ...
        $(btnstt).click(function (event) {// Gọi table khách hàng để chọn
            $('.dialog_main_ds_nhapkho').load("form/frm_ds_tanggiam_cptratruoc.php?idstyle=Form-chinh&idinput=STT&idfocus=STT&loaiphieu=2&loai=ccdc");
        });
