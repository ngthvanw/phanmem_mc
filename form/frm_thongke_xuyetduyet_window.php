...
<head>
    <meta charset="utf-8"/>
    <title>THÔNG KÊ TỔNG HỢP DUYỆT HỒ SƠ</title>
...
<script>
    ...
    $(function () {
        ...
        var obj = {
            ...
            toolbar: {
                items: [
                    { type: 'button', icon: ' ui-icon-arrowreturnthick-1-s', label: 'QUAY LẠI THÔNG KÊ TRUY CẬP', listeners: [
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                },
				{
					...
					render:function( ui ){
						...
						return "<a style='color:blue;' href='frm_thongke_ctduyeths_window.php?masothue="+$masothue+"&tendangnhap="+$nguoinhap+"&tencongty="+$tencongty+"&loaiphieu=9'>"+$val+"</a>"
					}
                }
                ,
                {
            ...
            dataModel: {
                ...
                url: $dir_module_user + "list_thongke_duyeths.php",//-- Load danh sách lên lưới
...
<div id="dialog-makhachhang"
     title="THÔNG KÊ TỔNG HỢP DUYỆT HỒ SƠ"><!-- dialog -->
