                 ...
                 if ($Conf == true) {
                     $.confirm({
                         ...
                         content: function () {
                             var self = this;
                             return $.ajax({
                                 url: $dir_module_baocaothue + "chepdulieu_dauky.php?loai=XDKQKD",
                                 dataType: 'json',
                                 method: 'get'
                             });
                         },
				...
				"Xác nhận": {
					...
					action: function () {
						$.confirm({
							...
							type: 'green',
							autoClose: 'OK|1000',
							content: 'url:' + $dir_module_baocaothue + 'capnhat_kqkd_dauky.php',
            ...
            change: function (evt, ui) {// Khi dữ liệu thay đổi                
                ...
                var rowList = ui.rowList,
                    ...
                    var obj = rowList[0],
                        ...
                        type = obj.type,
                        rowData = obj.rowData;
                var column = $("#grid_editing_bangcandoi_ketoan").pqGrid( "getData", { dataIndx: ['sotiendk', 'machitieu','matk','tkno'] } );
					...
					if (type == 'update') {                        
						...
						if(rowData.mavt==""){
                            ...
                            if (rowData[recIndx] == null) {
                                ...
                                url = $dir_module_baocaothue+"edit_sotien_tokhai_xdkqkd.php";
                            }
                            else {
...
colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                    ...
                    { title: "STT", dataType: "string",editable: false, dataIndx: "maso", width: 40,sortable: false,hidden:true,
                     },
					...
					{ title: "Mã chỉ tiêu",editable: false, dataType: "string", dataIndx: "machitieu", width: 40,sortable: true,align:"center"},
                    { title: "Số tiền", width: 50, dataType: "integer", dataIndx: "sotiendk",align:"right",
                        render: function (ui) {// Tính toán Tiền thuế và đưa lên lưới
                            //return FormatNumber(ui.rowData.sotiendk.toString());
                            return $.number(ui.rowData.sotiendk,0,".",",");
                        },
                    ...
                    { title: "Mã Chỉ tiêu cha",editable: false, width: 30, dataType: "string", align: "left", dataIndx: "machitieucha",sortable: false
                    },
...
<div id="dialog-thietlap_tokhai_phuluckqkd" title="THIẾT LẬP SỐ DƯ ĐẦU KỲ XÁC ĐỊNH KQKD"><!-- dialog -->
