            ...
            if ($('div').hasClass('jconfirm') == false) {
                ...
                if (event.keyCode == Keys.INSERT) { // Xóa
                    ...
                    if($sott==0 || $sott=="" || typeof $sott == 'undefined'){
                        alert("Sản phẩm chưa được lưu, vui lòng lưu dữ liệu trước khi chọn sản phẩm ! ");
                        return false;
                    }
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                    ...
                    },},
                {
                    ...
                    validations: [
                        ...
                        {type: 'maxLen', value: 20, msg: "Mã sản phảm không lớn hơn 20 ký tự !"},
                ...
                {
                    title: "ĐVT", minWidth: 70, dataType: "string", dataIndx: "dvt", align: "center",
                    validations: [
                ...
                {
                    title: "GT hợp đồng", minWidth: 150, dataType: "integer", dataIndx: "gthopdong", align: "right",hidden: true,
                    render: function (ui) {
                ...
                {
                    title: "Ngày khởi công",hidden: true,
                    minWidth: 150,
                    dataType: "string",
                ...
                {
                    title: "Ngày hoàn thành",hidden: true,
                    minWidth: 150,
                    dataType: "string",
                ...
                {
                    title: "Năm SX", minWidth: 150, dataType: "string", dataIndx: "namsx", align: "right",
                    render: function (ui) {
                ...
                {
                    title: "Quyết toán", minWidth: 50, dataType: "string", dataIndx: "quyettoan",hidden: true,
                    editor: {
                ...
                {
                    title: "Loại SP", minWidth: 20, dataType: "string", dataIndx: "loaisp", align: "right",hidden: true,
                },
                {
                    title: "Mô tả", width: 150, dataType: "string", align: "right", dataIndx: "ghichu",
                    editor: {type: "textarea", attr: "rows=3"}
                }
...
<div id="dialog-danhmuc_sanpham" title="CHỌN DANH MỤC SẢM PHẨM (INSERT : CHỌN, ENTER : SỬA VÀ LƯU , F7: SAO CHÉP , F8: XÓA , ESC : THOÁT)"">
    <!-- dialog -->
