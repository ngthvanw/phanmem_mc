    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_mataisan + "laythongtinbangketang_giamtaisan.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                loadiFrame('tcpdf/baocao/inbang_bangkekhai_tanggiam_taisan.php?denngay=<?php echo $denngay; ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
			...
			window.open("tcpdf/baocao/inbang_bangkekhai_tanggiam_taisan.php?denngay=<?php echo $denngay; ?>","bangketaisancodinh","menubar=0,resizable=0");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BẢNG KÊ KHAI TĂNG/GIẢM TÀI SẢN CỐ ĐỊNH"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
