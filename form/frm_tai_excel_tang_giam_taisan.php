    ...
    if (isset($_FILES['excel_file'])) {
        ...
        if ($xlsx = SimpleXLSX::parse($file)) {
            ...
            for ($i = 2; $i < $count_data; $i++) {
                ...
                $sql = "INSERT INTO psts ($columns) VALUES ($values);";
                $sql_mats = "INSERT INTO mats (mats,tents,matscha,dvt,matk,ngaysd,manhomts,tenkd) 
...
<head>
    ...
    <title>TẢI DỮ LIỆU TĂNG/GIẢM TÀI SẢN</title>
    <style>
        body {
...
<div class="container">
    ...
    <a href="../tmp/mautang_giamts.xlsx" download>Tải Excel mẫu</a>
</p>
</div>
