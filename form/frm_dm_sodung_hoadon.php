...
<script>
    ...
    $(function () {
			 ...
			 if (event.keyCode == Keys.F4) {
              ...
              if (event.keyCode == Keys.F7) { // copy
                  if (rowSelect != false){
                      ...
                      //--------------------------------------------Thay đổi khi copy---------------------------------
                       var _dataRow = {loaiphieu: rowData.loaiphieu, soquyen:rowData.soquyen, kyhieu: rowData.kyhieu, tuso: rowData.tuso, denso: rowData.denso, soluong: rowData.soluong, mauso: rowData.mauso,quy:rowData.quy,loaiphieu: "DK"};
		...
		function addRow(rowIndx,$name='mavt',$grid,$obj_addrow="") {
            ...
            var rowData = {loaiphieu: "1", soquyen: "", kyhieu: "", tuso: "", denso: "", soluong: "", mauso: "",quy:"0",loaiphieu: "DK"};
        ...
        //--------------------------------Khai báo lưới---------------------------------------.
 		var obj = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Số tờ/quyển", width: 165, dataType: "string", dataIndx: "soquyen", align: "right",
                    validations: [
                ...
                },
                {
                    ...
                    editor: {
                        type: "select", options: function (ui) {
                            var parsedJson = $.parseJSON('[{"I":"Quý I"},{"I":"Quý II"},{"I":"Quý III"},{"I":"Quý IV"}]');
                            return parsedJson;
                        }
                    },
                    render: function (ui) {
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_sudu_hoadon_select + "list_sodu_hoadon.php",//-- Load danh sách lên lưới
...
<div id="dialog-sodu_hoadon"
     title="SỐ DƯ HÓA ĐƠN ĐẦU KỲ (F4: Thêm mới , F7: Sao chép , F8: Xóa ,ESC : THOÁT)"><!-- dialog -->
