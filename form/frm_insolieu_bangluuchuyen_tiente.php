...
$denngay_fm = "Năm ".date("Y", $timedenngay);
    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.ajax({// Lấy thông tin phiếu và lưu vào session
                url: $dir_module_ketoantonghop + "laythongtininphieu_bangluuchuyen_tiente.php",
                data: {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                loadiFrame('tcpdf/baocao/inbang_luuchuyen_tiente.php?sole=<?php echo $sole ?>');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
			...
			window.open("tcpdf/baocao/inbang_luuchuyen_tiente.php","bankemuavao","menubar=0,resizable=1");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BÁO CÁO LƯU CHUYỂN TIỀN TỆ"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
