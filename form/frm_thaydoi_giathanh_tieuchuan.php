        ...
        var obj = {
            ...
            change: function (evt, ui) {// Khi dữ liệu thay đổi
                ...
                if(rowData.dinhmuc==""){
                    ...
                    $soluong = parseFloat(rowData.dinhmuc.toString().split(",").join(""));
                    if(rowData.dinhmuc!=""){
                        $soluong = 1;
                    }
                    $dongia = parseFloat(rowData.dongia.toString().split(",").join(""));
                    $thanhtiennhap = 0;
                    $thanhtien  = ThanhTien($soluong, $dongia, $thanhtiennhap); // Đưa thành tiền vào mảng
                ...
                if (type == 'update') {
                    ...
                    if (valid) {
                        if (rowData[recIndx] == null) {
                            url = $dir_module_dmsanpham + "editgiathanhtieuchuan.php";
                        }
                        else {
                            url = $dir_module_dmsanpham + "editgiathanhtieuchuan.php";
                        }
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                {
                    title: "Tên SP", width: 150, dataType: "string", editable: false, dataIndx: "tensp",
                    filter: { type: 'textbox', condition: 'begin', listeners: ['keyup'] }
                },
                {
                    title: "Mã VT",
...

                {
                    ...
                    dataIndx: "dinhmuc",
                    render: function (ui) {
                        var val = ui.rowData.dinhmuc;
                        var loaivl = ui.rowData.loaivl;
                        if(loaivl=="SXC"){
                            return "";
                        }else{
                            return parseFloat(val).toFixed(<?php echo ($_SESSION['txthienthisole']); ?>);
                        }
                    }
                },
                {
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_dmsanpham + "list_giathanh_tieuchuan.php",//-- Load danh sách lên lưới
...
<div id="dialog-sodutk"
     title="DANH SÁCH GIÁ THÀNH TIÊU CHUẨN... (ENTER : Sửa và Lưu , ESC : Thoát )">
    <!-- dialog -->
