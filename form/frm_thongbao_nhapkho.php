...
?>
<style>
    #dialog-thongbao_nhapkho fieldset {
...
<script>
    $(function () {
        $("#dialog-thongbao_nhapkho").dialog({
            resizable: false,
            height: "auto",
            width: 450,
            modal: true
        });
        $("#dialog-thongbao_nhapkho").keydown(function (event) {//--------------Các phím tắt
        ...
        function xoadialog_thongbao_nhapkho() {
            reset_dialog(".dialog-thongbao_nhapkho");
        ...
        function xoaform_phieuthuchi($mangsang) {//------------------------------------------------------------------------------------
            if($mangsang==1) {
                ...
                $("#manoidung").val("100010");
                $("#noidung").val("Mua hàng trả tiền mặt");
        ...
        $("#dialog-thongbao_nhapkho").keydown(function (event) {
            if (event.keyCode == Keys.ESCAPE) {
                reset_dialog(".dialog-thongbao_nhapkho");
        ...
        $("#InPhieuNhapKho").click(function () {
            $('.dialog_main_insolieu_thuchi').load('form/frm_insolieu_nhapkho.php?+<?php echo $ChuoiTruyVan; ?>');
...
<div id="dialog-thongbao_nhapkho" title="Tiếp tục hoặc kết thúc">
    <p>
