...
<div id="dialog-tangtaisan" title="BẢNG THANH TOÁN TIỀN THUÊ NGOÀI">
                ...
                <td width="100%">
                    <fieldset style="background-color: #afd9ee;border: 0px solid">
                        <table class="table-dialog" style="vertical-align: middle;width: 100%" border="0" id="table_tonghop" >
                            ...
                            <tr>
                                <td style="padding: 2px;"><label for="name"> Họ tên người thuê :</label></td>
                                <td style="padding: 2px;"><input name="hotennguoichi" type="text" value="" required=""
                                                                 class="text ui-widget-content ui-corner-all"
                                                                 id="hotennguoichi" placeholder="Họ và tên người thuê "
                                                                 style="width: 100%"></td>
                            </tr>
                            <tr>
                                <td style="padding: 2px;"><label for="name"> Bộ phận(hoặc địa chỉ) :</label></td>
...
<script>
    ...
    $(function () {
        ...
        var obj = {
                ...
                items: [
                    {
                        ...
                        "click": function (evt, ui) {
                            ...
                            var rowData = {hoten: '', diachi:'',socong:1,dongia:0,thanhtien:0,thuetncn:0,thuclinh:0}; //empty row
                    ...
                    if (type == 'add') {
                        ...
                        if (valid) {
                            ...
                            if ($data != null) { // Nếu tk có tòn tại trong hệ thống tài khoản thì lấy giá trị và gán vào textbox
                                rowData.hoten = $data.tenkh;
                                if($data.socmnd!=""){
                                    rowData.diachi = $data.diachi;
                                }else {
                                    rowData.diachi = $data.diachi;
                                }
                            }
            ...
            colModel: [
                {
                    title: "Mã Người được thuê", width: 115, dataType: "string", dataIndx: "makh",
                    validations: [
                ...
                {
                    title: "Họ và Tên người được thuê", width: 165, dataType: "string", dataIndx: "hoten",
                    validations: [
                        {type: 'nonEmpty', msg: "Không được trống"},
                    ]
                },
                {
                    title: "Địa chỉ hoặc số CMND", width: 140, dataType: "string", align: "left", dataIndx: "diachi"
                },
                {
                    title: "Nội dung hoặc tên CV thuê",
                    width: 120,
                    dataType: "string",
                    align: "left",
                    dataIndx: "noidung",
                ...
                {
                    title: "Số công hoặc KLCV đã làm", width: 70, dataType: "float", align: "right", dataIndx: "socong",
                ...
                {
                    title: "Thuế TNCN", width: 100, dataType: "integer", align: "right", dataIndx: "thuetncn"
                    ,
                    render: function (ui) {
                        var cellData = ui.cellData;
                        return $.number(cellData, 0, ".", ",");
                ...
                {
                    title: "Thực lĩnh", width: 100, dataType: "integer", align: "right", dataIndx: "thuclinh",editable: false
                    ,
                    render: function (ui) {
                        var cellData = ui.cellData;
                        return $.number(cellData, 0, ".", ",");
        ...
        function ChucNang_nhapkho() {// Xử lý khi nhấp button đồng ý
            ...
            var danhsach = $( "#grid_editing_bangthuengoai" ).pqGrid( "getData", { dataIndx: ['hoten', 'diachi','noidung','socong','dongia','thanhtien','thuetncn','thuclinh'] } );
            if (valid) {
                $.ajax({
                    url: $dir_module_bangkechitien + "nhapbangkethuengoai.php", // Bao gồm cả add và edit
                    ...
                    success: function (result) {
                        $('.dialog_main_thongbao').load('form/frm_thongbao_bangthanhtoanngoai.php?mabangke=' + $mabangke);
                    }
                });
            }
