...
<script>
    ...
    $width = getWidth() - 150;
    $(function () {
        var $dir_module_chitiet_ps_kt = "";
        $dir_module_chitiet_ps_kt = "modules/chitietpskt/";//--------------------------------------------Thay đổi khi copy
        ...
        function xoadialog_chitiet_ps_kt() { // ----------------------đóng form
            reset_dialog(".dialog-chitiet_ps_kt");
            reset_dialog(".dialog_main_chitiet_pskt");
            $("#grid_editing_ps_kt :button").first().focus();
        }

        $("#dialog-chitiet_ps_kt").dialog({ // ------------------Gọi dialog
            resizable: false,
            height: $height,
            width: $width,
            modal: true
        ...
        $("#dialog-chitiet_ps_kt").keydown(function (event) {//--------------Các phím tắt
            var $grid_pb = $("#grid_editing_chitiet_ps_kt").closest('.pq-grid');//---- Lưới----------------
            ...
            var rowEditting = $("#grid_editing_chitiet_ps_kt").pqGrid("getRowsByClass", {cls: 'pq-row-edit'});//---Lấy đối tượng đang sửa
                ...
                if (event.keyCode == Keys.F7) { // copy
                    if (rowSelect != false) {
                        ...
                        var _dataRow = {
                            ...
                            tennoidung2: rowData.tennoidung2,
                            tkno_mand2: rowData.tkno_mand2,
                            tennoidung: rowData.tennoidung,
                            tkno_mand: rowData.tkno_mand,
                            gtvnd: rowData.gtvnd,
                            date: rowData.date,
        ...
        /* $.contextMenu('destroy');
         ...
         selector: '#grid_editing_chitiet_ps_kt',
         build: function ($trigger, e) {
         return {
         callback: function (key, options) {
         var $grid_pb = $("#grid_editing_chitiet_ps_kt").closest('.pq-grid');
                        ...
                        buttons: {
                            ...
                            "Hủy bỏ": {
                                keys: ['N'], action: function () {
                                    $("#grid_editing_ps_kt").pqGrid("refreshDataAndView");
        ...
        var manoidung_select = function (ui) {
            ...
            var $inp = $("<input type='text'  name='" + dataIndx + "' class='" + cls + " pq-cell-editor pg-cel-define' readonly />")
                .appendTo($cell)
                .val(dc).keypress(function (e) {
                    $('.dialog_main_manoidung').load("form/frm_dm_manoidung_select.php?idstyle=grid_editing_chitiet_ps_kt");
                });
        }
                    ...
                    buttons: {
                        "Đồng ý": {
                            keys: ['Y'], action: function () {
                                ...
                                $.ajax($.extend({}, ajaxObj, {
                                    context: $grid,
                                    url: $dir_module_chitiet_ps_kt + "del.php",
                                    data: {id: sott, ma: ma},
        ...
        function update(rowIndx, $grid) {
            ...
            if (isDirty) {
                ...
                if (rowData[recIndx] == null) {
                    //url to add records.
                    url = $dir_module_chitiet_ps_kt + "add.php";
                }
                else {
                    //url to  update records.
                    url = $dir_module_chitiet_ps_kt + "edit.php";
                }
                $.ajax($.extend({}, ajaxObj, {
                    context: $grid,
                    url: url,
        ...
        var makh_select = function (ui) {
            ...
            var $inp = $("<input type='text'  name='" + dataIndx + "' class='" + cls + " pq-cell-editor pg-cel-define' readonly />")
                ...
                .val(dc).keypress(function () {
                    $('.dialog_main_makh').load("form/frm_dm_makh_select.php?idstyle=grid_editing_chitiet_ps_kt");
                });
        }
        ...
        var obj = {
            ...
            colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
                ...
                /*{
                 ...
                 var parsedJson = "";
                 $.ajax({
                 url: $dir_module_chitiet_ps_kt + "cb_loaiphieu.php",
                 data: {},
                 async: false,
                 success: function (response) {
                 ...
                 var $TenLoai = "";
                 $.ajax({
                 url: $dir_module_chitiet_ps_kt + "ten_loaiphieu.php",
                 data: {ma: $maloaict},
                 async: false,
                 success: function (response) {
                 $TenLoai = response;
                 ...
                 var $Ten = "";
                 $.ajax({
                 url: $dir_module_chitiet_ps_kt + "gettenkh.php",
                 data: {makh: $makh},
                 async: false,
                 success: function (response) {
...

                {
                    ...
                    filter: {
                        ...
                        options: function (ui) {
                            ...
                            var parsedJson = "";
                            $.ajax({
                                url: $dir_module_chitiet_ps_kt + "cb_loaict.php",
                                data: {},
                                async: false,
                                success: function (response) {
                                    parsedJson = $.parseJSON(response);
                    ...
                    render: function (ui) {
                        ...
                        var $TenLoai = "";
                        $.ajax({
                            url: $dir_module_chitiet_ps_kt + "ten_loaict.php",
                            data: {ma: $maloaict},
                            async: false,
                            success: function (response) {
                                $TenLoai = response;
                        ...
                        {type: 'minLen', value: 1, msg: "Tài khoản nợ không được trống !"},
                        {
                            type: function (ui) {
                                ...
                                if (_found) {
                                    ...
                                    $('.dialog_main_httk').load("form/frm_dm_httk_select.php?idstyle=grid_editing_chitiet_ps_kt");
                                    return false;
                                }
                            }
                        }
            ...
            dataModel: {
                ...
                url: $dir_module_chitiet_ps_kt + "list.php",//-- Load danh sách lên lưới
        ...
        var $grid = $("#grid_editing_chitiet_ps_kt").pqGrid(obj);
        ...
        function getRowSelect() { // --------------------Lấy dữ liệu theo dòng trên gird----------------------                 
            var arr = $("#grid_editing_chitiet_ps_kt").pqGrid("selection", {
                type: 'cell',
                method: 'getSelection'
...
<div id="dialog-chitiet_ps_kt"
     title="Chi tiết Phát sinh kế toán ... (F2: Sửa , F7: Sao chép , F8: Xóa , F9: Lưu , END : Hủy dòng đang sửa)">
    <!-- dialog -->
    <div id="grid_editing_chitiet_ps_kt" style="margin:5px auto;border: 0px !important;"></div>
</div>