...
$tructieptrendoanhthu = $_GET['tructieptrendoanhthu'];
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            $.confirm({
                ...
                content: function(){
                    var self = this;
                    return $.ajax({
                        url: $dir_module_baocaothue + "laythongtininphieubangkebanra.php",
                        dataType: 'json',
                        method: 'get',
                        data: {
                    ...
                    "OK": {
                        keys: ['Y'], action: function () {
                            if($("#XuatExcel").prop("checked") == true){
                                window.open($dir_module_baocaothue+"xuatexcelbangkebanra.php?loaibangke=<?php echo $loaibangke ?>");
                            }else{
								if("<?php echo $loaingoaite ?>"=="NT"){
									loadiFrame('tcpdf/baocao/inbangke_hanghoa_banra.php_nt?loaibangke=<?php echo $loaibangke ?>');
								}else{
									
									if("<?php echo $tructieptrendoanhthu ?>"=="true"){
										loadiFrame('tcpdf/baocao/inbangke_hanghoa_banra_ttdt.php?loaibangke=<?php echo $loaibangke ?>');
									}else{
										loadiFrame('tcpdf/baocao/inbangke_hanghoa_banra.php?loaibangke=<?php echo $loaibangke ?>');
									}
								}
            ...
            $.confirm({
                ...
                buttons: {
                    "OK": {
                        keys: ['Y'], action: function () {
							if("<?php echo $loaingoaite ?>"=="NT"){
									window.open("tcpdf/baocao/inbangke_hanghoa_banra_nt.php?loaibangke=<?php echo $loaibangke ?>","bangkebanra","menubar=0,resizable=1");
								}else{
									if("<?php echo $tructieptrendoanhthu ?>"=="true"){
										window.open("tcpdf/baocao/inbangke_hanghoa_banra_ttdt.php?loaibangke=<?php echo $loaibangke ?>","bangkebanra","menubar=0,resizable=1");
									}else{
										window.open("tcpdf/baocao/inbangke_hanghoa_banra.php?loaibangke=<?php echo $loaibangke ?>","bangkebanra","menubar=0,resizable=1");
									}
								}
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="BẢNG KÊ KHAI HÓA ĐƠN, CHỨNG TỪ HÀNG HÓA, DỊCH VỤ BÁN RA"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
