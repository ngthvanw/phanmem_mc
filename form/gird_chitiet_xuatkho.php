...
//onBlur: 'validate',
        ...
        colModel: [//-------------------------------------------Khai báo các cột trong lưới-----------------------
            ...
            {title: "Thành tiền Chưa CK", minWidth: 120, dataType: "string", align: "right", dataIndx: "thanhtienchuack", editable: false,
                render: function (ui) {
                    var thanhtienchuack = ui.rowData.thanhtienchuack; // Lấy số lượng nhập

                    return FormatNumber(thanhtienchuack.toString());
                }
            },
            {title: "Thành tiền CK", minWidth: 100, dataType: "string", align: "right", dataIndx: "thanhtien", editable: false,
                render: function (ui) {
