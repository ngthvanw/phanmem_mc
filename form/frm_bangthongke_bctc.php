...
<div id="dialog-tangtaisan" title="THỐNG KÊ TRÌNH DUYỆT BCTC">
                            ...
                            <tr>
                                ...
                                <td style="padding: 2px;">
                                    <select style="width: 150px;height:25px" id="trangthai">
                                        ...
                                        <option value="0">Chưa trình duyệt</option>
                                        <option value="1">Đã trình duyệt</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
    ...
    $(function () {
        ...
        var obj = {
            ...
            colModel: [
                ...
                {
                    title: "Năm ", width: 80, dataType: "string", align: "center", dataIndx: "tokhaithang"
                },
                {
                ...
                {
                    title: "Trình duyệt", width: 100, dataType: "string", align: "center", dataIndx: "truongnhomduyet",
                    render: function (ui) {
                        var value = ui.rowData.truongnhomduyet;
                        if (value == "CD" || value == "DD" || value == "TN" || value == "TL") {
            ...
            dataModel: {
                ...
                location: "remote",
                recIndx: "sott",
                url: $dir_module_user + "danhsach_thongke_bctc.php", //for ASP.NET
        ...
        function ChucNang_ThongKe() {// Xử lý khi nhấp button đồng ý
            ...
            if (valid) {
                ...
                $grid.pqGrid( "option", "dataModel.postData", function( ui ){
                    return {niendo:niendo,trangthai:trangthai,nguoiphutrach:nguoiphutrach};
                } );
        ...
        $("#xuatbaocao").click(function (event) {// Gọi table mã nội dung để chọn
                ...
                trangthai = $("#trangthai").val().trim();
                nguoiphutrach = $("#nguoiphutrach").val().trim();
            window.open("tcpdf/baocao/inbangke_thongke_bctc.php?niendo="+niendo+"&trangthai="+trangthai+"&nguoiphutrach="+nguoiphutrach,"ThongKeToKhai","menubar=0,resizable=0");
        });
    });
</script>