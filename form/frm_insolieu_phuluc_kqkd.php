    ...
    $(function () {
        ...
        $("#batđauin_insolieu_thuchi").click(function () {
            ...
            if($("#XuatExcel").prop("checked") == true){
                ...
                loadiFrame('tcpdf/baocao/inbang_phuluc_kqkd.php');
        ...
        $("#xemtruockhiin_insolieu_thuchi").click(function () {
            ...
            window.open("tcpdf/baocao/inbang_phuluc_kqkd.php","PLXDKQKD","menubar=0,resizable=1");
        });
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="TenPhieu_ThuChi" style="width:100%" id="TenPhieu_ThuChi"
                                       value="KẾT QUẢ HOẠT ĐỘNG SẢN XUẤT KINH DOANH"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Ngày HĐ</td>
