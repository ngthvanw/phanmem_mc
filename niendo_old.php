...
if (isset($_POST['submit'])) {
    ...
    if ($NienDo != "") {
        ...
        if ($MacDinh != "on") {
            ...
            if($theothongtu=='200'){
                $filename = 'datafile/khac/datafile_tt200.rar';
            }else{
                $filename = 'datafile/khac/datafile.rar';
            }
            $dbname = $_SESSION['TIENTO'] . $_SESSION['MST'] . "_" . $NienDo;
            mkdir($driver_htdocs."/log_login");
            mkdir($driver_htdocs."/log_login/" . $dbname);
            ...
            mysqli_select_db($cnn,$mysql_database);

            mysqli_query($cnn,"SET NAMES 'UTF-8'");
